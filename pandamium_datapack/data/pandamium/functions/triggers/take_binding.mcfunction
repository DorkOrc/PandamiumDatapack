...
execute as @a if score @p[tag=doing_trigger] take_binding = @s id if data entity @s Inventory[{Slot:100b}].tag.Enchantments[{id:"minecraft:binding_curse"}] run scoreboard players set <has_bound_items> variable 1
execute as @a if score @p[tag=doing_trigger] take_binding = @s id if data entity @s Inventory[{Slot:101b}].tag.Enchantments[{id:"minecraft:binding_curse"}] run scoreboard players set <has_bound_items> variable 1
execute as @a if score @p[tag=doing_trigger] take_binding = @s id if data entity @s Inventory[{Slot:102b}].tag.Enchantments[{id:"minecraft:binding_curse"}] run scoreboard players set <has_bound_items> variable 1
execute as @a if score @p[tag=doing_trigger] take_binding = @s id if data entity @s Inventory[{Slot:103b}].tag.Enchantments[{id:"minecraft:binding_curse"}] run scoreboard players set <has_bound_items> variable 1
