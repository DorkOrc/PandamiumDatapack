...
execute if score @s vote matches 1 run tellraw @s [" ",{"text":"Link 1: ","color":"green"},{"text":"minecraft-server-list.com","clickEvent":{"action":"open_url","value":"https://minecraft-server-list.com/server/445164/vote/"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to visit ","color":"blue"},{"text":"minecraft-server-list.com","bold":true}]},"color":"blue","underlined":true}]
execute if score @s vote matches 1 run tellraw @s [" ",{"text":"Link 2: ","color":"green"},{"text":"minecraftservers.org","clickEvent":{"action":"open_url","value":"https://minecraftservers.org/vote/562059"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to visit ","color":"blue"},{"text":"minecraftservers.org","bold":true}]},"color":"blue","underlined":true}]
execute if score @s vote matches 1 run tellraw @s [" ",{"text":"Link 3: ","color":"green"},{"text":"minecraft-mp.com","clickEvent":{"action":"open_url","value":"https://minecraft-mp.com/server/232030/vote/"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to visit ","color":"blue"},{"text":"minecraft-mp.com","bold":true}]},"color":"blue","underlined":true}]
execute if score @s vote matches 1 run tellraw @s [" ",{"text":"Link 4: ","color":"green"},{"text":"topg.org","clickEvent":{"action":"open_url","value":"https://topg.org/Minecraft/in-519676"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to visit ","color":"blue"},{"text":"topg.org","bold":true}]},"color":"blue","underlined":true}]
