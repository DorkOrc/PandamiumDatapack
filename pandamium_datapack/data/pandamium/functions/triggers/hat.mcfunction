...
execute if score @s gameplay_perms matches 6.. in pandamium:staff_world run item replace block 7 64 -7 container.0 from entity @s armor.head
execute if score @s gameplay_perms matches 6.. run item replace entity @s armor.head from entity @s weapon.mainhand
execute if score @s gameplay_perms matches 6.. in pandamium:staff_world run item replace entity @s weapon.mainhand from block 7 64 -7 container.0
