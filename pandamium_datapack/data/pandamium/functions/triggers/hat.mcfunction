...
# Swap
execute if score <returned> variable matches 0 run setblock 0 0 0 chest
execute if score <returned> variable matches 0 run item replace block 0 0 0 container.0 from entity @s armor.head
execute if score <returned> variable matches 0 run item replace entity @s armor.head from entity @s weapon.mainhand
execute if score <returned> variable matches 0 run item replace entity @s weapon.mainhand from block 0 0 0 container.0
