...
execute if score @s gameplay_perms matches 5.. if score <hand_item_exists> variable matches 1 in overworld run setblock -3 52 -1 chest[facing=south,type=single]{Items:[]}
execute if score @s gameplay_perms matches 5.. if score <hand_item_exists> variable matches 1 in overworld run item block -3 52 -1 container.0 copy entity @s armor.head
execute if score @s gameplay_perms matches 5.. if score <hand_item_exists> variable matches 1 in overworld run item entity @s armor.head copy entity @s weapon.mainhand
execute if score @s gameplay_perms matches 5.. if score <hand_item_exists> variable matches 1 in overworld run item entity @s weapon.mainhand copy block -3 52 -1 container.0
