...
execute if score @s get_guidebook matches 2.. if score <player_exists> temp matches 0 run tellraw @s [{"text":"[Guidebook]","color":"dark_red"},{"text":" Could not find that player!","color":"red"}]
execute if score @s get_guidebook matches 2.. if score <player_exists> temp matches 1 run tellraw @s [{"text":"[Guidebook]","color":"gold"},[{"text":" Gave ","color":"yellow"},{"selector":"@p[tag=selected_player]"}," a guidebook!"]]
execute if score @s get_guidebook matches 2.. if score <player_exists> temp matches 1 run tellraw @a[scores={staff_perms=1..},tag=!running_trigger] [{"text":"","color":"gray"},{"text":"[Info] ","color":"dark_gray"},{"selector":"@s","color":"gray"}," gave ",{"selector":"@p[tag=selected_player]","color":"gray"}," a guidebook."]
