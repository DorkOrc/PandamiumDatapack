...
execute if score @p[tag=running_trigger] get_guidebook matches 1 if score @s staff_perms matches 1.. run function pandamium:misc/print_nearest_non_staff_player
