...
execute as @p[tag=selected_player] unless score @s spawnpoint_x = @s spawnpoint_x run tellraw @p[tag=running_trigger] [{"text":"","color":"red"},{"text":"[Spawnpoint] ","color":"dark_red"},{"selector":"@s","color":"red"}," has not set a spawnpoint yet!"]
