...
tellraw @s [{"text":"","color":"gold","bold":false},{"text":"[inventory] ","clickEvent":{"action":"suggest_command","value":"/trigger inventory set "}},{"text":"[enderchest] ","clickEvent":{"action":"suggest_command","value":"/trigger enderchest set "}},{"text":"[show_cooldown]","clickEvent":{"action":"suggest_command","value":"/trigger show_cooldown set "}},"\n",{"text":"[show_homes] ","clickEvent":{"action":"suggest_command","value":"/trigger show_homes set "}},{"text":"[show_playtime] ","clickEvent":{"action":"suggest_command","value":"/trigger show_playtime set "}},{"text":"[show_spawnpoint]","clickEvent":{"action":"suggest_command","value":"/trigger show_spawnpoint set "}}]
