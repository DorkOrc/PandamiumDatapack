...
execute if score @s vote_shop matches 1 run tellraw @s ["",{"text":"Vote Credits:","color":"green"}," ",{"score":{"name":"@s","objective":"vote_credits"},"bold":true,"color":"aqua"}]
...
execute if score @s vote_shop matches 1 run tellraw @s [[{"text":"7: ","color":"green"},[{"text":"[A Random Player's Head]  ","color":"gold","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -7"},"hoverEvent":{"action":"show_item","contents":{"id":"bundle","tag":"{display:{Name:'{\"text\":\"20 Vote Credits\",\"italic\":false,\"bold\":true,\"color\":\"green\"}',Lore:['{\"text\":\"Requires At Least 10 Online Players\",\"italic\":false}']},Items:[{id:player_head,Count:1,tag:{SkullOwner:MHF_Question}}]}"}}}]],[{"text":"8: ","color":"green"},[{"text":"[Your Head]","color":"gold","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -108"},"hoverEvent":{"action":"show_item","contents":{"id":"bundle","tag":"{display:{Name:'{\"text\":\"100 Vote Credits\",\"italic\":false,\"bold\":true,\"color\":\"green\"}'},Items:[{id:player_head,Count:1b,tag:{SkullOwner:MHF_Exclamation}}]}"}}}]]]
execute if score @s vote_shop matches 1 run tellraw @s [ [{"text":"9: ","color":"green"},[{"text":"[Spawn A Shulker]  ","color":"blue","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -109"},"hoverEvent":{"action":"show_text","value":{"text":"10 Vote Credits","bold":true,"color":"green"}}}]]]
execute if score @s vote_shop matches 1 run tellraw @s [ [{"text":"10: ","color":"green"},[{"text":"[1 Random Caves and Cliffs Loot Bundle]  ","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -10"},"hoverEvent":{"action":"show_item","contents":{"id":"bundle","tag":"{display:{Name:'{\"text\":\"30 Vote Credits\",\"italic\":false,\"bold\":true,\"color\":\"green\"}'},Items:[{id:bundle,Count:1b,tag:{Enchantments:[{}],Items:[{id:bow,Count:1}]}}]}"}}}]]]
...
execute if score @s vote_shop matches -10 run scoreboard players set <cost> variable 30
...
execute if score @s vote_shop matches ..-1 if score @s vote_shop matches -9 in overworld if entity @p[tag=running_trigger,x=-512,y=-64,z=-512,dx=1024,dy=384,dz=1024] run scoreboard players set <can_buy> variable 0
execute if score @s vote_shop matches ..-1 if score @s vote_shop matches -9 in the_nether if entity @p[tag=running_trigger,x=-512,y=-64,z=-512,dx=1024,dy=384,dz=1024] run scoreboard players set <can_buy> variable 0
...
execute if score @s vote_shop matches ..-1 if score <can_buy> variable matches 0 unless score <displayed_error> variable matches 1 store success score <displayed_error> variable if score @s vote_shop matches ..-11 run tellraw @s [{"text":"","color":"red"},{"text":"[Vote Shop]","color":"dark_red"}," This is not a valid option!"]
