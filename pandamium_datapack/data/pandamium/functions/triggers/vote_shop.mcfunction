...
execute if score @s vote_shop matches 1 run tellraw @s [ [{"text":"9: ","color":"green"},[{"text":"[Spawn A Shulker]  ","color":"blue","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -109"},"hoverEvent":{"action":"show_text","value":{"text":"10 Vote Credits","bold":true,"color":"green"}}}]], [{"text":"10: ","color":"green"},[{"text":"[1 Random Caves and Cliffs Loot Bundle]  ","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -10"},"hoverEvent":{"action":"show_item","contents":{"id":"bundle","tag":"{display:{Name:'{\"text\":\"30 Vote Credits\",\"italic\":false,\"bold\":true,\"color\":\"green\"}'},Items:[{id:bundle,Count:1,tag:{Enchantments:[{}],Items:[{id:bow,Count:1}]}}]}"}}}]] ]
...
execute if score @s vote_shop matches ..-1 if score @s vote_shop matches -11 unless predicate pandamium:mini_blocks/mainhand_mini_block_items run scoreboard players set <can_buy> variable 0
...
execute if score @s vote_shop matches ..-1 if score <can_buy> variable matches 0 unless score <displayed_error> variable matches 1 store success score <displayed_error> variable if score @s vote_shop matches -11 unless predicate pandamium:mini_blocks/mainhand_mini_block_items run tellraw @s [{"text":"","color":"red"},{"text":"[Vote Shop]","color":"dark_red"}," Cannot mini-block-ify this item! Hold a solid block in your mainhand to get the mini-block form of it."]
