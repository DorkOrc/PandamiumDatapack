...
execute if score @s vote_shop matches ..-1 unless score @s vote_shop matches -9 unless score @s vote_shop matches -12 run scoreboard players set <gives_item> variable 1
...
execute if score @s vote_shop matches -12 run scoreboard players set <cost> variable 15
...
execute if score <can_buy> variable matches 1 if score @s vote_shop matches -10 run scoreboard players set <can_buy> variable 0
...
execute if score @s vote_shop matches ..-1 if score <can_buy> variable matches 0 unless score <displayed_error> variable matches 1 store success score <displayed_error> variable if score @s vote_shop matches -10 run tellraw @s [{"text":"","color":"red"},{"text":"[Vote Shop]","color":"dark_red"}," This is currently unavailable!"]
