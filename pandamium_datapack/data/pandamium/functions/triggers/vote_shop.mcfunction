...
execute if score @s vote_shop matches 1 run tellraw @s [[{"text":"1: ","color":"green"},[{"text":"[1 Golden Apple]  ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -1"},"hoverEvent":{"action":"show_text","contents":[{"text":"1 Vote Credit","color":"green"}]}}]],[{"text":"2: ","color":"green"},[{"text":"[5 Experience Bottles]","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -2"},"hoverEvent":{"action":"show_text","contents":[{"text":"1 Vote Credit","color":"green"}]}}]]]
execute if score @s vote_shop matches 1 run tellraw @s [[{"text":"3: ","color":"green"},[{"text":"[1 Endermite Egg]  ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -3"},"hoverEvent":{"action":"show_text","contents":[{"text":"1 Vote Credit","color":"green"}]}}]],[{"text":"4: ","color":"green"},[{"text":"[1 Diamond]","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -4"},"hoverEvent":{"action":"show_text","contents":[{"text":"3 Vote Credits","color":"green"}]}}]]]
execute if score @s vote_shop matches 1 run tellraw @s [[{"text":"5: ","color":"green"},[{"text":"[A Random Player's Head]  ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -5"},"hoverEvent":{"action":"show_text","contents":[{"text":"20 Vote Credits","color":"green"}]}}]],[{"text":"6: ","color":"green"},[{"text":"[1 Mending Book]","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -6"},"hoverEvent":{"action":"show_text","contents":[{"text":"25 Vote Credits","color":"green"}]}}]]]
execute if score @s vote_shop matches 1 run tellraw @s [[{"text":"7: ","color":"green"},[{"text":"[1 Enchanted Golden Apple]  ","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -7"},"hoverEvent":{"action":"show_text","contents":[{"text":"50 Vote Credits","color":"green"}]}}]],[{"text":"8: ","color":"green"},[{"text":"[Your Head]","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger vote_shop set -8"},"hoverEvent":{"action":"show_text","contents":[{"text":"100 Vote Credits","color":"green"}]}}]]]
...
execute if score @s vote_shop matches -1 if score @s temp_3 matches ..35 if score @s vote_credits matches 1.. run give @s minecraft:golden_apple 1
execute if score @s vote_shop matches -1 if score @s temp_3 matches ..35 if score @s vote_credits matches 1.. run scoreboard players remove @s vote_credits 1
...
execute if score @s vote_shop matches -3 if score @s temp_3 matches ..35 if score @s vote_credits matches 1.. run give @s minecraft:endermite_spawn_egg{EntityTag:{PlayerSpawned:1b}} 1
...
execute if score @s vote_shop matches -4 if score @s temp_3 matches ..35 if score @s vote_credits matches 3.. run give @s minecraft:diamond 1
execute if score @s vote_shop matches -4 if score @s temp_3 matches ..35 if score @s vote_credits matches 3.. run scoreboard players remove @s vote_credits 3

execute if score @s vote_shop matches -5 if score @s temp_3 matches ..35 if score @s vote_credits matches 20.. at @s as @r run loot give @p loot pandamium:head
execute if score @s vote_shop matches -5 if score @s temp_3 matches ..35 if score @s vote_credits matches 20.. run scoreboard players remove @s vote_credits 20

execute if score @s vote_shop matches -6 if score @s temp_3 matches ..35 if score @s vote_credits matches 25.. run give @s minecraft:enchanted_book{StoredEnchantments:[{id:"minecraft:mending",lvl:1}]} 1
execute if score @s vote_shop matches -6 if score @s temp_3 matches ..35 if score @s vote_credits matches 25.. run scoreboard players remove @s vote_credits 25

execute if score @s vote_shop matches -7 if score @s temp_3 matches ..35 if score @s vote_credits matches 50.. run give @s minecraft:enchanted_golden_apple 1
execute if score @s vote_shop matches -7 if score @s temp_3 matches ..35 if score @s vote_credits matches 50.. run scoreboard players remove @s vote_credits 50
