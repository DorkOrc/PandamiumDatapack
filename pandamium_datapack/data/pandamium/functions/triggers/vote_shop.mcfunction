...
execute if score @s vote_shop matches -6 if score @s vote_credits matches 1.. run scoreboard players set @s home_cooldown 0
execute if score @s vote_shop matches -6 if score @s vote_credits matches 1.. run scoreboard players remove @s vote_credits 1

execute if score @s vote_shop matches -7 if score @s vote_credits matches 1.. run scoreboard players set @s tpa_cooldown 0
execute if score @s vote_shop matches -7 if score @s vote_credits matches 1.. run scoreboard players remove @s vote_credits 1
