...
execute if score @s temp_2 matches ..35 if score @s vote_shop matches ..-1 if score @s vote_credits = @s temp_1 unless score @s temp_2 matches 0 run tellraw @s [{"text":"[Vote Shop]","color":"dark_red"},{"text":" You do not have enough credits.","color":"red"}]
