...
execute if score @s gameplay_perms matches 5.. run tellraw @a [{"text":"[Info] ","color":"blue"},{"selector":"@s"},{"text":" toggled ","color":"green"},{"text":"top votes","color":"aqua"},{"text":" for ","color":"green"},{"text":"30 seconds!","color":"aqua"}]
