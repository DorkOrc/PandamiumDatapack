...
execute if score @s kick matches 2.. at @a if score @s kick = @p id run scoreboard players set <player_exists> variable 1
execute if score @s kick matches 2.. if score <player_exists> variable matches 0 run tellraw @s [{"text":"","color":"red"},{"text":"[Info]","color":"dark_red"}," No player was found!"]
