...
execute if data storage pandamium:temp NBT.SelectedItem.tag.BlockEntityTag.Items[].tag.Items[].tag.pandamium.stored_mob run scoreboard players set <mainhand_contains_pets> variable 1
