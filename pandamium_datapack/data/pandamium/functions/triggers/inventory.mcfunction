...
execute if score @s inventory matches 2.. if score <player_exists> variable matches 0 run tellraw @s [{"text":"[Containers]","color":"dark_red"},[{"text":" Could not find a player with ID ","color":"red"},{"score":{"name":"@s","objective":"inventory"}},"!"]]
