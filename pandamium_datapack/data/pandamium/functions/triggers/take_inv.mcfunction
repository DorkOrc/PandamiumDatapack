...
execute at @a if score @s take_inv = @p id if score @p temp_1 matches 1.. if score @p temp_2 matches 2 run tellraw @s [{"text":"","color":"yellow"},{"text":"[Info]","color":"gold"}," Took ",[{"selector":"@p"},"'s"]," ",{"text":"inventory","color":"aqua"}," items!"]
