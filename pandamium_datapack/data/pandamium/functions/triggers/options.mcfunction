...
execute if score @s options matches 1.. if score @s health_display matches 1 run tellraw @s [{"text":"Health Display: ","color":"aqua","hoverEvent":{"action":"show_text","value":{"text":"Toggle the display of an entity's health when hit","color":"aqua"}},"clickEvent":{"action":"run_command","value":"/trigger options set -4"}},{"text":"False","color":"yellow","bold":true}]
execute if score @s options matches 1.. unless score @s health_display matches 1 run tellraw @s [{"text":"Health Display: ","color":"aqua","hoverEvent":{"action":"show_text","value":{"text":"Toggle the display of an entity's health when hit","color":"aqua"}},"clickEvent":{"action":"run_command","value":"/trigger options set -4"}},{"text":"True","color":"yellow","bold":true}]
...
execute if score @s options matches -4 store success score @s health_display unless score @s health_display matches 1
execute if score @s options matches -4 if score @s health_display matches 0 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"},{"text":" Enabled ","color":"aqua"},{"text":"Health Display","bold":true,"color":"yellow"},"!"]
execute if score @s options matches -4 if score @s health_display matches 1 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"},{"text":" Disabled ","color":"aqua"},{"text":"Health Display","bold":true,"color":"yellow"},"!"]
