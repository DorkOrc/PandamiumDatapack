scoreboard players set <at_least_elder> temp 0
execute if score @s votes matches 125.. if score @s playtime_ticks matches 9000000.. run scoreboard players set <at_least_elder> temp 1
...
execute if score @s options matches -128 if score <can_toggle_donator_prefix> temp matches 1 run function pandamium:misc/toggle_donator_team
execute if score @s options matches -128 if score <can_toggle_donator_prefix> temp matches 1 if score <donator_team> temp matches 0 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"},{"text":" Disabled ","color":"aqua"},{"text":"Donator Prefix","bold":true,"color":"dark_purple"},"!"]
execute if score @s options matches -128 if score <can_toggle_donator_prefix> temp matches 1 if score <donator_team> temp matches 1 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"},{"text":" Enabled ","color":"aqua"},{"text":"Donator Prefix","bold":true,"color":"dark_purple"},"!"]
...
# Error Messages
scoreboard players set <has_toggled_donator_prefix> temp 0
execute if score @s options matches -128 if score <can_toggle_donator_prefix> temp matches 1 run scoreboard players set <has_toggled_donator_prefix> temp 1
execute if score @s options matches ..-4 unless score @s option matches -102 unless score <has_toggled_donator_prefix> temp matches 1 unless entity @s[scores={options=-129,gameplay_perms=3..}] unless entity @s[scores={options=-128,gameplay_perms=6..}] unless entity @s[scores={options=-64,staff_perms=1..}] unless entity @s[scores={options=-65,staff_perms=2..}] run tellraw @s [{"text":"[Options]","color":"dark_red"},{"text":" This is not a valid option!","color":"red"}]
