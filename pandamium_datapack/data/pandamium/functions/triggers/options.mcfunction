...
execute if score @s options matches 1.. if score @s gameplay_perms matches 6.. if score @s hide_auto_msgs matches 1 run tellraw @s [{"text":"Auto Messages: ","color":"dark_purple","hoverEvent":{"action":"show_text","value":{"text":"Toggle Auto Messages","color":"dark_purple"}},"clickEvent":{"action":"run_command","value":"/trigger options set -129"}},{"text":"False","color":"yellow","bold":true}]
execute if score @s options matches 1.. if score @s gameplay_perms matches 6.. unless score @s hide_auto_msgs matches 1 run tellraw @s [{"text":"Auto Messages: ","color":"dark_purple","hoverEvent":{"action":"show_text","value":{"text":"Toggle Auto Messages","color":"dark_purple"}},"clickEvent":{"action":"run_command","value":"/trigger options set -129"}},{"text":"True","color":"yellow","bold":true}]
execute if score @s options matches 1.. unless score @s gameplay_perms matches 6.. run tellraw @s [{"text":"Auto Messages: ","color":"#C9C9C9","hoverEvent":{"action":"show_text","value":[{"text":"This option is only available for Donators.\n","color":"red"},[{"text":"Click here to join our ","color":"aqua"},{"text":"Discord","bold":true,"color":"#5865F2"}," server for more information on how to donate!"]]},"clickEvent":{"action":"open_url","value":"http://discord.pandamium.eu/"}},{"text":"True","color":"#E9E9E9","bold":true}]
