...
execute if score @s options matches 1.. if score @s attack_indicator matches 1 run tellraw @s [{"text":"Attack Indicator: ","color":"aqua","hoverEvent":{"action":"show_text","value":{"text":"Toggle Attack Indicator","color":"aqua"}},"clickEvent":{"action":"run_command","value":"/trigger options set -4"}},{"text":"True","color":"yellow","bold":true}]
execute if score @s options matches 1.. unless score @s attack_indicator matches 1 run tellraw @s [{"text":"Attack Indicator: ","color":"aqua","hoverEvent":{"action":"show_text","value":{"text":"Toggle Attack Indicator","color":"aqua"}},"clickEvent":{"action":"run_command","value":"/trigger options set -4"}},{"text":"False","color":"yellow","bold":true}]

execute if score @s options matches 1.. if score @s show_parkour_timer matches 1 run tellraw @s [{"text":"Show Parkour Timer: ","color":"aqua","hoverEvent":{"action":"show_text","value":{"text":"Toggle Show Parkour Timer","color":"aqua"}},"clickEvent":{"action":"run_command","value":"/trigger options set -5"}},{"text":"True","color":"yellow","bold":true}]
execute if score @s options matches 1.. unless score @s show_parkour_timer matches 1 run tellraw @s [{"text":"Show Parkour Timer: ","color":"aqua","hoverEvent":{"action":"show_text","value":{"text":"Toggle Show Parkour Timer","color":"aqua"}},"clickEvent":{"action":"run_command","value":"/trigger options set -5"}},{"text":"False","color":"yellow","bold":true}]
