...
execute if score @s options matches -128 unless entity @s[team=!donator,team=!elder+,team=!veteran+,team=!elite+] run function pandamium:misc/toggle_donator_team
execute if score @s options matches -128 unless entity @s[team=!donator,team=!elder+,team=!veteran+,team=!elite+] if score <donator_team> variable matches 0 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"}," ",{"text":"Disabled","color":"aqua"}," ",{"text":"Donator Prefix","bold":true,"color":"dark_purple"},"!"]
execute if score @s options matches -128 unless entity @s[team=!donator,team=!elder+,team=!veteran+,team=!elite+] if score <donator_team> variable matches 1 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"}," ",{"text":"Enabled","color":"aqua"}," ",{"text":"Donator Prefix","bold":true,"color":"dark_purple"},"!"]
...
execute if score @s options matches -128 unless entity @s[team=!donator,team=!elder+,team=!veteran+,team=!elite+] run scoreboard players set <has_toggled_donator_prefix> variable 1
