...
execute if score @s gameplay_perms matches 6.. unless score @s staff_perms matches 1.. if score @s votes matches 125.. if score @s playtime_ticks matches 9000000.. run scoreboard players set <can_toggle_donator_prefix> variable 1
