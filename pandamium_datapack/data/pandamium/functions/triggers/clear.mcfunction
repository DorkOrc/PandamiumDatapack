...
execute unless score @s jailed matches 1.. if score @s clear matches -1 run tellraw @s [{"text":"[Clear]","color":"dark_green"},{"text":" Cleared everything in your inventory!","color":"green"}]
