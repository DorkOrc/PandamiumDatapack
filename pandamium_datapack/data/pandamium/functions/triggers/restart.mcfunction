...
execute if score @s restart matches -3 if score <restart_countdown> variable matches 1.. run tellraw @a [{"text":"[Restart] ","color":"red"},"The server restart was cancelled!"]
