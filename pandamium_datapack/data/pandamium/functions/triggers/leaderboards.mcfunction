...
execute if score @s gameplay_perms matches 5.. if score <can_run> variable matches 1 if score @s leaderboards matches -3 run tellraw @a [{"text":"","color":"green"},{"text":"[Info] ","color":"blue"},{"selector":"@s"}," toggled ",{"text":"Monthly Playtime","bold":true,"color":"blue"}," for ",{"text":"30 seconds","color":"aqua"},"!"]
execute if score @s gameplay_perms matches 5.. if score <can_run> variable matches 1 if score @s leaderboards matches -4 run tellraw @a [{"text":"","color":"green"},{"text":"[Info] ","color":"blue"},{"selector":"@s"}," toggled ",{"text":"Monthly Votes","bold":true,"color":"blue"}," for ",{"text":"30 seconds","color":"aqua"},"!"]
