...
execute if score <can_run> variable matches 1 if score <value> variable matches 5 run tellraw @a [{"text":"[Leaderboards]","color":"blue"},[{"text":" ","color":"green"},{"selector":"@s"}," displayed the ",{"text":"Caves and Cliffs Parkour","bold":true,"color":"blue"}," leaderboard for ",{"text":"30 seconds","color":"aqua"},"!"]]
execute if score <can_run> variable matches 1 if score <value> variable matches 6 run tellraw @a [{"text":"[Leaderboards]","color":"blue"},[{"text":" ","color":"green"},{"selector":"@s"}," displayed the ",{"text":"Monstrous Parkour","bold":true,"color":"blue"}," leaderboard for ",{"text":"30 seconds","color":"aqua"},"!"]]
