...
execute if score @s unjail matches 1 if score <jailed_player_exists> variable matches 1 as @a[scores={jailed=1..}] run tellraw @p[tag=running_trigger] [{"text":" ","color":"yellow","hoverEvent":{"action":"show_text","contents":[["cheater = ",{"score":{"name":"@s","objective":"cheater"}}],"\n",["jailer_id = ",{"score":{"name":"@s","objective":"jailed"}}]]}},{"selector":"@s","hoverEvent":{"action":"show_text","contents":[["cheater = ",{"score":{"name":"@s","objective":"cheater"}}],"\n",["jailer_id = ",{"score":{"name":"@s","objective":"jailed"}}]]}}," --- ",{"score":{"name":"@s","objective":"id"},"color":"gold","bold":true}]
execute if score @s unjail matches 1 if score <jailed_player_exists> variable matches 1 run tellraw @s {"text":"==========================", "color":"yellow"}
execute if score @s unjail matches 1 if score <jailed_player_exists> variable matches 0 run tellraw @s [{"text":"[Info]","color":"dark_red"},{"text":" There are no jailed players online!","color":"red"}]
...
execute if score <player_exists> variable matches 1 if score <player_is_jailed> variable matches 0 run tellraw @s [{"text":"[Info]","color":"dark_red"},{"text":" This player is already not jailed!","color":"red"}]
...
execute if score <player_exists> variable matches 1 if score <player_is_jailed> variable matches 1 run tellraw @a [{"text":"","color":"dark_purple"},{"text":"[Info]","color":"dark_purple"}," ",{"selector":"@p[tag=selected_player]","color":"light_purple"}," was unjailed by ",{"selector":"@s","color":"light_purple"},"!"]
