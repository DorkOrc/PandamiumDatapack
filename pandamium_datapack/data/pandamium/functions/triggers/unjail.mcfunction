...
execute if score @s unjail matches 1 if entity @a[scores={jailed=1..}] at @a[scores={jailed=1..}] run tellraw @s [{"text":" ","color":"yellow","hoverEvent":{"action":"show_text","contents":[["jailed = ",{"score":{"name":"@p","objective":"jailed"}}],["\ncheater = ",{"score":{"name":"@p","objective":"cheater"}}]]}},{"selector":"@p","hoverEvent":{"action":"show_text","contents":[["jailed = ",{"score":{"name":"@p","objective":"jailed"}}],["\ncheater = ",{"score":{"name":"@p","objective":"cheater"}}]]}}," --- ",{"score":{"name":"@p","objective":"id"},"color":"gold","bold":true}]
