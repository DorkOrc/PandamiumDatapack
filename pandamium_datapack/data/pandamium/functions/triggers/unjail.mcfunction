...
execute if score <player_exists> variable matches 1 if score <player_is_jailed> variable matches 1 unless score @s hide_punishments matches 1 run tellraw @a [{"text":"","color":"dark_purple"},{"text":"[Info]","color":"dark_purple"}," ",{"selector":"@p[tag=selected_player]","color":"light_purple"}," was unjailed by ",{"selector":"@s","color":"light_purple"},"!"]
execute if score <player_exists> variable matches 1 if score <player_is_jailed> variable matches 1 if score @s hide_punishments matches 1 run tellraw @a[scores={staff_perms=1..}] [{"text":"","color":"gray"},{"text":"[Info]","color":"dark_gray"}," ",{"selector":"@p[tag=selected_player]"}," was unjailed by ",{"selector":"@s"},"!"]
