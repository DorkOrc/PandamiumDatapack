...
execute if score <can_run> variable matches 1 if score @s item_font matches -104..-101 store success score <can_run> variable unless data storage pandamium:temp NBT.SelectedItem.tag.pandamium.stored_mob
...
execute if score <can_run> variable matches 0 unless score <displayed_error> variable matches 1 store success score <displayed_error> variable if score @s item_font matches -104..-101 if data storage pandamium:temp NBT.SelectedItem.tag.pandamium.stored_mob run tellraw @s [{"text":"[Item Font]","color":"dark_red"},{"text":" You cannot modify the lore of this item!","color":"red"}]
