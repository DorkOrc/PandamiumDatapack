...
execute if score <can_run> variable matches 1 run function pandamium:misc/font/edit_mainhand_name
execute if score <can_run> variable matches 1 if score <text_changed> variable matches 0 run scoreboard players set <can_run> variable 0
execute if score <can_run> variable matches 1 if score <valid_option> variable matches 0 run scoreboard players set <can_run> variable 0

# Success
execute if score <can_run> variable matches 1 if score <text_changed> variable matches 1 run tellraw @s [{"text":"","color":"green"},{"text":"[Item Font]","color":"dark_green"}," Updated the ",{"text":"name","color":"aqua"}," of your selected item: ",[{"text":"","color":"white","italic":true},{"nbt":"Text","storage":"pandamium:temp","interpret":true}]]
execute if score <can_run> variable matches 1 if score <text_changed> variable matches 1 at @s run playsound ui.cartography_table.take_result master @s
