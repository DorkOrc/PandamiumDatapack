...
execute unless score @s spawn matches 2 run tp @s 0.5 64.0 0.5 -90 0
execute if score @s spawn matches 2 in minecraft:the_nether run tp @s 7.0 83.0 1.0 90 0
