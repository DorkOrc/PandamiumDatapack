...
execute if score @s tpa matches -2..-1 as @a if score @s id = @p[tag=running_trigger] tpa_request store success score <player_exists> variable run tag @s add selected_player
