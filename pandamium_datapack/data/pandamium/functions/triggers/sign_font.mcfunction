...
execute if score <can_run> variable matches 1 store success score <can_run> variable unless score @s in_spawn matches 1
...
execute if score <can_run> variable matches 1 if score <lines_changed> variable matches 1.. at @s run playsound ui.cartography_table.take_result master @s
...
execute if score <can_run> variable matches 0 unless score <displayed_error> variable matches 1 store success score <displayed_error> variable if score @s in_spawn matches 1 run tellraw @s [{"text":"[Sign Font]","color":"dark_red"},{"text":" You cannot use that trigger at spawn!","color":"red"}]
execute if score <can_run> variable matches 0 unless score <displayed_error> variable matches 1 store success score <displayed_error> variable if entity @s[gamemode=spectator] run tellraw @s [{"text":"[Sign Font]","color":"dark_red"},{"text":" You cannot use that trigger in spectator mode!","color":"red"}]
