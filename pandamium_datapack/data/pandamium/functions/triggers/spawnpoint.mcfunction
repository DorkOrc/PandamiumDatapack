...
execute if score @s staff_perms matches 2.. as @p[tag=selected_player] if score @s spawnpoint_x = @s spawnpoint_x if score <has_spawnpoint> variable matches 1 run tellraw @p[tag=running_trigger] [{"text":"","color":"yellow","hoverEvent":{"action":"show_text","value":[{"text":"Click to teleport to ","color":"yellow"},[{"selector":"@p[tag=selected_player]"},"'s"],{"text":" Spawnpoint","bold":true}]},"clickEvent":{"action":"run_command","value":"/trigger spawnpoint set -1"}},{"text":"[Spawnpoint] ","color":"gold"},[{"selector":"@s"},"'s "],{"text":"current","color":"gold","bold":true}," spawnpoint is at ",[{"score":{"name":"@s","objective":"spawnpoint_x"},"color":"gold"}," ",{"score":{"name":"@s","objective":"spawnpoint_y"}}," ",{"score":{"name":"@s","objective":"spawnpoint_z"}}]," in the ",{"nbt":"print_dimension","storage":"pandamium:spawnpoint","color":"gold","bold":true},"!"]
execute if score @s staff_perms matches 2.. as @p[tag=selected_player] if score @s spawnpoint_x = @s spawnpoint_x if score <has_spawnpoint> variable matches 0 run tellraw @p[tag=running_trigger] [{"text":"","color":"yellow","hoverEvent":{"action":"show_text","value":[{"text":"Click to teleport to ","color":"yellow"},[{"selector":"@p[tag=selected_player]"},"'s"],{"text":" Spawnpoint","bold":true}]},"clickEvent":{"action":"run_command","value":"/trigger spawnpoint set -1"}},{"text":"[Spawnpoint] ","color":"gold"},[{"selector":"@s"},"'s "],{"text":"last","color":"gold","bold":true}," spawnpoint was at ",[{"score":{"name":"@s","objective":"spawnpoint_x"},"color":"gold"}," ",{"score":{"name":"@s","objective":"spawnpoint_y"}}," ",{"score":{"name":"@s","objective":"spawnpoint_z"}}]," in the ",{"nbt":"print_dimension","storage":"pandamium:spawnpoint","color":"gold","bold":true},"!"]
