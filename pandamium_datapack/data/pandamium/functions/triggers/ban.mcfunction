...
execute if score @s ban matches 2.. at @a if score @s ban = @p id unless score @s staff_perms <= @p staff_perms run scoreboard players set <player_exists> variable 1
