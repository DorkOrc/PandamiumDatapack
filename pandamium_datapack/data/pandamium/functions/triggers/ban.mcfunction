...
execute if score @s ban matches 2.. if score <can_ban> variable matches 1 unless score @s staff_alt matches 1 if score @s hide_punishments matches 1 run tellraw @a[scores={staff_perms=1..}] [{"text":"","color":"gray"},{"text":"[Info] ","color":"dark_gray"},{"selector":"@p[tag=selected_player]","color":"gray"}," was banned by ",{"selector":"@s","color":"gray"},"!"]
...
execute if score @s ban matches 2.. if score <can_ban> variable matches 1 if score @s staff_alt matches 1 if score @s hide_punishments matches 1 run tellraw @a[scores={staff_perms=1..}] [{"text":"","color":"gray"},{"text":"[Info] ","color":"dark_gray"},{"selector":"@p[tag=selected_player]","color":"gray"}," was banned by a staff member!"]
