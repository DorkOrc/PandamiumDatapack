...
execute if score @s ban matches 1 at @s at @p[tag=!staff] run tellraw @s [{"text":"","color":"gray"},{"text":"[Info]","color":"dark_gray"}," The nearest non-staff player is ",{"selector":"@p","color":"gray"}," (",{"score":{"name":"@p","objective":"id"}},")."]
...
execute if score @s ban matches 2.. at @a if score @s ban = @p id if score @s staff_perms <= @p staff_perms run @s [{"text":"","color":"red"},{"text":"[Info]","color":"dark_red"}," You cannot ban ",{"selector":"@p"},"."]
