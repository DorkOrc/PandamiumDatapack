...
execute if score @s ban matches 2.. if score <player_exists> variable matches 0 run tellraw @s [{"text":"[Info]","color":"dark_red"},{"text":" Could not find that player!","color":"red"}]
...
execute if score @s ban matches 2.. if score <can_ban> variable matches 0 unless score @s hide_punishments matches 1 run tellraw @a [{"text":"[Info]","color":"red"}," ",{"selector":"@p[tag=selected_player]","color":"dark_red"}," was banned by ",{"selector":"@s","color":"dark_red"},"!"]
execute if score @s ban matches 2.. if score <can_ban> variable matches 0 if score @s hide_punishments matches 1 run tellraw @a[scores={staff_perms=1..}] [{"text":"","color":"gray"},{"text":"[Info]","color":"dark_gray"}," ",{"selector":"@p[tag=selected_player]"}," was banned by ",{"selector":"@s"},"!"]
