...
execute if score <player_exists> variable matches 1 if score <switching_jail> variable matches 1 if score <jail_type> variable matches 1 run tp @p[tag=selected_player] 11.0 32 67.5 0 0
