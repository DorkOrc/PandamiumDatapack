...
execute if score @s playtime matches 2.. if score <player_exists> temp matches 0 run tellraw @s [{"text":"[Playtime]","color":"dark_red"},{"text":" Could not find that player!","color":"red"}]
