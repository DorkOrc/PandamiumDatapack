...
execute if score <do_menu> variable matches 1 if score @s parkour.checkpoint matches 0.. unless score @s parkour.checkpoint matches 100..199 run tellraw @s [{"text":"","color":"green"},{"text":"[Return to Last Checkpoint]","color":"dark_aqua","hoverEvent":{"action":"show_text","value":[{"text":"Click to return to last checkpoint","color":"dark_aqua"}]},"clickEvent":{"action":"run_command","value":"/trigger parkour set -1"}},"  |  ",{"text":"[Quit]","color":"red","hoverEvent":{"action":"show_text","value":[{"text":"Click to ","color":"red"},{"text":"Quit","bold":true}," the course"]},"clickEvent":{"action":"run_command","value":"/trigger parkour set -2"}},"  |  ",{"text":"[Restart]","color":"dark_aqua","hoverEvent":{"action":"show_text","value":[{"text":"Click to ","color":"dark_aqua"},{"text":"Restart","bold":true}," this course"]},"clickEvent":{"action":"run_command","value":"/trigger parkour set -3"}}]
execute if score <do_menu> variable matches 1 if score @s parkour.checkpoint matches 100..199 run tellraw @s [{"text":"","color":"green"},{"text":"[Save Progress and Quit]","color":"red","hoverEvent":{"action":"show_text","value":[{"text":"Click to ","color":"red"},{"text":"Quit","bold":true}," the course",{"text":"\nYour position and time will be saved, and restored when you start the course again.","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger parkour set -2"}},"  |  ",{"text":"[Restart]","color":"dark_red","hoverEvent":{"action":"show_text","value":[{"text":"Click to ","color":"dark_red"},{"text":"Restart","bold":true}," this course",[{"text":"\nAny saved progress will be ","color":"gray"},{"text":"lost permanently","underlined":true},"."]]},"clickEvent":{"action":"run_command","value":"/trigger parkour set -3"}}]
...
execute if score @s parkour matches -2 run function pandamium:misc/parkour/actions/cancel/quit

execute if score @s parkour matches -3 if score @s parkour.checkpoint matches 0..99 run function pandamium:misc/parkour/parkour_1/restart
...
execute if score @s parkour matches -3 if score @s parkour.checkpoint matches 100..199 run tellraw @s [{"text":"[Parkour] ","color":"dark_green"},[{"text":"Monstrosity Parkour progress was ","color":"green"},{"text":"reset","color":"aqua"},"!"]]
