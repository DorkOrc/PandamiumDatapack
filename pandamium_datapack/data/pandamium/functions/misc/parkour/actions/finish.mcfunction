...
execute store result score <timer_seconds> variable run scoreboard players operation <timer_negative_seconds> variable /= <ticks_per_second> variable
scoreboard players operation <timer_negative_seconds> variable *= <-1> variable

# Update best times
execute if score <course_number> variable matches 1 run function pandamium:misc/parkour/parkour_1/finish
execute if score <course_number> variable matches 2 run function pandamium:misc/parkour/parkour_2/finish
