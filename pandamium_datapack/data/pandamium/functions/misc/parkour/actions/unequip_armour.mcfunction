...
execute if score <is_wearing_armour> variable matches 1 if score <filled_inventory_slots> variable matches ..32 in pandamium:staff_world run function pandamium:misc/unequip_armour
