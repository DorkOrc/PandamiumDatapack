...
execute as @e[type=marker,tag=parkour.node,x=-512,y=-64,z=-512,dx=1024,dy=384,dz=1024] if score @s id = <my_checkpoint> variable at @s run tp @p[tag=running_function] ~ ~ ~
