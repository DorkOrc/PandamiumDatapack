scoreboard players operation <parkour_best_hours> variable = @s parkour_2.best_time
scoreboard players operation <parkour_best_hours> variable /= <ticks_per_hour> variable

scoreboard players operation <parkour_best_minutes> variable = @s parkour_2.best_time
...
scoreboard players operation <parkour_best_seconds> variable = @s parkour_2.best_time
