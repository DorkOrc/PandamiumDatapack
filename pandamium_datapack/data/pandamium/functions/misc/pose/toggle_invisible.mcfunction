...
execute unless data storage pandamium:pose NBT{Invisible:1b} if score <can_toggle_invisible> variable matches 1 run data merge entity @s {Invisible:1b,DisabledSlots:63}
