...
execute if score <pose> variable matches -10 run data modify entity @s Pose merge value {RightArm:[-20f,-20f,0f],LeftArm:[-50f,50f,0f],RightLeg:[-20f,0f,0f],LeftLeg:[20f,0f,0f]}
execute if score <pose> variable matches -11 run data modify entity @s Pose merge value {Body:[15f,0f,0f],RightArm:[-60f,-10f,0f],LeftArm:[10f,0f,-10f],RightLeg:[-15f,0f,0f],LeftLeg:[30f,0f,0f]}
execute if score <pose> variable matches -12 run data modify entity @s Pose merge value {Head:[-15f,0f,0f],RightArm:[240f,-10f,0f],LeftArm:[10f,0f,-10f],LeftLeg:[15f,0f,0f]}
execute if score <pose> variable matches -13 run data modify entity @s Pose merge value {RightArm:[-80f,20f,0f],LeftArm:[-80f,-20f,0f],RightLeg:[-90f,10f,0f],LeftLeg:[-90f,-10f,0f]}
...
execute if score <pose> variable matches -22 run data modify entity @s Pose merge value {Body:[0f,13f,0f],Head:[0f,30f,0f],RightArm:[-22f,31f,10f],LeftArm:[145f,22f,-49f],RightLeg:[6f,-20f,0f],LeftLeg:[-6f,0f,0f]}
execute if score <pose> variable matches -23 run data modify entity @s Pose merge value {Body:[4f,0f,0f],Head:[4f,0f,0f],RightArm:[30f,22f,-20f],LeftArm:[30f,-20f,21f],RightLeg:[0f,0f,5f],LeftLeg:[0f,0f,-5f]}
