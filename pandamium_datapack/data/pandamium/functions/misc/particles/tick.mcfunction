...
#execute if score @s active_particles matches 31 positioned ~ ~-0.2 ~ run function pandamium:misc/particles/halo
#execute if score @s active_particles matches 32 positioned ~ ~-0.2 ~ run function pandamium:misc/particles/devil
#execute if score @s active_particles matches 33 positioned ~ ~-0.2 ~ run function pandamium:misc/particles/olex
execute if score @s active_particles matches 34 positioned ~ ~-0.2 ~ run function pandamium:misc/particles/tears
