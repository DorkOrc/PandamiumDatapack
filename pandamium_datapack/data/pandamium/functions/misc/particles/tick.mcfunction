execute if score @s active_particles matches 1 run particle composter ~ ~0.25 ~ 0.5 0.5 0.5 0 3
execute if score @s active_particles matches 2 run particle dragon_breath ~ ~0.25 ~ 0.5 0.5 0.5 0 2
execute if score @s active_particles matches 3 run particle end_rod ~ ~0.25 ~ 0.5 0.5 0.5 0 1

execute if score @s active_particles matches 4 run particle small_flame ~ ~0.25 ~ 0.5 0.5 0.5 0 2 force @s
execute if score @s active_particles matches 4 run particle flame ~ ~0.25 ~ 0.5 0.5 0.5 0 2 force @a[distance=0.1..32]

execute if score @s active_particles matches 5 run particle note ~ ~0.25 ~ 0.5 0.5 0.5 2 1
execute if score @s active_particles matches 6 run particle soul_fire_flame ~ ~0.25 ~ 0.5 0.5 0.5 0 2
execute if score @s active_particles matches 7 run particle soul ~ ~0.25 ~ 0.5 0.5 0.5 0 1
execute if score @s active_particles matches 11 run particle crit ~ ~0.25 ~ 0.6 0.6 0.6 0.1 1
execute if score @s active_particles matches 13 run particle mycelium ~ ~0.5 ~ 0.3 0.5 0.3 0 1
execute if score @s active_particles matches 14 run particle totem_of_undying ~ ~0.25 ~ 0.3 0.5 0.3 0.1 1
execute if score @s active_particles matches 15 run particle dust 1 0 0 0.6 ~ ~0.25 ~ 0.3 0.6 0.3 0.2 1
...
execute if score @s active_particles matches 21 run particle dust 100 100 100 0.5 ~ ~1 ~ 0.3 0.5 0.3 0.5 1
...
execute if score @s active_particles matches 28 run particle squid_ink ~ ~0.25 ~ 0.3 0.5 0.3 0.1 2 force @a[distance=0.1..32]
...
execute if score @s active_particles matches 32 run particle glow_squid_ink ~ ~0.25 ~ 0.3 0.5 0.3 0.1 2 force @a[distance=0.1..32]
