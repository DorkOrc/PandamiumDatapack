...
execute store success score nbt_changed temp_1 run data modify storage pandamium:remove_nbt Inventory2[-1] set from storage pandamium:remove_nbt Inventory[-1]
...
function pandamium:misc/remove_nbt/hardcoded/check_inventory_slot
