...
xp add @s 0
execute unless score <parkour_teleport> variable matches 1 if score @s parkour_checkpoint matches 0.. run function pandamium:misc/map_specific/parkour/end_parkour
