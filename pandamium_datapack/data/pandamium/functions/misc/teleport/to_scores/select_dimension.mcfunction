...
execute unless score <tp_d> variable matches -1 unless score <tp_d> variable matches 1 in overworld run function pandamium:misc/teleport/to_scores/teleport
