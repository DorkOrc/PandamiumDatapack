execute if score <auto_message> variable matches 0 run tellraw @a [{"text":"","color":"green","clickEvent":{"action":"open_url","value":"http://discord.pandamium.eu"},"hoverEvent":{"action":"show_text","value":{"text":"Click to Join the Discord Server!","color":"aqua"}}},{"text":"[Info] ","color":"blue"},{"text":"Click here","color":"aqua"}," to join our official ",{"text":"Discord","color":"aqua"}," server and always stay up to date: ",{"text":"discord.pandamium.eu","color":"aqua"}]

execute if score <auto_message> variable matches 1 run tellraw @a [{"text":"","color":"green","clickEvent":{"action":"suggest_command","value":"/trigger vote"},"hoverEvent":{"action":"show_text","value":{"text":"Click to Vote for Pandamium!","color":"aqua"}}},{"text":"[Info] ","color":"blue"},"Do ",{"text":"/trigger vote","color":"aqua"}," to ",{"text":"get rewards","color":"aqua"},", ",{"text":"rank up","color":"aqua"}," and ",{"text":"support the server","color":"aqua"},"!"]
