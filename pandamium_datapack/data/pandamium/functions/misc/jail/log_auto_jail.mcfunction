...
execute store result storage pandamium:jail auto_jails[-1].index int 1 run scoreboard players get <next_auto_jail_log_index> global
...
execute store result storage pandamium:jail auto_jails[-1].date[0] int 1 run scoreboard players get <year> global
execute store result storage pandamium:jail auto_jails[-1].date[1] int 1 run scoreboard players get <month> global
execute store result storage pandamium:jail auto_jails[-1].date[2] int 1 run scoreboard players get <day> global
execute store result storage pandamium:jail auto_jails[-1].date[3] int 1 run scoreboard players get <hour> global
...
scoreboard players add <unread_auto_jails> global 1

scoreboard players add <next_auto_jail_log_index> global 1
execute if score <next_auto_jail_log_index> global matches 21.. run scoreboard players set <next_auto_jail_log_index> global 1
