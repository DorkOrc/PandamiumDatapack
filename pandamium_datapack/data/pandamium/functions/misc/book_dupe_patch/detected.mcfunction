...
execute if score <hand> variable matches 1 run data modify storage pandamium:book_dupe detections[-1] set from entity @s SelectedItem.tag
execute if score <hand> variable matches 0 run data modify storage pandamium:book_dupe detections[-1] set from entity @s Inventory[{Slot:-106b}].tag
