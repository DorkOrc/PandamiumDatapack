...
execute if score <auto_clear> variable matches 100 run playsound minecraft:entity.experience_orb.pickup player @s ~ ~ ~ 0.25 0.5
...
execute if score <auto_clear> variable matches 80 run playsound minecraft:entity.experience_orb.pickup player @s ~ ~ ~ 0.25 0.5
...
execute if score <auto_clear> variable matches 60 run playsound minecraft:entity.experience_orb.pickup player @s ~ ~ ~ 0.25 0.5
...
execute if score <auto_clear> variable matches 40 run playsound minecraft:entity.experience_orb.pickup player @s ~ ~ ~ 0.25 0.5
...
execute if score <auto_clear> variable matches 20 run playsound minecraft:entity.experience_orb.pickup player @s ~ ~ ~ 0.25 0.5
...
execute if score <auto_clear> variable matches 0 run playsound minecraft:entity.experience_orb.pickup player @s ~ ~ ~ 0.25 1
