...
execute unless entity @e[tag=map_specific.red_carpet,type=falling_block] run summon falling_block -103 73 7 {BlockState:{Name:"minecraft:red_carpet"},NoGravity:1b,Time:1,Tags:["map_specific.red_carpet"]}
execute unless entity @e[tag=map_specific.red_carpet,type=falling_block] run summon falling_block -103 73 -7 {BlockState:{Name:"minecraft:red_carpet"},NoGravity:1b,Time:1}
