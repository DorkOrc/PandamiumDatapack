...
execute if score <hand> variable matches 1 run replaceitem entity @s weapon air
execute if score <hand> variable matches 0 run replaceitem entity @s weapon.offhand air
