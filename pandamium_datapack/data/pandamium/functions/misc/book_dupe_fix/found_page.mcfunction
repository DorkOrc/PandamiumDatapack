...
execute unless score <page_length> variable matches 21853.. if data storage pandamium:book_dupe pages[] run function pandamium:misc/book_dupe_fix/found_page
