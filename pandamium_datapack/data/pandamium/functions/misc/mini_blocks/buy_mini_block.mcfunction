...
scoreboard players set <can_give_mini_block> temp 0
function pandamium:misc/mini_blocks/give_mini_block

execute if score <can_give_mini_block> temp matches 1 run playsound ui.stonecutter.take_result master @s
execute if score <can_give_mini_block> temp matches 0 run scoreboard players set <can_buy> temp 0
