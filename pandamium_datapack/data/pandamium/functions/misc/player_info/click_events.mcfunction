...
execute if score @s player_info matches -8 unless score @s staff_perms matches 2.. run scoreboard players set <player_info_can_run> variable 0
...
execute if score @s player_info matches -14 as @p[tag=player_info_selected_player] run function pandamium:misc/teleport/spawn
...
execute if score @s player_info matches -15 unless score @s staff_perms matches 2.. run scoreboard players set <player_info_can_run> variable 0
...
execute if score @s player_info matches -17 if score @s staff_perms matches 3.. in pandamium:staff_world run function pandamium:triggers/take_inv
execute if score @s player_info matches -17 unless score @s staff_perms matches 3.. run scoreboard players set <player_info_can_run> variable 0
...
execute if score @s player_info matches -18 if score @s staff_perms matches 3.. in pandamium:staff_world run function pandamium:triggers/take_ec
...
execute if score @s player_info matches -19 if score @s staff_perms matches 3.. in pandamium:staff_world run function pandamium:triggers/take_binding
