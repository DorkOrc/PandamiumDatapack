...
execute if score @s player_info matches -9 unless score @s staff_perms matches 2.. run scoreboard players set <can_run> variable 0
...
execute if score @s player_info matches -15 as @p[tag=selected_player] run function pandamium:misc/teleport/spawn
execute if score @s player_info matches -15 run tellraw @s [{"text":"[Player Info]","color":"gold"},[{"text":" Teleported ","color":"yellow"},{"selector":"@p[tag=selected_player]"}," to spawn!"]]
...
execute if score @s player_info matches -17 unless score @s staff_perms matches 2.. run scoreboard players set <can_run> variable 0
...
execute if score @s player_info matches -20 unless score @s staff_perms matches 3.. run scoreboard players set <can_run> variable 0
