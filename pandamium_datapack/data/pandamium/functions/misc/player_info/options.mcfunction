...
execute if score @s hide_auto_msgs matches 1 run tellraw @p[tag=player_info_running_trigger] [{"text":"Auto Messages: ","color":"dark_aqua"},{"text":"False","color":"yellow","bold":true}]
execute unless score @s hide_auto_msgs matches 1 run tellraw @p[tag=player_info_running_trigger] [{"text":"Auto Messages: ","color":"dark_aqua"},{"text":"True","color":"yellow","bold":true}]

execute store success score <donator_team> variable if entity @s[team=donator]
execute if score <donator_team> variable matches 1 run tellraw @p[tag=player_info_running_trigger] [{"text":"Donator Prefix: ","color":"dark_purple"},{"text":"True","color":"yellow","bold":true}]
execute unless score <donator_team> variable matches 1 run tellraw @p[tag=player_info_running_trigger] [{"text":"Donator Prefix: ","color":"dark_purple"},{"text":"False","color":"yellow","bold":true}]
