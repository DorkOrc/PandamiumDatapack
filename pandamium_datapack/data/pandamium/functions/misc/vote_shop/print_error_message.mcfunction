...
execute unless score <displayed_error> variable matches 1 store success score <displayed_error> variable if score @s vote_shop matches -11 if entity @s[predicate=pandamium:in_spawn] run tellraw @s [{"text":"[Vote Shop]","color":"dark_red"},{"text":" You cannot buy that at spawn! It spawns a shulker at your location.","color":"red"}]
...
execute unless score <displayed_error> variable matches 1 store success score <displayed_error> variable if score @s vote_shop matches -14 if entity @s[predicate=pandamium:in_spawn] run tellraw @s [{"text":"[Vote Shop]","color":"dark_red"},{"text":" You cannot buy that at spawn! It spawns a tamed zombie horse at your location.","color":"red"}]
