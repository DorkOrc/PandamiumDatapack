...
execute unless score <displayed_error> variable matches 1 store success score <displayed_error> variable if score @s vote_shop matches -11 if score @s in_spawn matches 1 run tellraw @s [{"text":"[Vote Shop]","color":"dark_red"},{"text":" You cannot buy that at spawn! It spawns a shulker at your location.","color":"red"}]

execute unless score <displayed_error> variable matches 1 store success score <displayed_error> variable if score @s vote_shop matches -13 if score @s in_spawn matches 1 run tellraw @s [{"text":"[Vote Shop]","color":"dark_red"},{"text":" You cannot buy that at spawn!","color":"red"}]
...
execute unless score <displayed_error> variable matches 1 store success score <displayed_error> variable if score @s vote_shop matches -14 if score @s in_spawn matches 1 run tellraw @s [{"text":"[Vote Shop]","color":"dark_red"},{"text":" You cannot buy that at spawn! It spawns a tamed zombie horse at your location.","color":"red"}]
