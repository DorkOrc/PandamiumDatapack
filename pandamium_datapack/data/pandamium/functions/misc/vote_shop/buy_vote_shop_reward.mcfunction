...
execute store success score <buying_mini_block_alt> variable if score @s vote_shop matches -228..-201
execute store success score <buying_special_mini_block> variable if score @s vote_shop matches -52..-51
