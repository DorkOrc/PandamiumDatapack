...
execute unless score @s vote_shop matches -106 unless score @s vote_shop matches -109..-108 run scoreboard players set <conf_message> variable 0
...
execute if score <can_buy> variable matches 1 if score <conf_message> variable matches 1 run scoreboard players set <can_buy> variable 0
