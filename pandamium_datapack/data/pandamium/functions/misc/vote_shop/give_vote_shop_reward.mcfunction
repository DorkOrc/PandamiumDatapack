...
execute if score @s vote_shop matches -8 run function pandamium:misc/vote_shop/mini_blocks/buy
...
execute if score <buying_mini_block_alt> variable matches 1 run function pandamium:misc/vote_shop/mini_blocks/alt/give
