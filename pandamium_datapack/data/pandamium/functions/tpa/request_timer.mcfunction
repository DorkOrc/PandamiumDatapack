...
execute unless score @s tpa_request_time matches 0.. run tellraw @s [{"text":"[TPA]","color":"dark_blue"},{"text":" Your tpa request from ","color":"green"},{"selector":"@p"},{"text":" expired","color":"aqua"},{"text":"!","color":"green"}]
