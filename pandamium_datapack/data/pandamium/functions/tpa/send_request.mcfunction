execute if score @s tpa_request matches 1.. run tellraw @p[tag=running_trigger] [{"text":"","color":"red"},{"text":"[TPA]","color":"dark_red"}," ",{"selector":"@s","color":"red"}," already has another TPA request."]
...
execute unless score @s tpa_request matches 1.. at @s run playsound entity.experience_orb.pickup player @s ~ ~ ~ 1 2 1
