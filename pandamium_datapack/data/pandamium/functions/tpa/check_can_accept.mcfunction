...
#execute in overworld if entity @p[tag=receiver,x=-131,y=16,z=-10,dx=60,dy=34,dz=35] unless entity @p[tag=sender,scores={gameplay_perms=6..}] run scoreboard players set <can_accept> variable 0
