...
execute if score @s sethome matches 2 if score @s gameplay_perms matches 1.. run function pandamium:home/set_check_dimension
...
execute if score @s sethome matches 3 if score @s gameplay_perms matches 2.. run function pandamium:home/set_check_dimension
...
execute if score @s sethome matches 4..5 if score @s gameplay_perms matches 3.. run function pandamium:home/set_check_dimension
