...
execute as @e[x=-512,y=0,z=-512,dx=1024,dy=256,dz=1024,type=#pandamium:remove_at_spawn] run tp 0 -1000 0
...
kill @e[type=minecart,x=-128,y=0,z=-128,dx=256,dy=128,dz=256]
