...
execute as @e[x=-512,y=0,z=-512,dx=1024,dy=256,dz=1024,type=#pandamium:remove_at_spawn] unless data entity @s Tags run tp 0 -1000 0
execute as @e[x=-128,y=0,z=-128,dx=256,dy=128,dz=256,type=#pandamium:kill_at_spawn] unless data entity @s Tags run kill @s
execute as @e[type=potion,x=-128,y=0,z=-128,dx=256,dy=128,dz=256] run data merge entity @s {Item:{tag:{Potion:"none"}}}
