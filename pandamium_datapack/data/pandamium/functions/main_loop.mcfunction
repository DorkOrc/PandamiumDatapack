...
execute as @a[gamemode=spectator] unless score @s staff_perms matches 2.. unless entity @s[x=-512,y=-256,z=-512,dx=1024,dy=1280,dz=1024] run function pandamium:misc/spawn_restriction
