...
execute if entity @a[x=0,predicate=pandamium:in_spawn,limit=1] at @e[type=marker,x=-128,y=-64,z=-128,dx=256,dy=384,dz=256,tag=rtp] as @a[distance=..2,limit=1] unless score @s rtp_cooldown matches 1.. run function pandamium:misc/teleport/random/main
