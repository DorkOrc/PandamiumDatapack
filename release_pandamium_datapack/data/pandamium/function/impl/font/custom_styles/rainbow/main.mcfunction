...
execute if score <max_index> variable matches 50.. run data modify entity @s text set from storage pandamium:temp text
...
execute if score <max_index> variable matches 0 run function pandamium:impl/font/custom_styles/rainbow/single_character_exception
