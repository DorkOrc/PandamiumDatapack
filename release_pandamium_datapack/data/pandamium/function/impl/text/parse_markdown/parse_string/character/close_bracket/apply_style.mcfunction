...
$data modify storage pandamium:local functions."pandamium:impl/text/parse_markdown/*".components[{__left__:[$(left_node_index)],__right__:[$(right_node_index)]}] merge from storage pandamium:local functions."pandamium:impl/text/parse_markdown/*".hyperlink_style
