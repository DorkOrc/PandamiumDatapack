execute store result score <nether_player_count> variable in the_nether if entity @a[gamemode=!spectator,x=0]
execute store result score <overworld_player_count> variable in overworld if entity @a[gamemode=!spectator,x=0]
execute store result score <end_player_count> variable in the_end if entity @a[gamemode=!spectator,x=0]

execute store result score <staff_world_player_count> variable in pandamium:staff_world if entity @a[gamemode=!spectator,x=0]
scoreboard players operation <overworld_player_count> variable += <staff_world_player_count> variable

execute store result score <nether_mob_count> variable in the_nether if entity @e[type=!player,x=0]
execute store result score <overworld_mob_count> variable in overworld if entity @e[type=!player,x=0]
execute store result score <end_mob_count> variable in the_end if entity @e[type=!player,x=0]
