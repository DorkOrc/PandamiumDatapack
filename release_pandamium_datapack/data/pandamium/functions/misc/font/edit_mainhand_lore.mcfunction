...
execute if score <font> variable matches 101 run function pandamium:misc/font/modify_lore/line_1
execute if score <font> variable matches 102 run function pandamium:misc/font/modify_lore/line_2
execute if score <font> variable matches 103 run function pandamium:misc/font/modify_lore/line_3
execute if score <font> variable matches 104 run function pandamium:misc/font/modify_lore/line_4
...
function pandamium:misc/font/modify_lore/trim
