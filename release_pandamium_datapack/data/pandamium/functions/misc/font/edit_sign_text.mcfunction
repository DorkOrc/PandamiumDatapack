...
execute if score <line> variable matches 1 run data modify block ~ ~ ~ {} merge from storage pandamium:temp sign_attributes
...
execute if score <line> variable matches 2 run data modify block ~ ~ ~ {} merge from storage pandamium:temp sign_attributes
...
execute if score <line> variable matches 3 run data modify block ~ ~ ~ {} merge from storage pandamium:temp sign_attributes
...
execute if score <line> variable matches 4 run data modify block ~ ~ ~ {} merge from storage pandamium:temp sign_attributes
