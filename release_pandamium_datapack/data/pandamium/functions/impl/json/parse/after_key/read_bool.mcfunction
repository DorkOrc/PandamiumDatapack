...
execute if score <bool> variable matches 0..1 if data storage pandamium:json key if data storage pandamium:json stack[-1].flags{is_root:1b} run function pandamium:impl/json/parse/after_key/store_root_bool_attribute
