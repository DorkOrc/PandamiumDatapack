...
execute if data storage pandamium:json string run function pandamium:impl/json/parse/iter
...
execute if score <found_original_text> variable matches 1 run function pandamium:impl/json/resolve_original_text_characters
