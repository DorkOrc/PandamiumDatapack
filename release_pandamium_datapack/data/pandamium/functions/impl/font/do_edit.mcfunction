...
execute if score <font> variable matches 75 if entity @s[predicate=pandamium:in_spawn,scores={staff_perms=2..,sign_font=..-1}] store success score <valid_option> variable run data modify block 3 0 0 front_text.messages[0] set value '{"nbt":"Text","storage":"pandamium:temp","interpret":true,"color":"yellow"}'
execute if score <font> variable matches 76 if entity @s[predicate=pandamium:in_spawn,scores={staff_perms=2..,sign_font=..-1}] store success score <valid_option> variable run data modify block 3 0 0 front_text.messages[0] set value '{"nbt":"Text","storage":"pandamium:temp","interpret":true,"color":"gold"}'
execute if score <font> variable matches 77 if entity @s[predicate=pandamium:in_spawn,scores={staff_perms=2..,sign_font=..-1}] store success score <valid_option> variable run data modify block 3 0 0 front_text.messages[0] set value '{"nbt":"Text","storage":"pandamium:temp","interpret":true,"color":"#FB6F00"}'
execute if score <font> variable matches 78 if entity @s[predicate=pandamium:in_spawn,scores={staff_perms=2..,sign_font=..-1}] store success score <valid_option> variable run data modify block 3 0 0 front_text.messages[0] set value '{"nbt":"Text","storage":"pandamium:temp","interpret":true,"color":"red"}'
execute if score <font> variable matches 79 if entity @s[predicate=pandamium:in_spawn,scores={staff_perms=2..,sign_font=..-1}] store success score <valid_option> variable run data modify block 3 0 0 front_text.messages[0] set value '{"nbt":"Text","storage":"pandamium:temp","interpret":true,"color":"dark_red"}'
execute if score <font> variable matches 80 if entity @s[predicate=pandamium:in_spawn,scores={staff_perms=2..,sign_font=..-1}] store success score <valid_option> variable run data modify block 3 0 0 front_text.messages[0] set value '{"nbt":"Text","storage":"pandamium:temp","interpret":true,"color":"green"}'
execute if score <font> variable matches 81 if entity @s[predicate=pandamium:in_spawn,scores={staff_perms=2..,sign_font=..-1}] store success score <valid_option> variable run data modify block 3 0 0 front_text.messages[0] set value '{"nbt":"Text","storage":"pandamium:temp","interpret":true,"color":"dark_green"}'
execute if score <font> variable matches 82 if entity @s[predicate=pandamium:in_spawn,scores={staff_perms=2..,sign_font=..-1}] store success score <valid_option> variable run data modify block 3 0 0 front_text.messages[0] set value '{"nbt":"Text","storage":"pandamium:temp","interpret":true,"color":"aqua"}'
execute if score <font> variable matches 83 if entity @s[predicate=pandamium:in_spawn,scores={staff_perms=2..,sign_font=..-1}] store success score <valid_option> variable run data modify block 3 0 0 front_text.messages[0] set value '{"nbt":"Text","storage":"pandamium:temp","interpret":true,"color":"dark_aqua"}'
execute if score <font> variable matches 84 if entity @s[predicate=pandamium:in_spawn,scores={staff_perms=2..,sign_font=..-1}] store success score <valid_option> variable run data modify block 3 0 0 front_text.messages[0] set value '{"nbt":"Text","storage":"pandamium:temp","interpret":true,"color":"blue"}'
execute if score <font> variable matches 85 if entity @s[predicate=pandamium:in_spawn,scores={staff_perms=2..,sign_font=..-1}] store success score <valid_option> variable run data modify block 3 0 0 front_text.messages[0] set value '{"nbt":"Text","storage":"pandamium:temp","interpret":true,"color":"dark_blue"}'
execute if score <font> variable matches 86 if entity @s[predicate=pandamium:in_spawn,scores={staff_perms=2..,sign_font=..-1}] store success score <valid_option> variable run data modify block 3 0 0 front_text.messages[0] set value '{"nbt":"Text","storage":"pandamium:temp","interpret":true,"color":"dark_purple"}'
execute if score <font> variable matches 87 if entity @s[predicate=pandamium:in_spawn,scores={staff_perms=2..,sign_font=..-1}] store success score <valid_option> variable run data modify block 3 0 0 front_text.messages[0] set value '{"nbt":"Text","storage":"pandamium:temp","interpret":true,"color":"#00CE73"}'

# Custom Fonts
execute if score <font> variable matches 91 if score @s item_font matches ..-1 store success score <valid_option> variable run function pandamium:impl/font/custom_fonts/reset
execute if score <font> variable matches 92 if score @s item_font matches ..-1 store success score <valid_option> variable run function pandamium:impl/font/custom_fonts/rainbow

execute if score <font> variable matches 301..400 if score @s item_font matches ..-1 if score @s font.gradient.left_index = @s font.gradient.left_index store success score <valid_option> variable run function pandamium:impl/font/custom_fonts/gradient/enter_right_index
