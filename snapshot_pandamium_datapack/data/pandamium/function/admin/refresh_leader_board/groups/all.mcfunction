...
tellraw @s [{"text":"[admin]","color":"dark_green"},[{"text":" Queued refreshing leader boards: ","color":"green"},{"text":"[","color":"aqua"},{"storage":"pandamium:queue","nbt":"entries[{action:'refresh_leader_board'}].leader_board","color":"aqua","separator":["]",{"text":", ","color":"green"},"["]},{"text":"]","color":"aqua"},"."]]
