...
$execute if score $(username) staff_rank matches 5 run return run tellraw @s [{"text":"[admin]","color":"dark_red"},[{"text":" ","color":"red"},{"text":"$(username)","color":"yellow"},"'s ",{"text":"staff","color":"yellow"}," rank is already ",{"text":"owner","color":"yellow"},"!"]]
...
$tellraw @s [{"text":"[admin]","color":"dark_green"},[{"text":" Set ","color":"green"},{"text":"$(username)","color":"aqua"},"'s ",{"text":"staff","color":"aqua"}," rank to ",{"text":"owner","color":"aqua"},"!"]]
