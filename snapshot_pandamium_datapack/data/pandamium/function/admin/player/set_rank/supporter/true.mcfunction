...
$execute if score $(username) supporter_rank matches 1 run return run tellraw @s [{"text":"[admin]","color":"dark_red"},[{"text":" ","color":"red"},{"text":"$(username)","color":"yellow"},"'s ",{"text":"supporter","color":"yellow"}," rank is already ",{"text":"true","color":"yellow"},"!"]]
