...
$execute in pandamium:staff_world run data modify block 3 0 0 front_text.messages[0] set value '[{"storage":"pandamium:temp","nbt":"username","insertion":"$(id)"},{"text":" (Offline)","color":"gray"}]'
