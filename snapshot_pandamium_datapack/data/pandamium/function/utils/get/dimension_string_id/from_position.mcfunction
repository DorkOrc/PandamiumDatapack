execute if dimension minecraft:overworld run return run data modify storage pandamium:temp dimension_string_id set value "minecraft:overworld"
...
execute if dimension minecraft:the_ned run return run data modify storage pandamium:temp dimension_string_id set value "minecraft:the_end"
