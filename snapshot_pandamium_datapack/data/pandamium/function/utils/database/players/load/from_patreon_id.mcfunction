...
$execute if data storage pandamium.db.players:data patreon_id_indexes."$(patreon_id)" store result storage pandamium.db.players:io selected.index int 1 run data get storage pandamium.db.players:data patreon_id_indexes."$(patreon_id)"
