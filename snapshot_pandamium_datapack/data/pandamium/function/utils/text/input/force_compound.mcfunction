...
execute if storage pandamium:text input{} run return 1

# resolve the input if it is a list
execute if storage pandamium:text input[0] run return run function pandamium:impl/text/resolve_input/main
