...
tellraw @s [{text:"",color:"green"},{text:"[Homes]",color:"dark_green"},{text:" Teleported to "},{storage:"pandamium.db.players:io",nbt:"selected.entry.username"},{text:"'s "},{text:"Home ",color:"aqua",bold:true,extra:[{score:{name:"<home>",objective:"variable"}}]},{text:" in spectator mode!"}]
