...
tellraw @s [{text:""},{text:"[Search Nearby]",color:"dark_green"},{text:" Teleported to ",color:"green",extra:[{color:"aqua",text:"",extra:[{storage:"pandamium:temp",nbt:"display_name",interpret:true}]},{text:"'s "},{text:"Home ",color:"aqua",extra:[{storage:"pandamium.db.click_events:io",nbt:"selected.entry.data.home_data.home_slot"}]},{text:"! "},{text:"ℹ",color:"blue",hover_event:{action:"show_text",text:[{storage:"pandamium.db.click_events:io",nbt:"selected.entry.data.home_data.x"},{text:" "},{storage:"pandamium.db.click_events:io",nbt:"selected.entry.data.home_data.y"},{text:" "},{storage:"pandamium.db.click_events:io",nbt:"selected.entry.data.home_data.z"},{text:" in ",color:"gray"},{storage:"pandamium:temp",nbt:"dimension_name"}]}}]}]
