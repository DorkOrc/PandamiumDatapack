...
tellraw @s [{text:"[Flair]",color:"dark_green"},{text:" Set ",color:"green",extra:[{text:"flair type",color:"aqua"},{text:" to "},{color:"aqua",text:"",extra:[{storage:"pandamium:temp",nbt:"flair",interpret:true}]},{text:"!"}]}]
