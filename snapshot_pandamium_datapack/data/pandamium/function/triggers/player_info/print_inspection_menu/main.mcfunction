...
# playtimes
data modify storage pandamium:local functions."pandamium:triggers/player_info/print_inspection_menu/*".playtime_display_modifiers set value [{text:{text:"[this_month]",color:"dark_gray",hover_event:{action:"show_text",value:[{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.monthly_playtime[3]",plain:true},{text:"h "},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.monthly_playtime[2]",plain:true},{text:"m "},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.monthly_playtime[1]",plain:true},{text:"s"}]}},type:"monthly"},{text:{text:"[this_year]",color:"dark_gray",hover_event:{action:"show_text",value:[{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.yearly_playtime[3]",plain:true},{text:"h "},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.yearly_playtime[2]",plain:true},{text:"m "},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.yearly_playtime[1]",plain:true},{text:"s"}]}},type:"yearly"}]
...
tellraw @s [{text:" playtime: ",color:"gold"},\
    {text:"",color:"yellow",extra:[{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.total_playtime[3]",plain:true},"h ",{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.total_playtime[2]",plain:true},"m ",{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.total_playtime[1]",plain:true},"s"]}," ",\
...
execute if score <target_is_online> variable matches 1 run tellraw @s [{text:" session_length: ",color:"gold"},{text:"",color:"yellow",extra:[{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.session_playtime[3]",plain:true},"h ",{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.session_playtime[2]",plain:true},"m ",{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.session_playtime[1]",plain:true},"s"]}]
...
$execute if predicate pandamium:player/min_staff_perms/moderator run execute if score <target_is_online> variable matches 1 run tellraw @s [{text:" last_death_location: ",color:"gold"},{text:"[👁]",color:"dark_gray",hover_event:{action:"show_text",value:[{text:"",color:"gold"},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.last_death_location.pos[]",plain:true,separator:" ",color:"yellow"}," in ",{nbt:"dimension_name",storage:"pandamium:temp",interpret:true,color:"yellow"}]}}," ",{text:"[→]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to teleport to ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},"'s ",{text:"last death location",bold:true}]},click_event:{action:"run_command",command:"trigger player_info set -8$(id_with_leading_zeroes)"}}]
