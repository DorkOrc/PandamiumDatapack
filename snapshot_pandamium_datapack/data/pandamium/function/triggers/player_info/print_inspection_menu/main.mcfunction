...
# alt information
execute if predicate pandamium:player/staff_perms/moderator run data modify storage pandamium:local functions."pandamium:triggers/player_info/print_inspection_menu/*".alt_ids set from storage pandamium.db.players:io selected.entry.data.alts
execute if predicate pandamium:player/staff_perms/moderator run data modify storage pandamium:local functions."pandamium:triggers/player_info/print_inspection_menu/*".alt_names set value []
execute if predicate pandamium:player/staff_perms/moderator run execute if data storage pandamium:local functions."pandamium:triggers/player_info/print_inspection_menu/*".alt_ids[0] in pandamium:staff_world run function pandamium:triggers/player_info/print_inspection_menu/alts_loop with storage pandamium:local functions."pandamium:triggers/player_info/print_inspection_menu/*".alt_ids[0]
execute if predicate pandamium:player/staff_perms/moderator run execute if data storage pandamium:local functions."pandamium:triggers/player_info/print_inspection_menu/*".alt_names[0] run tellraw @s [{text:" known_alts: ",color:"gold"},{text:"",color:"yellow",extra:[{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.alt_names[]",interpret:true,separator:{text:", ",color:"gray"}}]}]

execute if predicate pandamium:player/staff_perms/moderator run execute if data storage pandamium.db.players:io selected.entry.data.alt_of in pandamium:staff_world run function pandamium:triggers/player_info/print_inspection_menu/get_alt_of with storage pandamium.db.players:io selected.entry.data.alt_of
