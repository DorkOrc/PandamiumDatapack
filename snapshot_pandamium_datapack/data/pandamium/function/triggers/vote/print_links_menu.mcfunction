...
tellraw @s [" ",{text:"Link 1: ",color:"#7FFFDF"},{text:"[",color:"aqua",shadow_color:[0.0f,0.75f,0.75f,0.75f],extra:[{storage:"pandamium:dictionary",nbt:"votifier_service_titles.'FindMCServer'",interpret:true},"] ",{text:"(OFFICIAL)",bold:true,color:"aqua",font:"minecraft:uniform"}]}]
