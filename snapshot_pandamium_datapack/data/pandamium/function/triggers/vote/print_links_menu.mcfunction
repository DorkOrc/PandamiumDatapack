...
tellraw @s [" ",{"text":"Link 1: ","color":"green"},{"text":"findmcserver.com","color":"blue","underlined":true,"clickEvent":{"action":"open_url","value":"https://findmcserver.com/server/pandamium?vote=true"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to vote through\n","color":"blue"},{"text":"FindMCServer","bold":true}]}}]
