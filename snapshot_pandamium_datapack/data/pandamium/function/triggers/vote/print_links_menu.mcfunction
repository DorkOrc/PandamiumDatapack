...
tellraw @s [" ",{"text":"Link 1: ","color":"#7FFFDF"},{"text":"findmcserver.com","color":"aqua","shadow_color":[0,0.75,0.75,0.75],"underlined":true,"clickEvent":{"action":"open_url","value":"https://findmcserver.com/server/pandamium?vote=true"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to vote through\n","color":"aqua"},{"text":"FindMCServer","bold":true}]},"extra":[" ",{"text":"(OFFICIAL)","bold":true,"color":"aqua","font":"minecraft:uniform"}]}]
tellraw @s [" ",{"text":"Link 2: ","color":"green"},{"text":"minecraft-server-list.com","color":"blue","underlined":true,"clickEvent":{"action":"open_url","value":"https://minecraft-server-list.com/server/445164/vote/"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to vote through\n","color":"blue"},{"text":"MCSL","bold":true}]}}]
tellraw @s [" ",{"text":"Link 3: ","color":"green"},{"text":"minecraftservers.org","color":"blue","underlined":true,"clickEvent":{"action":"open_url","value":"https://minecraftservers.org/vote/562059"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to vote through\n","color":"blue"},{"text":"MinecraftServers.org","bold":true}]}}]
tellraw @s [" ",{"text":"Link 4: ","color":"green"},{"text":"topminecraftservers.org","color":"blue","underlined":true,"clickEvent":{"action":"open_url","value":"http://topminecraftservers.org/vote/29717"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to vote through\n","color":"blue"},{"text":"TopMinecraftServers","bold":true}]}}]
tellraw @s [" ",{"text":"Link 5: ","color":"green"},{"text":"minecraft.global","color":"blue","underlined":true,"clickEvent":{"action":"open_url","value":"https://minecraft.global/servers/b559672e-7906-4d17-858b-3c630000a152/vote"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to vote through\n","color":"blue"},{"text":"minecraft.global","bold":true}]}}]
