...
execute if score @s parkour_1.best_time matches 1.. run tellraw @s [{storage:"pandamium:dictionary",nbt:"parkour.parkour_1.name",interpret:true,color:"dark_aqua"},{text:": "},{storage:"pandamium:temp",nbt:"formatted_time",interpret:true},{text:" (ARCHIVED)",color:"gray",font:"uniform",hover_event:{action:"show_text",value:{text:"You have completed this course,\nbut it no longer exists.",color:"gray"}}}]
...
execute if score @s parkour_2.best_time matches 1.. if score <hours> variable matches 0 run tellraw @s [{storage:"pandamium:dictionary",nbt:"parkour.parkour_2.name",interpret:true,color:"dark_aqua"},{text:": "},{storage:"pandamium:temp",nbt:"formatted_time",interpret:true},{text:" (ARCHIVED)",color:"gray",font:"uniform",hover_event:{action:"show_text",value:{text:"You have completed this course,\nbut it no longer exists.",color:"gray"}}}]
