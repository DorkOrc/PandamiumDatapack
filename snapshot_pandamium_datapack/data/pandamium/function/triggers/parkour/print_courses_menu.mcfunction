...
execute unless score @s optn.parkour.restart_on_fall matches 1 run tellraw @s [{"text":"New Attempt on Fall: ","color":"aqua","hoverEvent":{"action":"show_text","value":[{"text":"Click to cycle options for\n","color":"aqua"},{"text":"New Attempt on Fall","bold":true},[{"text":"","color":"dark_gray"},{"text":"\n• Off (Default)","color":"white"},"\n• On"],{"text":"\nIf On, falling on any course\nwill send you back to the\nbeginning and restart your timer,\nregardless of your checkpoint.\nUseful for speedruns!","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -15"}},{"text":"Off","color":"yellow","bold":true}]
execute if score @s optn.parkour.restart_on_fall matches 1 run tellraw @s [{"text":"New Attempt on Fall: ","color":"aqua","hoverEvent":{"action":"show_text","value":[{"text":"Click to cycle options for\n","color":"aqua"},{"text":"New Attempt on Fall","bold":true},[{"text":"\n• Off (Default)","color":"dark_gray"},{"text":"\n• On","color":"white"}],{"text":"\nIf On, falling on any course\nwill send you back to the\nbeginning and restart your timer,\nregardless of your checkpoint.\nUseful for speedruns!","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -15"}},{"text":"On","color":"yellow","bold":true}]
