...
execute if score @s parkour_1.best_time matches 1.. run tellraw @s [{storage:"pandamium:dictionary",nbt:"parkour.parkour_1.name",interpret:true,color:"dark_aqua"},{text:": "},{storage:"pandamium:temp",nbt:"formatted_time",interpret:true},{text:" (ARCHIVED)",color:"gray",font:"uniform",hover_event:{action:"show_text",text:{text:"You have completed this course,\nbut it no longer exists.",color:"gray"}}}]
...
execute if score @s parkour_2.best_time matches 1.. if score <hours> variable matches 0 run tellraw @s [{storage:"pandamium:dictionary",nbt:"parkour.parkour_2.name",interpret:true,color:"dark_aqua"},{text:": "},{storage:"pandamium:temp",nbt:"formatted_time",interpret:true},{text:" (ARCHIVED)",color:"gray",font:"uniform",hover_event:{action:"show_text",text:{text:"You have completed this course,\nbut it no longer exists.",color:"gray"}}}]
...
execute if score @s parkour_3.best_time_real matches 1.. run tellraw @s [{storage:"pandamium:dictionary",nbt:"parkour.parkour_3.name",interpret:true,color:"dark_aqua"},{text:": "},{storage:"pandamium:temp",nbt:"formatted_time",interpret:true}]
...
execute if score @s parkour_3.best_time_deathless matches 1.. run tellraw @s [{storage:"pandamium:dictionary",nbt:"parkour.parkour_3.name",interpret:true,color:"dark_aqua"},{text:" (Flawless): "},{storage:"pandamium:temp",nbt:"formatted_time",interpret:true}]
...
execute if score @s parkour_4.shortest_time.time matches 1.. run tellraw @s [{storage:"pandamium:dictionary",nbt:"parkour.parkour_4.name",interpret:true,color:"dark_aqua"},{text:" (Shortest Time): "},{storage:"pandamium:temp",nbt:"formatted_time",interpret:true},{text:" with "},{score:{name:"@s",objective:"parkour_4.shortest_time.falls"}},{text:" falls"}]
...
tellraw @s [{text:" ",color:"green"},{text:"[",color:"aqua",hover_event:{action:"show_text",text:[{text:"Click to teleport to the ",color:"aqua"},{storage:"pandamium:dictionary",nbt:"parkour.parkour_3.name",interpret:true,bold:true},{text:" parkour course"},{text:"\n\nOr run ",color:"dark_gray"},{text:"/trigger ",color:"gray"},{text:"parkour.warp.Forgotten_Caverns",color:"aqua"}]},click_event:{action:"run_command",command:"trigger parkour.warp.Forgotten_Caverns"},extra:[{storage:"pandamium:dictionary",nbt:"parkour.parkour_3.name",interpret:true},{text:"]"}]},{text:"  |  "},{text:"[",color:"aqua",hover_event:{action:"show_text",text:[{text:"Click to teleport to the ",color:"aqua"},{storage:"pandamium:dictionary",nbt:"parkour.parkour_4.name",interpret:true,bold:true},{text:" parkour course"},{text:"\n\nOr run ",color:"dark_gray"},{text:"/trigger ",color:"gray"},{text:"parkour.warp.Jack_o_Giggle",color:"aqua"}]},click_event:{action:"run_command",command:"trigger parkour.warp.Jack_o_Giggle"},extra:[{storage:"pandamium:dictionary",nbt:"parkour.parkour_4.name",interpret:true},{text:"]"}]}]

# options
tellraw @s {text:"\nOptions:",bold:true,color:"aqua"}
execute unless score @s hide_parkour_timer matches 1 run tellraw @s [{text:"\nShow Parkour Timer: ",color:"aqua",hover_event:{action:"show_text",text:[{text:"Click to cycle options for\n",color:"aqua"},{text:"Show Parkour Timer",bold:true},{text:"",color:"dark_gray",extra:[{text:"\n• On (Default)",color:"white"},{text:"\n• Off"}]}]},click_event:{action:"run_command",command:"trigger options set -5"}},{text:"On",color:"yellow",bold:true}]
