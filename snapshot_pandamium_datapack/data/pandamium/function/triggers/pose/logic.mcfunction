execute unless score @s gameplay_perms matches 6.. unless predicate pandamium:player/min_staff_perms/helper run return run tellraw @s [{text:"[Pose]",color:"dark_red"},{storage:"pandamium:dictionary",nbt:"triggers.supporter_only_trigger",interpret:true},{text:"\n This command would let you pose any armour stand and even make it float, be invisible, and more!",color:"gray"}]
