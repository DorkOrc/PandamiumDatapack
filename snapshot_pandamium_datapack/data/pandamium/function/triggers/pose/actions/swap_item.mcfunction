...
execute if score <cannot_swap> variable matches 0 if score <pose> variable matches -302 store success score <returned> variable run tellraw @a[tag=source,limit=1] [{text:"",color:"green"},{text:"[Pose]",color:"dark_green"},{text:" Swapped out target's "},{text:"head",color:"aqua"},{text:" slot!"}]
...
execute if score <cannot_swap> variable matches 0 if score <pose> variable matches -303 store success score <returned> variable run tellraw @a[tag=source,limit=1] [{text:"",color:"green"},{text:"[Pose]",color:"dark_green"},{text:" Swapped out target's "},{text:"off-hand",color:"aqua"},{text:" slot!"}]
