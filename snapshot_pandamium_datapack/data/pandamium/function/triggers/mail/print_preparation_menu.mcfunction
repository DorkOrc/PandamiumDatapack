...
execute unless data storage pandamium:temp display_title unless data storage pandamium.db.mail:io selected.entry.data.message if data storage pandamium.db.mail:io selected.entry.data.items[0] run data modify storage pandamium:temp display_title set value {text:"",extra:[{italic:true,text:"Mailed Items"},{text:" ",underlined:false},{text:"ℹ",color:"blue",underlined:false,hover_event:{action:"show_text",value:[{text:""},{text:"To send mail with a message and title, hold a book and quill when sending the mail and write your message on the first page with your title on the first line using markdown. For example:",color:"gray"},{text:"\n\n# Title Goes Here\nMessage goes here..."}]}}]}
execute unless data storage pandamium:temp display_title if score <has_message> variable matches 0 run data modify storage pandamium:temp display_title set value {text:"",extra:[{italic:true,text:"Untitled Mail"},{text:" ",underlined:false},{text:"ℹ",color:"blue",underlined:false,hover_event:{action:"show_text",value:[{text:""},{text:"To set a title, write a heading using markdown on the first line of a Book and Quill, then hold it and click the \"Add Message\" button. For example:",color:"gray"},{text:"\n\n# Title Goes Here\nMessage goes here..."}]}}]}
execute unless data storage pandamium:temp display_title if score <has_message> variable matches 1 run data modify storage pandamium:temp display_title set value {text:"",extra:[{italic:true,text:"Untitled Mail"},{text:" ",underlined:false},{text:"ℹ",color:"blue",underlined:false,hover_event:{action:"show_text",value:[{text:""},{text:"To set a title, write a heading using markdown on the first line of a Book and Quill, then hold it and click the \"Edit Message\" button. For example:",color:"gray"},{text:"\n\n# Title Goes Here\nMessage goes here..."}]}}]}
...
execute if score <receiver_type_is_player> variable matches 1 if data storage pandamium.db.mail:io selected.entry.receivers[1] run data modify storage pandamium:temp receiver_display_name set value {text:"Multiple Players"}
...
data modify storage pandamium:temp sender_display_name set value {text:"You"}
...
tellraw @s [{text:"To: ",color:"gray"},{text:"",color:"aqua",extra:[{storage:"pandamium:temp",nbt:"receiver_display_name",interpret:true}]}]
execute unless data storage pandamium:temp {sender_display_name:{text:"You"}} run tellraw @s [{text:"From: ",color:"gray"},{text:"",color:"aqua",extra:[{storage:"pandamium:temp",nbt:"sender_display_name",interpret:true}]}]
execute if data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run tellraw @s [{text:""},{text:"Ephemeral: ",color:"gray"},{text:"True",color:"#7AA4BB"}]
...
execute if score <attachment_slots_filled> variable matches 1.. run data modify storage pandamium:temp attachment_names set value [{text:""}]
...
execute if score <attachment_slots_filled> variable matches 1.. run tellraw @s [{text:"Attachments (",color:"gray"},{score:{name:"<attachment_slots_filled>",objective:"variable"}},"/5):",{text:"",color:"white",extra:[{storage:"pandamium:temp",nbt:"attachment_names[]",interpret:true,separator:{text:"\n• ",color:"gray"}}]}]
...
execute if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"player"} run data modify storage pandamium:temp modification_buttons append value {text:"[Send as Player]",color:"aqua",hover_event:{action:"show_text",value:[{text:"Click to set sender type to ",color:"aqua"},{text:"player",bold:true}]}}
execute if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"player"} run data modify storage pandamium:temp modification_buttons[-1].click_event set from storage pandamium.db.click_events:io selected.entry.click_event_root.click_event
...
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run function pandamium:utils/database/click_events/load_new
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run function pandamium:utils/database/click_events/modify/set_owner/from_self
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run function pandamium:utils/database/click_events/modify/set_trigger {trigger: "mail"}
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "set_sender_type_to_server"
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run data modify storage pandamium:temp modification_buttons append value {text:"[Send as Server]",color:"#FF0000",hover_event:{action:"show_text",value:[{text:"Click to set sender type to ",color:"#FF0000"},{text:"server",bold:true}]}}
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run data modify storage pandamium:temp modification_buttons[-1].click_event set from storage pandamium.db.click_events:io selected.entry.click_event_root.click_event
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run function pandamium:utils/database/click_events/save

# MODIFIER set the sender type to "staff"
execute if predicate pandamium:player/min_staff_perms/moderator if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run function pandamium:utils/database/click_events/load_new
execute if predicate pandamium:player/min_staff_perms/moderator if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run function pandamium:utils/database/click_events/modify/set_owner/from_self
execute if predicate pandamium:player/min_staff_perms/moderator if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run function pandamium:utils/database/click_events/modify/set_trigger {trigger: "mail"}
execute if predicate pandamium:player/min_staff_perms/moderator if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "set_sender_type_to_staff"
execute if predicate pandamium:player/min_staff_perms/moderator if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
execute if predicate pandamium:player/min_staff_perms/moderator if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run data modify storage pandamium:temp modification_buttons append value {text:"[Send as Staff]",color:"yellow",hover_event:{action:"show_text",value:[{text:"Click to set sender type to ",color:"yellow"},{text:"staff",bold:true}]}}
execute if predicate pandamium:player/min_staff_perms/moderator if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run data modify storage pandamium:temp modification_buttons[-1].click_event set from storage pandamium.db.click_events:io selected.entry.click_event_root.click_event
execute if predicate pandamium:player/min_staff_perms/moderator if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run function pandamium:utils/database/click_events/save
...
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run function pandamium:utils/database/click_events/load_new
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run function pandamium:utils/database/click_events/modify/set_owner/from_self
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run function pandamium:utils/database/click_events/modify/set_trigger {trigger: "mail"}
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "set_ephemeral"
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run data modify storage pandamium:temp modification_buttons append value {text:"[Set Ephemeral]",color:"#7AA4BB",hover_event:{action:"show_text",value:[{text:"Click to set ephemeral to ",color:"#7AA4BB"},{text:"true",bold:true}]}}
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run data modify storage pandamium:temp modification_buttons[-1].click_event set from storage pandamium.db.click_events:io selected.entry.click_event_root.click_event
execute if predicate pandamium:player/min_staff_perms/owner if score <receiver_type_is_player> variable matches 1 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run function pandamium:utils/database/click_events/save
...
execute if score <has_message> variable matches 0 run data modify storage pandamium:temp modification_buttons append value {text:"[Add a Message]",color:"dark_aqua",hover_event:{action:"show_text",value:[{text:"Click to add a message and title to your mail",color:"dark_aqua"}]}}
execute if score <has_message> variable matches 1 run data modify storage pandamium:temp modification_buttons append value {text:"[Edit Message]",color:"dark_aqua",hover_event:{action:"show_text",value:[{text:"Click to edit your mail's message and title",color:"dark_aqua"}]}}
data modify storage pandamium:temp modification_buttons[-1].click_event set from storage pandamium.db.click_events:io selected.entry.click_event_root.click_event
...
execute if score <receiver_type_is_news_feed> variable matches 0 if score <attachment_slots_filled> variable matches 0..4 run data modify storage pandamium:temp modification_buttons append value {text:"[Attach Item]",color:"dark_aqua",hover_event:{action:"show_text",value:[{text:"Click to attach a held item to the mail",color:"dark_aqua"}]}}
execute if score <receiver_type_is_news_feed> variable matches 0 if score <attachment_slots_filled> variable matches 0..4 run data modify storage pandamium:temp modification_buttons[-1].click_event set from storage pandamium.db.click_events:io selected.entry.click_event_root.click_event
...
execute if score <attachment_slots_filled> variable matches 1..5 run data modify storage pandamium:temp modification_buttons append value {text:"[Remove Attached Items]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to remove all attached items",color:"red"}]}}
execute if score <attachment_slots_filled> variable matches 1..5 run data modify storage pandamium:temp modification_buttons[-1].click_event set from storage pandamium.db.click_events:io selected.entry.click_event_root.click_event
execute if score <attachment_slots_filled> variable matches 1..5 run function pandamium:utils/database/click_events/save

execute if data storage pandamium:temp modification_buttons[0] run tellraw @s [{text:""},{text:"\nModifications: ",color:"aqua",bold:true},{text:"\n• ",color:"gray"},{storage:"pandamium:temp",nbt:"modification_buttons[]",interpret:true,separator:{text:"\n• ",color:"gray"}}]
...
execute if score <is_saved_as_draft> variable matches 1 if score <attachment_slots_filled> variable matches 1.. run tellraw @s ["",{text:"\nConfirm Send: ",color:"aqua",bold:true},{storage:"pandamium:temp",nbt:"confirm_send_click_event_root",interpret:true,extra:[{text:"[Confirm]",color:"dark_green",hover_event:{action:"show_text",value:[{text:"Click to ",color:"dark_green"},{text:"confirm",bold:true}," that the above\ndetails about your message are\ncorrect and ",{text:"send",bold:true}," it to ",{storage:"pandamium:temp",nbt:"receiver_display_name",interpret:true}]}}]},{text:"  |  ",color:"green"},{text:"[Delete Draft]",color:"gray",hover_event:{action:"show_text",value:[{text:"Remove all attachments to delete mail from drafts",color:"red"}]}}]
execute if score <is_saved_as_draft> variable matches 1 if score <has_content> variable matches 1 if score <attachment_slots_filled> variable matches 0 run tellraw @s ["",{text:"\nConfirm Send: ",color:"aqua",bold:true},{storage:"pandamium:temp",nbt:"confirm_send_click_event_root",interpret:true,extra:[{text:"[Confirm]",color:"dark_green",hover_event:{action:"show_text",value:[{text:"Click to ",color:"dark_green"},{text:"confirm",bold:true}," that the above\ndetails about your message are\ncorrect and ",{text:"send",bold:true}," it to ",{storage:"pandamium:temp",nbt:"receiver_display_name",interpret:true}]}}]},{text:"  |  ",color:"green"},{storage:"pandamium:temp",nbt:"delete_draft_click_event_root",interpret:true,extra:[{text:"[Delete Draft]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to ",color:"red"},{text:"delete draft",bold:true}]}}]}]
execute if score <is_saved_as_draft> variable matches 1 if score <has_content> variable matches 0 run tellraw @s ["",{text:"\nConfirm Send: ",color:"aqua",bold:true},{text:"[Confirm]",color:"gray",hover_event:{action:"show_text",value:{text:"You cannot send mail that has no content",color:"red"}}},{text:"  |  ",color:"green"},{storage:"pandamium:temp",nbt:"delete_draft_click_event_root",interpret:true,extra:[{text:"[Delete Draft]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to ",color:"red"},{text:"delete draft",bold:true}]}}]}]
execute if score <is_saved_as_draft> variable matches 0 if score <has_content> variable matches 1 run tellraw @s ["",{text:"\nConfirm Send: ",color:"aqua",bold:true},{storage:"pandamium:temp",nbt:"confirm_send_click_event_root",interpret:true,extra:[{text:"[Confirm]",color:"dark_green",hover_event:{action:"show_text",value:[{text:"Click to ",color:"dark_green"},{text:"confirm",bold:true}," that the above\ndetails about your message are\ncorrect and ",{text:"send",bold:true}," it to ",{storage:"pandamium:temp",nbt:"receiver_display_name",interpret:true}]}}]},{text:"  |  ",color:"green"},{storage:"pandamium:temp",nbt:"save_as_draft_click_event_root",interpret:true,extra:[{text:"[Save as Draft]",color:"dark_aqua",hover_event:{action:"show_text",value:[{text:"Click to ",color:"dark_aqua"},{text:"save as draft",bold:true}]}}]}]
execute if score <is_saved_as_draft> variable matches 0 if score <has_content> variable matches 0 run tellraw @s ["",{text:"\nConfirm Send: ",color:"aqua",bold:true},{text:"[Confirm]",color:"gray",hover_event:{action:"show_text",value:{text:"You cannot send mail that has no content",color:"red"}}},{text:"  |  ",color:"green"},{text:"[Save as Draft]",color:"gray",hover_event:{action:"show_text",value:{text:"You cannot save mail that has no content",color:"red"}}}]
