...
tellraw @s [{text:""},{text:"Title: ",color:"gray"},{storage:"pandamium:temp",nbt:"display_title",interpret:true,underlined:true}]
execute if score <has_message> variable matches 1 run tellraw @s [{text:""},{text:"Message:\n",color:"gray"},{storage:"pandamium.db.mail:io",nbt:"selected.entry.data.message",interpret:true}]
...
execute if score <attachment_slots_filled> variable matches 1.. run tellraw @s [{text:"Attachments (",color:"gray"},{score:{name:"<attachment_slots_filled>",objective:"variable"}},{text:"/5):"},{text:"",color:"white",extra:[{storage:"pandamium:temp",nbt:"attachment_names[]",interpret:true,separator:{text:"\n• ",color:"gray"}}]}]
...
execute if score <is_saved_as_draft> variable matches 1 if score <attachment_slots_filled> variable matches 1.. run tellraw @s [{text:""},{text:"\nConfirm Send: ",color:"aqua",bold:true},{storage:"pandamium:temp",nbt:"confirm_send_click_event_root",interpret:true,extra:[{text:"[Confirm]",color:"dark_green",hover_event:{action:"show_text",value:[{text:"Click to ",color:"dark_green"},{text:"confirm",bold:true},{text:" that the above\ndetails about your message are\ncorrect and "},{text:"send",bold:true},{text:" it to "},{storage:"pandamium:temp",nbt:"receiver_display_name",interpret:true}]}}]},{text:"  |  ",color:"green"},{text:"[Delete Draft]",color:"gray",hover_event:{action:"show_text",value:[{text:"Remove all attachments to delete mail from drafts",color:"red"}]}}]
execute if score <is_saved_as_draft> variable matches 1 if score <has_content> variable matches 1 if score <attachment_slots_filled> variable matches 0 run tellraw @s [{text:""},{text:"\nConfirm Send: ",color:"aqua",bold:true},{storage:"pandamium:temp",nbt:"confirm_send_click_event_root",interpret:true,extra:[{text:"[Confirm]",color:"dark_green",hover_event:{action:"show_text",value:[{text:"Click to ",color:"dark_green"},{text:"confirm",bold:true},{text:" that the above\ndetails about your message are\ncorrect and "},{text:"send",bold:true},{text:" it to "},{storage:"pandamium:temp",nbt:"receiver_display_name",interpret:true}]}}]},{text:"  |  ",color:"green"},{storage:"pandamium:temp",nbt:"delete_draft_click_event_root",interpret:true,extra:[{text:"[Delete Draft]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to ",color:"red"},{text:"delete draft",bold:true}]}}]}]
execute if score <is_saved_as_draft> variable matches 1 if score <has_content> variable matches 0 run tellraw @s [{text:""},{text:"\nConfirm Send: ",color:"aqua",bold:true},{text:"[Confirm]",color:"gray",hover_event:{action:"show_text",value:{text:"You cannot send mail that has no content",color:"red"}}},{text:"  |  ",color:"green"},{storage:"pandamium:temp",nbt:"delete_draft_click_event_root",interpret:true,extra:[{text:"[Delete Draft]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to ",color:"red"},{text:"delete draft",bold:true}]}}]}]
execute if score <is_saved_as_draft> variable matches 0 if score <has_content> variable matches 1 run tellraw @s [{text:""},{text:"\nConfirm Send: ",color:"aqua",bold:true},{storage:"pandamium:temp",nbt:"confirm_send_click_event_root",interpret:true,extra:[{text:"[Confirm]",color:"dark_green",hover_event:{action:"show_text",value:[{text:"Click to ",color:"dark_green"},{text:"confirm",bold:true},{text:" that the above\ndetails about your message are\ncorrect and "},{text:"send",bold:true},{text:" it to "},{storage:"pandamium:temp",nbt:"receiver_display_name",interpret:true}]}}]},{text:"  |  ",color:"green"},{storage:"pandamium:temp",nbt:"save_as_draft_click_event_root",interpret:true,extra:[{text:"[Save as Draft]",color:"dark_aqua",hover_event:{action:"show_text",value:[{text:"Click to ",color:"dark_aqua"},{text:"save as draft",bold:true}]}}]}]
execute if score <is_saved_as_draft> variable matches 0 if score <has_content> variable matches 0 run tellraw @s [{text:""},{text:"\nConfirm Send: ",color:"aqua",bold:true},{text:"[Confirm]",color:"gray",hover_event:{action:"show_text",value:{text:"You cannot send mail that has no content",color:"red"}}},{text:"  |  ",color:"green"},{text:"[Save as Draft]",color:"gray",hover_event:{action:"show_text",value:{text:"You cannot save mail that has no content",color:"red"}}}]

execute if score <is_saved_as_draft> variable matches 1 run tellraw @s [{text:"\n"},{text:"Pages: ",color:"yellow",bold:true},{storage:"pandamium:dictionary",nbt:"triggers.mail.main_menu_button",interpret:true},{text:" > ",color:"gray"},{storage:"pandamium:dictionary",nbt:"triggers.mail.drafts_menu_button",interpret:true}]
