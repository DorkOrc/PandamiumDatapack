...
execute unless data storage pandamium:temp {sender_display_name:'"You"'} run tellraw @s [{text:"From: ",color:"gray"},{text:"",color:"aqua",extra:[{storage:"pandamium:temp",nbt:"sender_display_name",interpret:true}]}]
