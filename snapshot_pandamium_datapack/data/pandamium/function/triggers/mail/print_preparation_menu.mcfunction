...
execute if score <public> variable matches 0 run function pandamium:utils/get/display_name/from_id with storage pandamium:templates macro.id
execute if score <public> variable matches 0 run data modify storage pandamium:temp receiver_display_name set from storage pandamium:temp display_name
execute if score <public> variable matches 0 if data storage pandamium.db.mail:io selected.entry.receivers[1] run data modify storage pandamium:temp receiver_display_name set value '"Multiple Players"'
execute if score <public> variable matches 1 run data modify storage pandamium:temp receiver_display_name set value '"News Feed"'
...
execute unless data storage pandamium.db.mail:io selected.entry.sender{type:"player"} run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "set_sender_type_to_player"
execute unless data storage pandamium.db.mail:io selected.entry.sender{type:"player"} run execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
execute unless data storage pandamium.db.mail:io selected.entry.sender{type:"player"} run data modify storage pandamium:temp set_sender_type_to_player_click_event_root set from storage pandamium.db.click_events:io selected.entry.click_event_root
...
execute if score @s staff_perms matches 5.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run function pandamium:utils/database/click_events/load_new
execute if score @s staff_perms matches 5.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run function pandamium:utils/database/click_events/modify/set_owner/from_self
execute if score @s staff_perms matches 5.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run function pandamium:utils/database/click_events/modify/set_trigger {trigger: "mail"}
execute if score @s staff_perms matches 5.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "set_sender_type_to_server"
execute if score @s staff_perms matches 5.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
execute if score @s staff_perms matches 5.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run data modify storage pandamium:temp set_sender_type_to_server_click_event_root set from storage pandamium.db.click_events:io selected.entry.click_event_root
execute if score @s staff_perms matches 5.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run function pandamium:utils/database/click_events/save
execute if score @s staff_perms matches 5.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run data modify storage pandamium:temp modification_buttons append value '[{"storage":"pandamium:temp","nbt":"set_sender_type_to_server_click_event_root","interpret":true},{"text":"[Send as Server]","color":"#FF0000","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set sender type to ","color":"#FF0000"},{"text":"server","bold":true}]}}]'

# MODIFIER set the sender type to "staff"
execute if score @s staff_perms matches 2.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run function pandamium:utils/database/click_events/load_new
execute if score @s staff_perms matches 2.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run function pandamium:utils/database/click_events/modify/set_owner/from_self
execute if score @s staff_perms matches 2.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run function pandamium:utils/database/click_events/modify/set_trigger {trigger: "mail"}
execute if score @s staff_perms matches 2.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "set_sender_type_to_staff"
execute if score @s staff_perms matches 2.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
execute if score @s staff_perms matches 2.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run data modify storage pandamium:temp set_sender_type_to_staff_click_event_root set from storage pandamium.db.click_events:io selected.entry.click_event_root
execute if score @s staff_perms matches 2.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run function pandamium:utils/database/click_events/save
execute if score @s staff_perms matches 2.. unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run data modify storage pandamium:temp modification_buttons append value '[{"storage":"pandamium:temp","nbt":"set_sender_type_to_staff_click_event_root","interpret":true},{"text":"[Send as Staff]","color":"yellow","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set sender type to ","color":"yellow"},{"text":"staff","bold":true}]}}]'
...
execute if score @s staff_perms matches 4.. if score <public> variable matches 0 if score <attachment_slots_filled> variable matches 0 run function pandamium:utils/database/click_events/load_new
execute if score @s staff_perms matches 4.. if score <public> variable matches 0 if score <attachment_slots_filled> variable matches 0 run function pandamium:utils/database/click_events/modify/set_owner/from_self
execute if score @s staff_perms matches 4.. if score <public> variable matches 0 if score <attachment_slots_filled> variable matches 0 run function pandamium:utils/database/click_events/modify/set_trigger {trigger: "mail"}
execute if score @s staff_perms matches 4.. if score <public> variable matches 0 if score <attachment_slots_filled> variable matches 0 run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "set_receiver_to_news_feed"
execute if score @s staff_perms matches 4.. if score <public> variable matches 0 if score <attachment_slots_filled> variable matches 0 run execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
execute if score @s staff_perms matches 4.. if score <public> variable matches 0 if score <attachment_slots_filled> variable matches 0 run data modify storage pandamium:temp set_receiver_to_news_feed_click_event_root set from storage pandamium.db.click_events:io selected.entry.click_event_root
execute if score @s staff_perms matches 4.. if score <public> variable matches 0 if score <attachment_slots_filled> variable matches 0 run function pandamium:utils/database/click_events/save
execute if score @s staff_perms matches 4.. if score <public> variable matches 0 if score <attachment_slots_filled> variable matches 0 run data modify storage pandamium:temp modification_buttons append value '[{"storage":"pandamium:temp","nbt":"set_receiver_to_news_feed_click_event_root","interpret":true},{"text":"[Set Receiver to News Feed]","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set receiver to ","color":"red"},{"text":"News Feed","bold":true}]}}]'

# MODIFIER set mail as ephemeral
execute if score @s staff_perms matches 5.. if score <public> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run function pandamium:utils/database/click_events/load_new
execute if score @s staff_perms matches 5.. if score <public> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run function pandamium:utils/database/click_events/modify/set_owner/from_self
execute if score @s staff_perms matches 5.. if score <public> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run function pandamium:utils/database/click_events/modify/set_trigger {trigger: "mail"}
execute if score @s staff_perms matches 5.. if score <public> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "set_ephemeral"
execute if score @s staff_perms matches 5.. if score <public> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
execute if score @s staff_perms matches 5.. if score <public> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run data modify storage pandamium:temp set_ephemeral_click_event_root set from storage pandamium.db.click_events:io selected.entry.click_event_root
execute if score @s staff_perms matches 5.. if score <public> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run function pandamium:utils/database/click_events/save
execute if score @s staff_perms matches 5.. if score <public> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run data modify storage pandamium:temp modification_buttons append value '[{"storage":"pandamium:temp","nbt":"set_ephemeral_click_event_root","interpret":true},{"text":"[Set Ephemeral]","color":"#7AA4BB","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set ephemeral to ","color":"#7AA4BB"},{"text":"true","bold":true}]}}]'
...
execute if score <public> variable matches 0 if score <attachment_slots_filled> variable matches 0..4 run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "add_item"
execute if score <public> variable matches 0 if score <attachment_slots_filled> variable matches 0..4 run execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
execute if score <public> variable matches 0 if score <attachment_slots_filled> variable matches 0..4 run data modify storage pandamium:temp add_item_click_event_root set from storage pandamium.db.click_events:io selected.entry.click_event_root
...
function pandamium:utils/database/click_events/modify/set_owner/from_self
function pandamium:utils/database/click_events/modify/set_trigger {trigger: "mail"}
data modify storage pandamium.db.click_events:io selected.entry.data.type set value "confirm_send"
execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
data modify storage pandamium:temp confirm_send_click_event_root set from storage pandamium.db.click_events:io selected.entry.click_event_root
function pandamium:utils/database/click_events/save
...
execute if score <is_saved_as_draft> variable matches 0 run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "save_as_draft"
execute if score <is_saved_as_draft> variable matches 0 store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
execute if score <is_saved_as_draft> variable matches 0 run data modify storage pandamium:temp save_as_draft_click_event_root set from storage pandamium.db.click_events:io selected.entry.click_event_root
