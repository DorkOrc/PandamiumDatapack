...
execute if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"player"} run function pandamium:utils/database/click_events/load_new
execute if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"player"} run function pandamium:utils/database/click_events/modify/set_owner/from_self
execute if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"player"} run function pandamium:utils/database/click_events/modify/set_trigger {trigger: "mail"}
execute if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"player"} run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "set_sender_type_to_player"
execute if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"player"} run execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
execute if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"player"} run data modify storage pandamium:temp set_sender_type_to_player_click_event_root set from storage pandamium.db.click_events:io selected.entry.click_event_root
execute if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"player"} run function pandamium:utils/database/click_events/save
...
execute if score @s staff_perms matches 5.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run function pandamium:utils/database/click_events/load_new
execute if score @s staff_perms matches 5.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run function pandamium:utils/database/click_events/modify/set_owner/from_self
execute if score @s staff_perms matches 5.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run function pandamium:utils/database/click_events/modify/set_trigger {trigger: "mail"}
execute if score @s staff_perms matches 5.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "set_sender_type_to_server"
...
execute if score @s staff_perms matches 5.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"server"} run function pandamium:utils/database/click_events/save
...
execute if score @s staff_perms matches 2.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run function pandamium:utils/database/click_events/load_new
execute if score @s staff_perms matches 2.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run function pandamium:utils/database/click_events/modify/set_owner/from_self
execute if score @s staff_perms matches 2.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run function pandamium:utils/database/click_events/modify/set_trigger {trigger: "mail"}
execute if score @s staff_perms matches 2.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "set_sender_type_to_staff"
execute if score @s staff_perms matches 2.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
...
execute if score @s staff_perms matches 2.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry.sender{type:"staff"} run function pandamium:utils/database/click_events/save
