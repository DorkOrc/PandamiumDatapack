...
execute if score <receiver_type_is_news_feed> variable matches 0 store result storage pandamium:templates macro.id.id int 1 run data get storage pandamium.db.mail:io selected.entry.receivers[0].id
execute if score <receiver_type_is_news_feed> variable matches 0 run function pandamium:utils/get/display_name/from_id with storage pandamium:templates macro.id
execute if score <receiver_type_is_news_feed> variable matches 0 run data modify storage pandamium:temp receiver_display_name set from storage pandamium:temp display_name
execute if score <receiver_type_is_news_feed> variable matches 0 if data storage pandamium.db.mail:io selected.entry.receivers[1] run data modify storage pandamium:temp receiver_display_name set value '"Multiple Players"'
execute if score <receiver_type_is_news_feed> variable matches 1 run data modify storage pandamium:temp receiver_display_name set value '{"text":"News Feed","color":"#00AA7F"}'
...
execute if score @s staff_perms matches 4.. if score <receiver_type_is_news_feed> variable matches 0 if score <attachment_slots_filled> variable matches 0 run function pandamium:utils/database/click_events/load_new
execute if score @s staff_perms matches 4.. if score <receiver_type_is_news_feed> variable matches 0 if score <attachment_slots_filled> variable matches 0 run function pandamium:utils/database/click_events/modify/set_owner/from_self
execute if score @s staff_perms matches 4.. if score <receiver_type_is_news_feed> variable matches 0 if score <attachment_slots_filled> variable matches 0 run function pandamium:utils/database/click_events/modify/set_trigger {trigger: "mail"}
execute if score @s staff_perms matches 4.. if score <receiver_type_is_news_feed> variable matches 0 if score <attachment_slots_filled> variable matches 0 run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "set_receiver_to_news_feed"
execute if score @s staff_perms matches 4.. if score <receiver_type_is_news_feed> variable matches 0 if score <attachment_slots_filled> variable matches 0 run execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
execute if score @s staff_perms matches 4.. if score <receiver_type_is_news_feed> variable matches 0 if score <attachment_slots_filled> variable matches 0 run data modify storage pandamium:temp set_receiver_to_news_feed_click_event_root set from storage pandamium.db.click_events:io selected.entry.click_event_root
execute if score @s staff_perms matches 4.. if score <receiver_type_is_news_feed> variable matches 0 if score <attachment_slots_filled> variable matches 0 run function pandamium:utils/database/click_events/save
execute if score @s staff_perms matches 4.. if score <receiver_type_is_news_feed> variable matches 0 if score <attachment_slots_filled> variable matches 0 run data modify storage pandamium:temp modification_buttons append value '[{"storage":"pandamium:temp","nbt":"set_receiver_to_news_feed_click_event_root","interpret":true},{"text":"[Set Receiver to News Feed]","color":"#00AA7F","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set receiver to ","color":"#00AA7F"},{"text":"News Feed","bold":true}]}}]'

# MODIFIER set mail as ephemeral
execute if score @s staff_perms matches 5.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run function pandamium:utils/database/click_events/load_new
execute if score @s staff_perms matches 5.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run function pandamium:utils/database/click_events/modify/set_owner/from_self
execute if score @s staff_perms matches 5.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run function pandamium:utils/database/click_events/modify/set_trigger {trigger: "mail"}
execute if score @s staff_perms matches 5.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run data modify storage pandamium.db.click_events:io selected.entry.data.type set value "set_ephemeral"
execute if score @s staff_perms matches 5.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run execute store result storage pandamium.db.click_events:io selected.entry.data.mail_id int 1 run scoreboard players get <mail_id> variable
...
execute if score @s staff_perms matches 5.. if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium.db.mail:io selected.entry{ephemeral:1b} run function pandamium:utils/database/click_events/save
