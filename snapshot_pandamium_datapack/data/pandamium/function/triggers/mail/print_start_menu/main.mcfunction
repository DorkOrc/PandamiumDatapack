...
tellraw @s ["",{"text":" ","color":"gray"},{"text":"[View News Feed]","color":"#7B00EC","hoverEvent":{"action":"show_text","contents":[{"text":"Click to go to ","color":"#7B00EC"},{"text":"News Feed","bold":true}," page"]},"clickEvent":{"action":"run_command","value":"/trigger mail set 1000007"}}]
