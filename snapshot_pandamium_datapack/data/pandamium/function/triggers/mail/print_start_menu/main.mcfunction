...
execute if score @s mail_data.unclaimed_items matches 2.. unless score @s mail_data.unread_mails matches 1.. in pandamium:staff_world run data modify block 3 0 0 front_text.messages[0] set value '[" ",{"storage":"pandamium:temp","nbt":"circled_number","color":"green","hoverEvent":{"action":"show_text","contents":[{"text":"You have ","color":"green"},{"score":{"name":"<unclaimed_items>","objective":"variable"}}," unclaimed item(s) in your inbox"]}}]'
...
execute if score @s mail_data.drafts matches 2.. in pandamium:staff_world run data modify block 3 0 0 front_text.messages[0] set value '[" ",{"storage":"pandamium:temp","nbt":"circled_number","color":"yellow","hoverEvent":{"action":"show_text","contents":[{"text":"You have ","color":"yellow"},{"score":{"name":"<drafts>","objective":"variable"}}," draft(s) in your drafts box"]}}]'
...
execute if score @s staff_rank matches 3.. if score @s send_extra_debug_info matches 2.. run tellraw @s [" ",{"text":"[View Server Outbox]","color":"#FF0000","hoverEvent":{"action":"show_text","contents":[{"text":"Click to go to ","color":"#FF0000"},{"text":"Server Outbox","bold":true}," page"]},"clickEvent":{"action":"run_command","value":"/trigger mail set 1000004"}}]
