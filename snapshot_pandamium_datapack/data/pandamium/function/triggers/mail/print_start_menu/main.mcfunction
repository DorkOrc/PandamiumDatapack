...
execute if score @s staff_perms matches 1.. run tellraw @s [" ",{"text":"[View Staff Team Inbox]","color":"yellow","hoverEvent":{"action":"show_text","contents":[{"text":"Click to go to ","color":"yellow"},{"text":"Staff Team Inbox","bold":true}," page"]},"clickEvent":{"action":"run_command","value":"/trigger mail set 1000008"}}]
