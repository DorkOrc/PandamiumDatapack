...
tellraw @s [" ",{text:"[View Inbox]",extra:[{storage:"pandamium:temp",nbt:"unread_mails_notifier",interpret:true},{storage:"pandamium:temp",nbt:"unclaimed_items_notifier",interpret:true}],color:"aqua",hover_event:{action:"show_text",value:[{text:"Click to go to ",color:"aqua"},{text:"Inbox",bold:true}," page"]},click_event:{action:"run_command",command:"trigger mail set 1000001"}}]

tellraw @s [\
    " ",\
        {text:"[View Outbox]",color:"dark_aqua",hover_event:{action:"show_text",value:[{text:"Click to go to ",color:"dark_aqua"},{text:"Outbox",bold:true}," page"]},click_event:{action:"run_command",command:"trigger mail set 1000002"}},\
            {text:"  |  ",color:"green"},\
            {text:"[Drafts]",extra:[{storage:"pandamium:temp",nbt:"mail_drafts_notifier",interpret:true}],color:"dark_aqua",hover_event:{action:"show_text",value:[{text:"Click to go to ",color:"dark_aqua"},{text:"Drafts",bold:true}," page"]},click_event:{action:"run_command",command:"trigger mail set 1000005"}},\
    "\n ",\
        {text:"[Send Mail]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to go to ",color:"blue"},{text:"Send Mail",bold:true}," page"]},click_event:{action:"run_command",command:"trigger mail set 1000003"}},\
    "\n ",\
        {text:"[View News Feed]",color:"#00AA7F",hover_event:{action:"show_text",value:[{text:"Click to go to ",color:"#00AA7F"},{text:"News Feed",bold:true}," page"]},click_event:{action:"run_command",command:"trigger mail set 1000007"}},\
]

execute if predicate pandamium:player/min_staff_perms/senior_moderator if score @s send_extra_debug_info matches 2.. run tellraw @s [" ",{text:"[View Server Outbox]",color:"#FF0000",hover_event:{action:"show_text",value:[{text:"Click to go to ",color:"#FF0000"},{text:"Server Outbox",bold:true}," page"]},click_event:{action:"run_command",command:"trigger mail set 1000004"}}]
...
execute if predicate pandamium:player/min_staff_perms/helper run data modify storage pandamium:temp unread_mails_notifier set value ""
execute if predicate pandamium:player/min_staff_perms/helper if score <unread_staff_mails> variable matches 1.. run data modify storage pandamium:temp unread_mails_notifier set value {text:" ",extra:[{text:"①",color:"#FF0000",hover_event:{action:"show_text",value:{text:"There is 1 unread mail in the staff team's inbox",color:"#FF0000"}}}]}
execute if predicate pandamium:player/min_staff_perms/helper if score <unread_staff_mails> variable matches 2.. store result score <unread_mails> variable store result storage pandamium:templates macro.value.value int 1 run scoreboard players get @s mail_data.unread_mails
execute if predicate pandamium:player/min_staff_perms/helper if score <unread_staff_mails> variable matches 2.. run function pandamium:utils/get/circled_number with storage pandamium:templates macro.value
execute if predicate pandamium:player/min_staff_perms/helper if score <unread_staff_mails> variable matches 2.. run data modify storage pandamium:temp unread_mails_notifier.extra[0].text set from storage pandamium:temp circled_number
...
execute if predicate pandamium:player/min_staff_perms/helper run data modify storage pandamium:temp unclaimed_items_notifier set value ""
execute if predicate pandamium:player/min_staff_perms/helper if score <unclaimed_items_in_staff_mails> variable matches 1 unless score <unread_staff_mails> variable matches 1.. run data modify storage pandamium:temp unclaimed_items_notifier set value {text:" ",extra:[{text:"⚠",color:"green",hover_event:{action:"show_text",value:{text:"There are unclaimed items in the staff team's inbox",color:"green"}}}]}
execute if predicate pandamium:player/min_staff_perms/helper run tellraw @s [" ",{text:"[View Staff Team Inbox]",extra:[{storage:"pandamium:temp",nbt:"unread_mails_notifier",interpret:true},{storage:"pandamium:temp",nbt:"unclaimed_items_notifier",interpret:true}],color:"yellow",hover_event:{action:"show_text",value:[{text:"Click to go to ",color:"yellow"},{text:"Staff Team Inbox",bold:true}," page"]},click_event:{action:"run_command",command:"trigger mail set 1000008"}}]

tellraw @s [{text:"\n",color:"green",extra:[{text:"ℹ",color:"blue"}," ",{text:"Hover here",color:"aqua"}," to learn how to ",{text:"send mail",color:"aqua"},"!"],hover_event:{action:"show_text",value:[{text:"How to send a mail:",color:"aqua"},{text:"\n",color:"green",extra:[{text:"1. ",color:"gray"},"Hold any item you want to send, or a Book and Quill with a message in it, in your main hand.",{text:"\n2. ",color:"gray"},"Run ",{text:"/trigger",color:"gray",extra:[{text:" mail",color:"aqua"}]}," and click ",{text:"[Send Mail]",color:"blue"}," then the person you want to send the mail to.",{text:"\n3. ",color:"gray"},"Open chat to look at the menu that has opened, and read through the information there. You can, optionally, add or edit a message and attach up to 5 item slots to the mail.",{text:"\n4. ",color:"gray"},"Click the ",{text:"[Confirm]",color:"dark_green"}," button to send the mail, or save it as a draft for later."]}]}}]
