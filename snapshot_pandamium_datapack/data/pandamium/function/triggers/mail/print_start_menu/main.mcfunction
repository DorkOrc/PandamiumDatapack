...
tellraw @s [{text:" "},{text:"[View Inbox]",extra:[{storage:"pandamium:temp",nbt:"unread_mails_notifier",interpret:true},{storage:"pandamium:temp",nbt:"unclaimed_items_notifier",interpret:true}],color:"aqua",hover_event:{action:"show_text",text:[{text:"Click to go to ",color:"aqua"},{text:"Inbox",bold:true},{text:" page"}]},click_event:{action:"run_command",command:"trigger mail set 1000001"}}]

tellraw @s [\
    {text:" "},\
        {text:"[View Outbox]",color:"dark_aqua",hover_event:{action:"show_text",text:[{text:"Click to go to ",color:"dark_aqua"},{text:"Outbox",bold:true},{text:" page"}]},click_event:{action:"run_command",command:"trigger mail set 1000002"}},\
            {text:"  |  ",color:"green"},\
            {text:"[Drafts]",extra:[{storage:"pandamium:temp",nbt:"mail_drafts_notifier",interpret:true}],color:"dark_aqua",hover_event:{action:"show_text",text:[{text:"Click to go to ",color:"dark_aqua"},{text:"Drafts",bold:true},{text:" page"}]},click_event:{action:"run_command",command:"trigger mail set 1000005"}},\
    {text:"\n "},\
        {text:"[Send Mail]",color:"blue",hover_event:{action:"show_text",text:[{text:"Click to go to ",color:"blue"},{text:"Send Mail",bold:true},{text:" page"}]},click_event:{action:"run_command",command:"trigger mail set 1000003"}},\
    {text:"\n "},\
        {text:"[View News Feed]",color:"#00AA7F",hover_event:{action:"show_text",text:[{text:"Click to go to ",color:"#00AA7F"},{text:"News Feed",bold:true},{text:" page"}]},click_event:{action:"run_command",command:"trigger mail set 1000007"}},\
]

execute if score @s staff_perms matches 3.. if score @s send_extra_debug_info matches 2.. run tellraw @s [{text:" "},{text:"[View Server Outbox]",color:"#FF0000",hover_event:{action:"show_text",text:[{text:"Click to go to ",color:"#FF0000"},{text:"Server Outbox",bold:true},{text:" page"}]},click_event:{action:"run_command",command:"trigger mail set 1000004"}}]
