...
execute if score @s mail matches 1000007 if score @s staff_perms matches 1.. if score @s send_extra_debug_info matches 2.. run return run function pandamium:triggers/mail/print_inbox_outbox_menu/main {type: "news_inbox", self: true}
