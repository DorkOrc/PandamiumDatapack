...
execute if score <receiver_type_is_news_feed> variable matches 0 run tellraw @s [{text:""},{text:"From: ",color:"gray"},{text:"",color:"aqua",extra:[{storage:"pandamium:temp",nbt:"sender_display_name",interpret:true}]},{text:" "},{text:"[⌚]",color:"dark_gray",hover_event:{action:"show_text",text:[{text:"Sent "},{storage:"pandamium:temp",nbt:"time_phrase",interpret:true}]}}]
execute if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium:temp {receiver_display_name:'"You"'} run tellraw @s [{text:""},{text:"To: ",color:"gray"},{text:"",color:"aqua",extra:[{storage:"pandamium:temp",nbt:"receiver_display_name",interpret:true}]}]

execute if score <has_attached_items> variable matches 1 if score <has_available_attached_items> variable matches 1 run tellraw @s [{text:""},{text:"Attachments: ",color:"gray"},{storage:"pandamium:temp",nbt:"take_incoming_items_click_event_root",interpret:true,extra:[{text:"[Take Attached Items]",color:"blue",hover_event:{action:"show_text",text:[{text:"Click to take the attached items from this mail",color:"blue"}]}}]},{storage:"pandamium:temp",nbt:"attached_items[{__viewable__:1b}].name",interpret:true,separator:{text:"\n• ",color:"gray"}}]
execute if score <has_attached_items> variable matches 1 if score <has_available_attached_items> variable matches 0 if score <has_viewable_attached_items> variable matches 1 run tellraw @s [{text:""},{text:"Attachments:",color:"gray"},{storage:"pandamium:temp",nbt:"attached_items[{__viewable__:1b}].name",interpret:true,separator:{text:"\n• ",color:"gray",strikethrough:false},strikethrough:true}]

execute if score <mail_is_ephemeral> variable matches 1 if score <has_available_attached_items> variable matches 0 run tellraw @s [{text:"\n"},{storage:"pandamium:temp",nbt:"delete_ephemeral_mail_click_event_root",interpret:true,extra:[{text:"[Delete This Mail]",color:"#7AA4BB",hover_event:{action:"show_text",text:[{text:"Click to delete this mail",color:"#7AA4BB"}]}}]}]

execute unless predicate pandamium:mail_list_type/news_feed_inbox unless predicate pandamium:mail_list_type/staff_inbox run tellraw @s [{text:"\n"},{text:"Pages: ",color:"yellow",bold:true},{storage:"pandamium:dictionary",nbt:"triggers.mail.main_menu_button",interpret:true},{text:" > ",color:"gray"},{storage:"pandamium:dictionary",nbt:"triggers.mail.inbox_menu_button",interpret:true}]
execute if predicate pandamium:mail_list_type/news_feed_inbox run tellraw @s [{text:"\n"},{text:"Pages: ",color:"yellow",bold:true},{storage:"pandamium:dictionary",nbt:"triggers.mail.main_menu_button",interpret:true},{text:" > ",color:"gray"},{storage:"pandamium:dictionary",nbt:"triggers.mail.news_feed_menu_button",interpret:true}]
execute if predicate pandamium:mail_list_type/staff_inbox run tellraw @s [{text:"\n"},{text:"Pages: ",color:"yellow",bold:true},{storage:"pandamium:dictionary",nbt:"triggers.mail.main_menu_button",interpret:true},{text:" > ",color:"gray"},{storage:"pandamium:dictionary",nbt:"triggers.mail.staff_inbox_menu_button",interpret:true}]
