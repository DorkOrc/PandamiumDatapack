...
execute if score <receiver_type_is_news_feed> variable matches 0 run function pandamium:triggers/mail/open_mail/validate_and_record_reciever with storage pandamium:templates macro.id
