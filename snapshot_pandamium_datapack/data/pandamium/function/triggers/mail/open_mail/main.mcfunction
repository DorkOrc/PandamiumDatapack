...
execute if score <receiver_type_is_news_feed> variable matches 0 if score <receiver_type_is_staff> variable matches 0 run function pandamium:triggers/mail/open_mail/validate_and_record_reciever with storage pandamium:local functions."pandamium:triggers/mail/open_mail/main"
...
execute if score <receiver_type_is_news_feed> variable matches 0 run function pandamium:triggers/mail/open_mail/update_cached_mail with storage pandamium:local functions."pandamium:triggers/mail/open_mail/main"
