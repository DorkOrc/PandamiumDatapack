...
execute if predicate pandamium:mail_list_type/any_outbox_or_drafts run function pandamium:triggers/mail/print_inbox_outbox_menu/get_player_display_names/main
...
execute if predicate pandamium:mail_list_type/any_outbox if data storage pandamium:temp entry_info.data.message run data modify storage pandamium:temp entry_info.display_info_components append value '["",{"text":"Message:\\n","color":"gray"},{"storage":"pandamium:temp","nbt":"entry_info.data.message","interpret":true}]'
execute unless predicate pandamium:mail_list_type/any_outbox if data storage pandamium:temp entry_info.data.preview if score <self> variable matches 1 run data modify storage pandamium:temp entry_info.display_info_components append value '["",{"text":"Preview:\\n","color":"gray"},{"storage":"pandamium:temp","nbt":"entry_info.data.preview","interpret":true},{"text":"...","color":"gray"}]'
execute unless predicate pandamium:mail_list_type/any_outbox if data storage pandamium:temp entry_info.data.preview if score <self> variable matches 0 run data modify storage pandamium:temp entry_info.display_info_components append value '["",{"text":"Message:\\n","color":"gray"},{"storage":"pandamium:temp","nbt":"entry_info.data.message","interpret":true}]'
