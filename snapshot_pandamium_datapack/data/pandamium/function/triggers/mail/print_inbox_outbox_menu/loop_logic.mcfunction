...
execute if predicate pandamium:mail_list_type/any_inbox if data storage pandamium:temp entry_info.data.preview if score <self> variable matches 1 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"",extra:[{text:"Preview:\n",color:"gray"},{storage:"pandamium:temp",nbt:"entry_info.data.preview",interpret:true},{text:"...",color:"gray"}]}
execute if predicate pandamium:mail_list_type/any_inbox if data storage pandamium:temp entry_info.data.preview if score <self> variable matches 0 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"",extra:[{text:"Message:\n",color:"gray"},{storage:"pandamium:temp",nbt:"entry_info.data.message",interpret:true}]}
