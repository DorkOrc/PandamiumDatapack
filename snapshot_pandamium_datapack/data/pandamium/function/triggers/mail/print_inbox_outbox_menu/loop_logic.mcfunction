...
execute unless data storage pandamium.db.mail:io selected run return run tellraw @s [{text:"• "},{text:"Invalid Mail",color:"red",underlined:true,hover_event:{action:"show_text",text:[{text:"Failed to load mail with arguments ",color:"red"},{storage:"pandamium:temp",nbt:"raw_entry"}]}}]
...
execute if score <self> variable matches 1 if predicate pandamium:mail_list_type/any_inbox unless predicate pandamium:mail_list_type/news_feed_inbox if score <readers> variable matches 2.. if score <read> variable matches 0 if score <other_readers> variable matches 2.. run data modify storage pandamium:temp entry_info.display_info_components append value '{"text":"Opened by ","extra":[{"score":{"name":"<other_readers>","objective":"variable"}}," other people"],"color":"dark_gray"}'
execute if score <self> variable matches 1 if predicate pandamium:mail_list_type/any_inbox unless predicate pandamium:mail_list_type/news_feed_inbox if score <readers> variable matches 2.. if score <read> variable matches 1 if score <other_readers> variable matches 2.. run data modify storage pandamium:temp entry_info.display_info_components append value '{"text":"Opened by you and ","extra":[{"score":{"name":"<other_readers>","objective":"variable"}}," other people"],"color":"dark_gray"}'
...
execute if score <self> variable matches 0 if score <readers> variable matches 2.. if score <read> variable matches 0 if score <other_readers> variable matches 2.. run data modify storage pandamium:temp entry_info.display_info_components append value '{"text":"Opened by ","extra":[{"score":{"name":"<other_readers>","objective":"variable"}}," people"],"color":"dark_gray"}'
execute if score <self> variable matches 0 if score <readers> variable matches 2.. if score <read> variable matches 1 if score <other_readers> variable matches 2.. run data modify storage pandamium:temp entry_info.display_info_components append value '{"text":"Opened by you and ","extra":[{"score":{"name":"<other_readers>","objective":"variable"}}," other people"],"color":"dark_gray"}'
