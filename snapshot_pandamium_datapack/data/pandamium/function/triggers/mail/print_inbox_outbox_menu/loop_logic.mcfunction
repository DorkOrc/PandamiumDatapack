...
$execute if predicate pandamium:mail_list_type/outbox_or_drafts if score <self> variable matches 1 unless data storage pandamium:temp entry_info.sender{id:$(id)} run return run tellraw @s [{text:"• "},{text:"Invalid Mail",color:"red",underlined:true,hover_event:{action:"show_text",value:[{text:"You are not a sender of this mail",color:"red"},{storage:"pandamium:temp",nbt:"entry_info.mail_id_tooltip",interpret:true}]}}]
execute if predicate pandamium:mail_list_type/drafts unless data storage pandamium.db.mail:io selected.entry{sent:0b} run return run tellraw @s [{text:"• "},{text:"Invalid Mail",color:"red",underlined:true,hover_event:{action:"show_text",value:[{text:"This mail has already been sent",color:"red"},{storage:"pandamium:temp",nbt:"entry_info.mail_id_tooltip",interpret:true}]}}]
...
execute store result score <other_readers> variable run scoreboard players operation <readers> variable += <indirect_readers> variable
execute if score <read> variable matches 1 run scoreboard players remove <other_readers> variable 1

data modify storage pandamium:temp entry_info.read_status_colour set value {text:"",color:"white"}
execute if score <self> variable matches 1 if score <read> variable matches 1 run data modify storage pandamium:temp entry_info.read_status_colour set value {text:"",color:"gray"}
execute if score <self> variable matches 0 if score <readers> variable matches 1.. run data modify storage pandamium:temp entry_info.read_status_colour set value {text:"",color:"gray"}
...
execute if predicate pandamium:mail_list_type/any_outbox_or_drafts if data storage pandamium:temp entry_info.data.message run data modify storage pandamium:temp entry_info.display_info_components append value {text:"",extra:[{text:"Message:\n",color:"gray"},{storage:"pandamium:temp",nbt:"entry_info.data.message",interpret:true}]}
execute if predicate pandamium:mail_list_type/any_inbox if score <self> variable matches 1 if data storage pandamium:temp entry_info.data.preview if data storage pandamium:temp entry_info.data{full_preview:1b} run data modify storage pandamium:temp entry_info.display_info_components append value {text:"",extra:[{text:"Message:\n",color:"gray"},{storage:"pandamium:temp",nbt:"entry_info.data.preview",interpret:true}]}
execute if predicate pandamium:mail_list_type/any_inbox if score <self> variable matches 1 if data storage pandamium:temp entry_info.data.preview unless data storage pandamium:temp entry_info.data{full_preview:1b} run data modify storage pandamium:temp entry_info.display_info_components append value {text:"",extra:[{text:"Message Preview:\n",color:"gray"},{storage:"pandamium:temp",nbt:"entry_info.data.preview",interpret:true},{text:"...",color:"gray"}]}
execute if predicate pandamium:mail_list_type/any_inbox if score <self> variable matches 0 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"",extra:[{text:"Message:\n",color:"gray"},{storage:"pandamium:temp",nbt:"entry_info.data.message",interpret:true}]}

execute if score <has_viewable_attached_items> variable matches 1 run function pandamium:triggers/mail/print_inbox_outbox_menu/resolve_attachment_names/main
execute if score <has_viewable_attached_items> variable matches 1 run data modify storage pandamium:temp entry_info.data.items prepend value {name:"",__viewable__:1b,taken:1b,__taken__:0b,__dummy__:1b}
execute if score <has_viewable_attached_items> variable matches 1 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"",extra:[{text:"Attachments:",color:"gray"},{storage:"pandamium:temp",nbt:"entry_info.data.items[{taken:1b}].name",interpret:true,strikethrough:true,separator:{text:"\n• ",color:"gray",strikethrough:false}},{storage:"pandamium:temp",nbt:"entry_info.data.items[{__taken__:0b}].name",interpret:true,separator:{text:"\n• ",color:"gray"}}]}

execute if score <self> variable matches 1 if predicate pandamium:mail_list_type/any_inbox unless predicate pandamium:mail_list_type/news_feed_inbox if score <readers> variable matches 0 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"Unopened",color:"dark_gray"}
execute if score <self> variable matches 1 if predicate pandamium:mail_list_type/any_inbox unless predicate pandamium:mail_list_type/news_feed_inbox if score <readers> variable matches 1 if score <read> variable matches 0 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"Opened by 1 other person",color:"dark_gray"}
execute if score <self> variable matches 1 if predicate pandamium:mail_list_type/any_inbox unless predicate pandamium:mail_list_type/news_feed_inbox if score <readers> variable matches 1 if score <read> variable matches 1 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"Opened",color:"dark_gray"}
execute if score <self> variable matches 1 if predicate pandamium:mail_list_type/any_inbox unless predicate pandamium:mail_list_type/news_feed_inbox if score <readers> variable matches 2.. if score <read> variable matches 0 if score <other_readers> variable matches 1 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"Opened by 1 other person",color:"dark_gray"}
execute if score <self> variable matches 1 if predicate pandamium:mail_list_type/any_inbox unless predicate pandamium:mail_list_type/news_feed_inbox if score <readers> variable matches 2.. if score <read> variable matches 1 if score <other_readers> variable matches 1 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"Opened by you and 1 other person",color:"dark_gray"}
execute if score <self> variable matches 1 if predicate pandamium:mail_list_type/any_inbox unless predicate pandamium:mail_list_type/news_feed_inbox if score <readers> variable matches 2.. if score <read> variable matches 0 if score <other_readers> variable matches 2.. run data modify storage pandamium:temp entry_info.display_info_components append value {text:"Opened by ",extra:[{score:{name:"<other_readers>",objective:"variable"}},{text:" other people"}],color:"dark_gray"}
...
execute if score <self> variable matches 0 if score <readers> variable matches 0 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"Unopened",color:"dark_gray"}
execute if score <self> variable matches 0 if score <readers> variable matches 1 if score <read> variable matches 0 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"Opened by 1 person",color:"dark_gray"}
execute if score <self> variable matches 0 if score <readers> variable matches 1 if score <read> variable matches 1 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"Opened by you",color:"dark_gray"}
execute if score <self> variable matches 0 if score <readers> variable matches 2.. if score <read> variable matches 0 if score <other_readers> variable matches 1 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"Opened by 1 person",color:"dark_gray"}
execute if score <self> variable matches 0 if score <readers> variable matches 2.. if score <read> variable matches 1 if score <other_readers> variable matches 1 run data modify storage pandamium:temp entry_info.display_info_components append value {text:"Opened by you and 1 other person",color:"dark_gray"}
