...
execute if dimension pandamium:staff_world unless predicate pandamium:player/min_staff_perms/helper run return run tellraw @s [{text:"[Homes]",color:"dark_red"},{text:" You cannot set a home in this dimension!",color:"red"}]
