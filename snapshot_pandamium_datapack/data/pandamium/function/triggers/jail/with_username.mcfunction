...
execute if score <target_is_online> variable matches 1 unless score @s silent_punishments matches 1 run tellraw @a [{text:"[Info] ",color:"dark_purple"},{storage:"pandamium:temp",nbt:"target",interpret:true,color:"light_purple"},{text:" was jailed by "},{storage:"pandamium:temp",nbt:"source",interpret:true,color:"light_purple"},{text:"!"}]
execute if score <target_is_online> variable matches 1 if score @s silent_punishments matches 1 run tellraw @a[scores={staff_perms=1..}] [{text:"",color:"gray"},{text:"[Staff Info] ",color:"dark_gray"},{storage:"pandamium:temp",nbt:"target",interpret:true,color:"gray"},{text:" was jailed by "},{storage:"pandamium:temp",nbt:"source",interpret:true,color:"gray"},{text:"!"}]
execute if score <target_is_online> variable matches 0 run tellraw @a[scores={staff_perms=1..}] [{text:"",color:"gray"},{text:"[Staff Info] ",color:"dark_gray"},{storage:"pandamium:temp",nbt:"target",interpret:true,color:"gray"},{text:" was jailed by "},{storage:"pandamium:temp",nbt:"source",interpret:true,color:"gray"},{text:"!"}]

execute if score <target_is_online> variable matches 1 run tellraw @a[scores={staff_perms=1..}] [{text:"",color:"gray"},{text:"[Staff Info] ",color:"dark_gray"},{storage:"pandamium:temp",nbt:"target",interpret:true,color:"gray"},{text:"'s id is "},{storage:"pandamium.db.players:io",nbt:"selected.entry.id",bold:true},{text:"! "},{text:"[→]",color:"blue",hover_event:{action:"show_text",text:[{text:"Click to teleport to ",color:"blue"},{text:"Jail Area",bold:true},{text:" in spectator mode"}]},click_event:{action:"run_command",command:"trigger spawn set -101"}}]
execute if score <target_is_online> variable matches 0 run tellraw @a[scores={staff_perms=1..}] [{text:"",color:"gray"},{text:"[Staff Info] ",color:"dark_gray"},{storage:"pandamium:temp",nbt:"target",interpret:true,color:"gray"},{text:"'s id is "},{storage:"pandamium.db.players:io",nbt:"selected.entry.id",bold:true},{text:"!"}]
