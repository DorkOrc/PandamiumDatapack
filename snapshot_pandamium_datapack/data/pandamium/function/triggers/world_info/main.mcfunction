...
tellraw @s [{text:"",color:"aqua"},{text:"Overworld:",bold:true},{text:"\n Players: ",color:"green"},{score:{name:"<overworld_player_count>",objective:"variable"},bold:true},{text:"\n Sleeping Players: ",color:"green"},{score:{name:"<total_sleeping_players>",objective:"variable"},bold:true},{text:" (",color:"gray",hover_event:{action:"show_text",value:[{text:"At least ",color:"gray"},{score:{name:"<minimum_sleeping_players_required>",objective:"variable"}},{text:" player(s) in the\noverworld are required to be\nsleeping in order to skip the\nnight."}]},extra:[{score:{name:"<total_sleeping_players>",objective:"variable"}},{text:"/"},{score:{name:"<minimum_sleeping_players_required>",objective:"variable"}},{text:")"}]},{text:"\n Mobs: ",color:"green"},{score:{name:"<overworld_mob_count>",objective:"variable"},bold:true}]
