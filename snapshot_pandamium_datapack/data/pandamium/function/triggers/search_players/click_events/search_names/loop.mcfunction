...
execute unless data storage pandamium:temp display_name run data modify storage pandamium:temp display_name set value {text:"<Invalid Username: ",color:"red",extra:[{storage:"pandamium:templates",nbt:"macro.username.username"},{text:">"}]}
