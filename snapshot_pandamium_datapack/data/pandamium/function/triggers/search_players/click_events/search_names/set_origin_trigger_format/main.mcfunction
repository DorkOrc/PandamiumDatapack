...
$execute if data storage pandamium:temp {origin_trigger:"jail"} run data modify block 3 0 0 front_text.messages[0] set value '["",{"text":"[J]","color":"dark_purple","hoverEvent":{"action":"show_text","contents":[{"text":"Click to jail ","color":"dark_purple"},{"storage":"pandamium:temp","nbt":"display_name","interpret":true}]},"clickEvent":{"action":"run_command","value":"/trigger jail set $(id)"}}," ",{"storage":"pandamium:temp","nbt":"display_name","interpret":true}]'
$execute if data storage pandamium:temp {origin_trigger:"unjail"} run data modify block 3 0 0 front_text.messages[0] set value '["",{"text":"[U]","color":"dark_purple","hoverEvent":{"action":"show_text","contents":[{"text":"Click to unjail ","color":"dark_purple"},{"storage":"pandamium:temp","nbt":"display_name","interpret":true}]},"clickEvent":{"action":"run_command","value":"/trigger unjail set $(id)"}}," ",{"storage":"pandamium:temp","nbt":"display_name","interpret":true}]'
$execute if data storage pandamium:temp {origin_trigger:"player_info"} run data modify block 3 0 0 front_text.messages[0] set value '["",{"text":"[👉]","color":"yellow","hoverEvent":{"action":"show_text","contents":[{"text":"Click to see player info for\\n","color":"yellow"},{"storage":"pandamium:temp","nbt":"display_name","interpret":true}]},"clickEvent":{"action":"run_command","value":"/trigger player_info_v2 set $(id)"}}," ",{"storage":"pandamium:temp","nbt":"display_name","interpret":true}]'
