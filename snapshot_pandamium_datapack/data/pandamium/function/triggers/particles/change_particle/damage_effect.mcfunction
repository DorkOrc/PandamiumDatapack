# removal option
execute if score @s particles matches -1999 unless score @s particles_data.damage_effect.type matches 1.. run return run tellraw @s [{"text":"","color":"red"},{"text":"[Particles]","color":"dark_red"}," You don't have a death/hurt effect enabled!"]
