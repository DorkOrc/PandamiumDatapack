...
tellraw @s [" ",{text:"[Search Offline Players]",color:"#6100B9",hover_event:{action:"show_text",value:[{text:"Click to search for players by username",color:"#6100B9"}]},click_event:{action:"run_command",command:"trigger player_info_v2 set 1000001"}}]
