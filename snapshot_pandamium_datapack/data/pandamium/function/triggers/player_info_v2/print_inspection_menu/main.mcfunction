...
$execute if score <target_is_online> variable matches 1 run tellraw @s [{text:" last_death_location: ",color:"gold"},{text:"[👁]",color:"dark_gray",hover_event:{action:"show_text",value:[{text:"",color:"gold"},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.last_death_location.pos[]",separator:" ",color:"yellow"}," in ",{nbt:"dimension_name",storage:"pandamium:temp",color:"yellow"}]}}," ",{text:"[→]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to teleport to ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},"'s ",{text:"last death location",bold:true}]},click_event:{action:"run_command",command:"trigger player_info_v2 set -8$(id_with_leading_zeroes)"}}]
...
$tellraw @s [{text:" tp_history: ",color:"gold"},{text:"[👁]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to see ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},"'s ",{text:"Teleport History",bold:true}]},click_event:{action:"run_command",command:"trigger player_info_v2 set -1$(id_with_leading_zeroes)"}}]
...
$execute if score <display_mail> variable matches 1 run tellraw @s [{text:" mail: ",color:"gold"},\
        {text:"[Inbox]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to see ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},"'s ",{text:"Inbox",bold:true},{text:"\n\nA command will be suggested to you, not automatically ran",color:"dark_gray"}]},click_event:{action:"suggest_command",command:"/trigger player_info_v2 set -2$(id_with_leading_zeroes)"}}," ",\
...
$tellraw @s ["",\
    ...
    "\n",\
        ...
        {text:"[none]",color:"green",hover_event:{action:"show_text",value:[{text:"Click to remove ",color:"green"},{storage:"pandamium:temp",nbt:"target",interpret:true},"'s RTP trigger restrictions"]},click_event:{action:"run_command",command:"trigger player_info_v2 set -4$(id_with_leading_zeroes)"}}," ",{text:"[5m]",color:"yellow",hover_event:{action:"show_text",value:[{text:"Click to set ",color:"yellow"},{storage:"pandamium:temp",nbt:"target",interpret:true},"'s RTP cooldown to 5 minutes"]},click_event:{action:"run_command",command:"trigger player_info_v2 set -5$(id_with_leading_zeroes)"}}," ",{text:"[1h]",color:"yellow",hover_event:{action:"show_text",value:[{text:"Click to set ",color:"yellow"},{storage:"pandamium:temp",nbt:"target",interpret:true},"'s RTP cooldown to 1 hour"]},click_event:{action:"run_command",command:"trigger player_info_v2 set -6$(id_with_leading_zeroes)"}}," ",{text:"[∞]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to disable ",color:"red"},{storage:"pandamium:temp",nbt:"target",interpret:true},"'s RTP trigger"]},click_event:{action:"run_command",command:"trigger player_info_v2 set -7$(id_with_leading_zeroes)"}},\
]
