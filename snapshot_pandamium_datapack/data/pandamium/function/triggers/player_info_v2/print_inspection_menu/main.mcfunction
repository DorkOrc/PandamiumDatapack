...
$execute if score $(username) last_position.y matches -2147483648.. run tellraw @s [{"text":" last_position: ","color":"gold"},{"text":"[👁]","color":"dark_gray","hoverEvent":{"action":"show_text","contents":[{"text":"","color":"gold"},[{"score":{"name":"$(username)","objective":"last_position.x"},"color":"yellow"}," ",{"score":{"name":"$(username)","objective":"last_position.y"}}," ",{"score":{"name":"$(username)","objective":"last_position.z"}}]," in ",{"nbt":"dimension_name","storage":"pandamium:temp","color":"yellow"}]}}," ",{"text":"[→]","color":"blue","hoverEvent":{"action":"show_text","contents":[{"text":"Click to teleport to ","color":"blue"},{"storage":"pandamium:temp","nbt":"target","interpret":true},"'s last position"]},"clickEvent":{"action":"run_command","value":"/trigger tp set $(id)"}}," ",{"text":"[🔙]","color":"red","hoverEvent":{"action":"show_text","value":[{"text":"Click to teleport ","color":"red"},{"storage":"pandamium:temp","nbt":"target","interpret":true}," to spawn and reset their ",{"text":"spawnpoint","bold":true},{"text":"\nIf they are offline, they will\nbe teleported when they next\njoin the server.","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger player_info_v2 set -9$(id_with_leading_zeroes)"}}]
$execute unless score $(username) last_position.y matches -2147483648.. run tellraw @s [{"text":" last_position: ","color":"gold"},{"text":"Unknown","color":"gray"}," ",{"text":"[🔙]","color":"red","hoverEvent":{"action":"show_text","value":[{"text":"Click to teleport ","color":"red"},{"storage":"pandamium:temp","nbt":"target","interpret":true}," to spawn",{"text":"\nIf they are offline, they will\nbe teleported when they next\njoin the server.","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger player_info_v2 set -9$(id_with_leading_zeroes)"}}]
