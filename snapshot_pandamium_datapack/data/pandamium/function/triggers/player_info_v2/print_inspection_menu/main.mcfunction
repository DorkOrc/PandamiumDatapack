...
$tellraw @s [{text:"======== ",color:"yellow"},{text:"Player Info",bold:true},{text:" ========"},{text:"\nPlayer: ",bold:true,color:"yellow"},{text:"",color:"aqua",extra:[{storage:"pandamium:temp",nbt:"target",interpret:true}]},{text:" ("},{score:{name:"$(username)",objective:"id"},bold:true},{text:")"}]

# playtimes
data modify storage pandamium:local functions."pandamium:triggers/player_info_v2/print_inspection_menu/*".playtime_display_modifiers set value [{text:{text:"[this_month]",color:"dark_gray",hover_event:{action:"show_text",value:[{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.monthly_playtime[3]"},{text:"h "},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.monthly_playtime[2]"},{text:"m "},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.monthly_playtime[1]"},{text:"s"}]}},type:"monthly"},{text:{text:"[this_year]",color:"dark_gray",hover_event:{action:"show_text",value:[{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.yearly_playtime[3]"},{text:"h "},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.yearly_playtime[2]"},{text:"m "},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.yearly_playtime[1]"},{text:"s"}]}},type:"yearly"}]
...
tellraw @s [{text:" playtime: ",color:"gold"},\
    {text:"",color:"yellow",extra:[{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.total_playtime[3]"},{text:"h "},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.total_playtime[2]"},{text:"m "},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.total_playtime[1]"},{text:"s"}]},{text:" "},\
...
execute if score <target_is_online> variable matches 1 run tellraw @s [{text:" session_length: ",color:"gold"},{text:"",color:"yellow",extra:[{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.session_playtime[3]"},{text:"h "},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.session_playtime[2]"},{text:"m "},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.session_playtime[1]"},{text:"s"}]}]

# votes
$data modify storage pandamium:local functions."pandamium:triggers/player_info_v2/print_inspection_menu/*".votes_display_modifiers set value [{text:{text:"[this_month]",color:"dark_gray",hover_event:{action:"show_text",value:[{score:{name:"$(username)",objective:"monthly_votes"}}]}},type:"monthly"},{text:{text:"[this_year]",color:"dark_gray",hover_event:{action:"show_text",value:[{score:{name:"$(username)",objective:"yearly_votes"}}]}},type:"yearly"}]
...
$execute if score $(username) votes matches 1.. run tellraw @s [{text:" votes: ",color:"gold"},\
    {score:{name:"$(username)",objective:"votes"},color:"yellow"},{text:" "},\
...
$execute if score $(username) last_position.y matches -2147483648.. run tellraw @s [{text:" last_position: ",color:"gold"},{text:"[👁]",color:"dark_gray",hover_event:{action:"show_text",value:[{text:"",color:"gold"},{score:{name:"$(username)",objective:"last_position.x"},color:"yellow",extra:[{text:" "},{score:{name:"$(username)",objective:"last_position.y"}},{text:" "},{score:{name:"$(username)",objective:"last_position.z"}}]},{text:" in "},{nbt:"dimension_name",storage:"pandamium:temp",color:"yellow"}]}},{text:" "},{text:"[→]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to teleport to ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s last position"}]},click_event:{action:"run_command",command:"trigger tp set $(id)"}},{text:" "},{text:"[🔙]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to teleport ",color:"red"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:" to spawn and reset their "},{text:"spawnpoint",bold:true},{text:"\nIf they are offline, they will\nbe teleported when they next\njoin the server.",color:"gray"}]},click_event:{action:"run_command",command:"trigger player_info_v2 set -9$(id_with_leading_zeroes)"}}]
$execute unless score $(username) last_position.y matches -2147483648.. run tellraw @s [{text:" last_position: ",color:"gold"},{text:"Unknown",color:"gray"},{text:" "},{text:"[🔙]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to teleport ",color:"red"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:" to spawn"},{text:"\nIf they are offline, they will\nbe teleported when they next\njoin the server.",color:"gray"}]},click_event:{action:"run_command",command:"trigger player_info_v2 set -9$(id_with_leading_zeroes)"}}]
...
function pandamium:utils/get/dimension_name/from_score
$execute if score $(username) spawnpoint_x matches -2147483648.. run tellraw @s [{text:" last_set_spawnpoint: ",color:"gold"},{text:"[👁]",color:"dark_gray",hover_event:{action:"show_text",value:[{text:"",color:"gold"},{score:{name:"$(username)",objective:"spawnpoint_x"},color:"yellow",extra:[{text:" "},{score:{name:"$(username)",objective:"spawnpoint_y"}},{text:" "},{score:{name:"$(username)",objective:"spawnpoint_z"}}]},{text:" in "},{nbt:"dimension_name",storage:"pandamium:temp",color:"yellow"}]}},{text:" "},{text:"[→]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to teleport to ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s "},{text:"spawnpoint",bold:true}]},click_event:{action:"run_command",command:"trigger spawnpoint set -$(id)"}}]

# pre-jail position
$execute store result score <dimension> variable run scoreboard players get $(username) pre_jail_pos_d
function pandamium:utils/get/dimension_name/from_score
$execute if score $(username) pre_jail_pos_x matches -2147483648.. run tellraw @s [{text:" pre_jail_position: ",color:"gold"},{text:"[👁]",color:"dark_gray",hover_event:{action:"show_text",value:[{text:"",color:"gold"},{score:{name:"$(username)",objective:"pre_jail_pos_x"},color:"yellow",extra:[{text:" "},{score:{name:"$(username)",objective:"pre_jail_pos_y"}},{text:" "},{score:{name:"$(username)",objective:"pre_jail_pos_z"}}]},{text:" in "},{nbt:"dimension_name",storage:"pandamium:temp",color:"yellow"}]}},{text:" "},{text:"[→]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to teleport to ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s pre-jail position"}]},click_event:{action:"run_command",command:"trigger pre_jail_tp set $(id)"}}]
...
$execute if score <target_is_online> variable matches 1 run tellraw @s [{text:" last_death_location: ",color:"gold"},{text:"[👁]",color:"dark_gray",hover_event:{action:"show_text",value:[{text:"",color:"gold"},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.last_death_location.pos[]",separator:" ",color:"yellow"},{text:" in "},{nbt:"dimension_name",storage:"pandamium:temp",color:"yellow"}]}},{text:" "},{text:"[→]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to teleport to ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s "},{text:"last death location",bold:true}]},click_event:{action:"run_command",command:"trigger player_info_v2 set -8$(id_with_leading_zeroes)"}}]
...
$tellraw @s [{text:" tp_history: ",color:"gold"},{text:"[👁]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to see ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s "},{text:"Teleport History",bold:true}]},click_event:{action:"run_command",command:"trigger player_info_v2 set -1$(id_with_leading_zeroes)"}}]

# inventory
$execute if score <target_is_online> variable matches 1 run tellraw @s [{text:" inventory: ",color:"gold"},\
        {text:"[👁]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to see ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s "},{text:"inventory",bold:true}]},click_event:{action:"run_command",command:"trigger inspect_inventory set $(id)"}},{text:" "},\
        {text:"[Take]",color:"dark_blue",hover_event:{action:"show_text",value:[{text:"Click to move ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s "},{text:"inventory",bold:true},{text:" to the staff world"},{text:"\n\nA command will be suggested to you, not automatically ran",color:"dark_gray"}]},click_event:{action:"suggest_command",command:"/trigger take_inventory set $(id)"}},\
]
...
$execute if score <target_is_online> variable matches 1 if items entity @a[predicate=pandamium:matches_id,limit=1] enderchest.* * run tellraw @s [{text:" ender_chest: ",color:"gold"},\
        {text:"[👁]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to see ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s "},{text:"ender chest",bold:true}]},click_event:{action:"run_command",command:"trigger inspect_enderchest set $(id)"}},{text:" "},\
        {text:"[Take]",color:"dark_blue",hover_event:{action:"show_text",value:[{text:"Click to move ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s "},{text:"ender chest",bold:true},{text:" to the staff world"},{text:"\n\nA command will be suggested to you, not automatically ran",color:"dark_gray"}]},click_event:{action:"suggest_command",command:"/trigger take_enderchest set $(id)"}},\
]

# items (offline)
$execute if score <target_is_online> variable matches 0 run tellraw @s [{text:" items: ",color:"gold"},\
        {text:"[Take]",color:"dark_blue",hover_event:{action:"show_text",value:[{text:"Click to move ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s "},{text:"inventory & ender chest",bold:true},{text:" to the staff world"},{text:"\n\nTheir items will be taken when\nthey next join the server.",color:"dark_gray"}]},click_event:{action:"run_command",command:"trigger player_info_v2 set -10$(id_with_leading_zeroes)"}},\
]
...
$execute if score <number_of_homes> variable matches 1.. run tellraw @s [{text:" homes: ",color:"gold"},\
        {score:{name:"<number_of_homes>",objective:"variable"},color:"yellow",hover_event:{action:"show_text",value:{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info_v2/print_inspection_menu/*'.homes_formatted[]",interpret:true,separator:"\n"}}},{text:" "},\
        {text:"[👁]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to see ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s "},{text:"homes",bold:true}]},click_event:{action:"run_command",command:"trigger homes set $(id)"}},\
]
...
$execute if score <display_mail> variable matches 1 run tellraw @s [{text:" mail: ",color:"gold"},\
        {text:"[Inbox]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to see ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s "},{text:"Inbox",bold:true},{text:"\n\nA command will be suggested to you, not automatically ran",color:"dark_gray"}]},click_event:{action:"suggest_command",command:"/trigger player_info_v2 set -2$(id_with_leading_zeroes)"}},{text:" "},\
        {text:"[Outbox]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to see ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s "},{text:"Outbox",bold:true},{text:"\n\nA command will be suggested to you, not automatically ran",color:"dark_gray"}]},click_event:{action:"suggest_command",command:"/trigger player_info_v2 set -3$(id_with_leading_zeroes)"}},\
]

# misc
$tellraw @s [{text:""},\
        {text:"Punishments:",color:"aqua",bold:true},{text:" "},\
        {text:"[Jail]",color:"light_purple",hover_event:{action:"show_text",value:[{text:"Click to jail ",color:"light_purple"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"\n\nA command will be suggested to you, not automatically ran",color:"dark_gray"}]},click_event:{action:"suggest_command",command:"/trigger jail set $(id)"}},{text:" "},\
        {text:"[Unjail]",color:"dark_purple",hover_event:{action:"show_text",value:[{text:"Click to unjail ",color:"dark_purple"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"\n\nA command will be suggested to you, not automatically ran",color:"dark_gray"}]},click_event:{action:"suggest_command",command:"/trigger unjail set $(id)"}},{text:" "},\
        {text:"[Kick]",color:"dark_aqua",hover_event:{action:"show_text",value:[{text:"Click to kick ",color:"dark_aqua"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"\nPlayer must be online",color:"red"},{text:"\n\nA command will be suggested to you, not automatically ran",color:"dark_gray"}]},click_event:{action:"suggest_command",command:"/trigger kick set $(id)"}},{text:" "},\
    ...
    {text:"\n"},\
        {text:"RTP Cooldown:",color:"aqua",bold:true},{text:" "},\
        {text:"[none]",color:"green",hover_event:{action:"show_text",value:[{text:"Click to remove ",color:"green"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s RTP trigger restrictions"}]},click_event:{action:"run_command",command:"trigger player_info_v2 set -4$(id_with_leading_zeroes)"}},{text:" "},{text:"[5m]",color:"yellow",hover_event:{action:"show_text",value:[{text:"Click to set ",color:"yellow"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s RTP cooldown to 5 minutes"}]},click_event:{action:"run_command",command:"trigger player_info_v2 set -5$(id_with_leading_zeroes)"}},{text:" "},{text:"[1h]",color:"yellow",hover_event:{action:"show_text",value:[{text:"Click to set ",color:"yellow"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s RTP cooldown to 1 hour"}]},click_event:{action:"run_command",command:"trigger player_info_v2 set -6$(id_with_leading_zeroes)"}},{text:" "},{text:"[∞]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to disable ",color:"red"},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s RTP trigger"}]},click_event:{action:"run_command",command:"trigger player_info_v2 set -7$(id_with_leading_zeroes)"}},\
]
