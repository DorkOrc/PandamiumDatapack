...
data modify storage pandamium:local functions."pandamium:triggers/player_info_v2/print_inspection_menu/*".display_alt_of set from block 5 0 0 item.components.minecraft:custom_name
