...
# do restart
execute if score <course> variable matches 3 run tellraw @s [{text:"[Parkour] ",color:"dark_green"},{text:"Restarted the ",color:"green",extra:[{storage:"pandamium:dictionary",nbt:"parkour.parkour_3.name",interpret:true,color:"aqua"},{text:" parkour course!"}]}]
...
execute if score <course> variable matches 4 run tellraw @s [{text:"[Parkour] ",color:"dark_green"},{text:"Restarted the ",color:"green",extra:[{storage:"pandamium:dictionary",nbt:"parkour.parkour_4.name",interpret:true,color:"aqua"},{text:" parkour course! New attempt started."}]}]
