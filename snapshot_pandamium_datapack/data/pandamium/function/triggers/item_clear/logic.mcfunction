execute if score @s item_clear matches 1.. run return run tellraw @s [{text:"[Item Clear]",color:"dark_red"},{text:" Confirm Item Clear ",color:"red"},{text:"[✔]",color:"dark_green",hover_event:{action:"show_text",value:[{text:"Click to clear ",color:"dark_green"},{text:"Simple Items",bold:true},{text:" and "},{text:"Arrows",bold:true},{text:" now"}]},click_event:{action:"run_command",command:"trigger item_clear set -2"}},{text:" "},{text:"[⌛]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to clear ",color:"blue"},{text:"Common Items",bold:true},{text:" in 30 seconds"}]},click_event:{action:"run_command",command:"trigger item_clear set -1"}}]
