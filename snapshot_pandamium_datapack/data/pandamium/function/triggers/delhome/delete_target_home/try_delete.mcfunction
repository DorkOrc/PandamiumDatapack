...
$tellraw @s [{text:"",color:"green"},{text:"[Homes]",color:"dark_green"},{text:" Deleted "},{storage:"pandamium:temp",nbt:"target",interpret:true},{text:"'s "},{storage:"pandamium:temp",nbt:"home_name",interpret:true},{text:" (previously at "},{storage:"pandamium.db.players:io",nbt:"selected.entry.data.homes.$(home).xyzd[0]",color:"aqua"},{text:" "},{storage:"pandamium.db.players:io",nbt:"selected.entry.data.homes.$(home).xyzd[1]",color:"aqua"},{text:" "},{storage:"pandamium.db.players:io",nbt:"selected.entry.data.homes.$(home).xyzd[2]",color:"aqua"},{text:" in "},{nbt:"dimension_name",storage:"pandamium:temp",color:"aqua"},{text:")!"}]
