...
execute store success score <name_not_filtered> variable run data modify storage pandamium:temp item.components."minecraft:custom_data".pandamium.font.ignore_custom_name set from storage pandamium:temp item.components."minecraft:custom_name"
execute if score <name_not_filtered> variable matches 0 run data remove storage pandamium:temp item.components."minecraft:custom_name"
...
execute if score <modify_style> variable matches 1 run return run tellraw @s [{text:"",color:"green"},{text:"[Item Font]",color:"dark_green"},{text:" Updated the "},{text:"name",color:"aqua"},{text:" of your selected item: "},{text:"",color:"white",italic:true,extra:[{nbt:'item.components."minecraft:custom_name"',storage:"pandamium:temp",interpret:true}]}]
execute if score <modify_lore> variable matches 1 run return run tellraw @s [{text:"",color:"green"},{text:"[Item Font]",color:"dark_green"},{text:" Updated the "},{text:"name and lore",color:"aqua"},{text:" of your selected item!"}]
