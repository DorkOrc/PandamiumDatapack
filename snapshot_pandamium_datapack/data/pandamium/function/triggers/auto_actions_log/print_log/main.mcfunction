...
tellraw @s [{text:"======== ",color:"yellow"},{text:"Auto-Actions Log",bold:true},{text:" ========"},{text:"\nEntries:",bold:true}]

execute unless data storage pandamium:auto_actions print_list[0] run tellraw @s {text:" n/a",color:"red",hover_event:{action:"show_text",text:{text:"There are no entries in the auto-actions log!",color:"red"}}}
