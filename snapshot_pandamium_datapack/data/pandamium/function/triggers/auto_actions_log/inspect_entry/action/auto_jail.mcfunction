...
tellraw @s [{text:"[Auto-Actions Log]",color:"gold"},{text:" Teleported to ",color:"yellow",extra:[{nbt:"selected_entry.username",storage:"pandamium:auto_actions"},{text:"'s "},{text:"Pre-Jail Location",bold:true},{text:" in spectator mode!"}]}]
