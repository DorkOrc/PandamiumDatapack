...
tellraw @s [{text:"[Warp]",color:"dark_red"},{text:" That is not a valid option! ",color:"red",extra:[{text:"ℹ",color:"blue",hover_event:{action:"show_text",text:[{text:"• "},{storage:"pandamium:temp",nbt:"options[]",separator:"\n• "}]}}]}]
