...
execute if score <chosen_type> variable matches 4..5 store result storage pandamium:local functions."pandamium:triggers/dye/*".color_0 int 1 store result storage pandamium:local functions."pandamium:triggers/dye/*".color_1 int 1 store result storage pandamium:local functions."pandamium:triggers/dye/*".color_2 int 1 store result storage pandamium:local functions."pandamium:triggers/dye/*".color_3 int 1 store result storage pandamium:local functions."pandamium:triggers/dye/*".color_4 int 1 run data get storage pandamium:local functions."pandamium:triggers/dye/*".colors[0]
execute if score <chosen_type> variable matches 4..5 if data storage pandamium:local functions."pandamium:triggers/dye/*".colors[1] run data modify storage pandamium:local functions."pandamium:triggers/dye/*".color_1 set from storage pandamium:local functions."pandamium:triggers/dye/*".colors[1]
execute if score <chosen_type> variable matches 4..5 if data storage pandamium:local functions."pandamium:triggers/dye/*".colors[2] run data modify storage pandamium:local functions."pandamium:triggers/dye/*".color_2 set from storage pandamium:local functions."pandamium:triggers/dye/*".colors[2]
execute if score <chosen_type> variable matches 4..5 if data storage pandamium:local functions."pandamium:triggers/dye/*".colors[3] run data modify storage pandamium:local functions."pandamium:triggers/dye/*".color_3 set from storage pandamium:local functions."pandamium:triggers/dye/*".colors[3]
execute if score <chosen_type> variable matches 5 if data storage pandamium:local functions."pandamium:triggers/dye/*".colors[4] run data modify storage pandamium:local functions."pandamium:triggers/dye/*".color_4 set from storage pandamium:local functions."pandamium:triggers/dye/*".colors[4]
