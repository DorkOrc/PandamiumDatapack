...
execute unless data storage pandamium:containers items[0] run return run tellraw @s [{text:"[Containers] ",color:"dark_red"},{text:"The ",color:"red",extra:[{nbt:"containers.display_id",storage:"pandamium:temp",interpret:true,bold:true},{text:" at "},{nbt:"containers.nbt.x",storage:"pandamium:temp",plain:true,bold:true,extra:[{text:" "},{nbt:"containers.nbt.y",storage:"pandamium:temp",plain:true},{text:" "},{nbt:"containers.nbt.z",storage:"pandamium:temp",plain:true}]},{text:" has no items in it!"}]}]
...
tellraw @s [{text:"========",color:"yellow"},{text:" Block Contents ",bold:true},"========",{text:"\nContainer Type: ",bold:true,color:"yellow"},{nbt:"containers.display_id",storage:"pandamium:temp",interpret:true,color:"green"},{text:"\nLocation: ",bold:true,color:"yellow"},{nbt:"containers.nbt.x",storage:"pandamium:temp",plain:true,bold:true,color:"gold",extra:[" ",{nbt:"containers.nbt.y",storage:"pandamium:temp",plain:true}," ",{nbt:"containers.nbt.z",storage:"pandamium:temp",plain:true}]}]
