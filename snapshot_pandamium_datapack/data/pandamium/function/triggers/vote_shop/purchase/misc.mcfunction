...
execute if score <value_in_section> variable matches 38 store success score <has_given> variable run loot give @s loot pandamium:loot_bundle/spring_drop_2025
