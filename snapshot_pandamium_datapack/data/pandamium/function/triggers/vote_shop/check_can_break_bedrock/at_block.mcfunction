...
scoreboard players set <bedrock_bottom_layer> variable 0
...
execute if dimension the_nether if score <bedrock_y> variable matches 0 store result score <bedrock_bottom_layer> variable run scoreboard players set <bedrock_valid_pos> variable 1
...
execute if dimension overworld if score <bedrock_y> variable matches -64 store result score <bedrock_bottom_layer> variable run scoreboard players set <bedrock_valid_pos> variable 1
...
execute if score <can_buy> variable matches 1 if score <bedrock_bottom_layer> variable matches 0 run setblock ~ ~ ~ air destroy
execute if score <can_buy> variable matches 1 if score <bedrock_bottom_layer> variable matches 1 run setblock ~ ~ ~ barrier destroy
