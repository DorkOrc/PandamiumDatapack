...
execute if predicate pandamium:player/min_gameplay_perms/elder run execute store result score <hide_auto_messages> variable run scoreboard players operation @s options /= #10 constant
execute if predicate pandamium:player/min_gameplay_perms/elder run scoreboard players operation <hide_auto_messages> variable %= #10 constant
...
execute if predicate pandamium:player/min_gameplay_perms/elder run execute if score <hide_auto_messages> variable matches 0 run scoreboard players reset @s hide_auto_messages
execute if predicate pandamium:player/min_gameplay_perms/elder run execute if score <hide_auto_messages> variable matches 1 run scoreboard players set @s hide_auto_messages 1
