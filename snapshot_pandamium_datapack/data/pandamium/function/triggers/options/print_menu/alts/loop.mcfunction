...
$execute unless data storage pandamium:temp alts[0].flags run tellraw @s [{text:"• "},{storage:"pandamium.db.players:io",nbt:"selected.entry.username",hover_event:{action:"show_text",value:{text:'Click to copy "$(id)" to clipboard'}},extra:[{text:" "},{text:"(",color:"gray",extra:[{storage:"pandamium:temp",nbt:"alts[0].id",bold:true},{text:")"}]}]},{text:" "},{text:"[flags]",color:"dark_gray",hover_event:{action:"show_text",value:"none"}}]
$execute if data storage pandamium:temp alts[0].flags run tellraw @s [{text:"• "},{storage:"pandamium.db.players:io",nbt:"selected.entry.username",hover_event:{action:"show_text",value:{text:'Click to copy "$(id)" to clipboard'}},extra:[{text:" "},{text:"(",color:"gray",extra:[{storage:"pandamium:temp",nbt:"alts[0].id",bold:true},{text:")"}]}]},{text:" "},{text:"[flags]",color:"dark_gray",hover_event:{action:"show_text",value:[{storage:"pandamium:temp",nbt:"alts[0].flags"}]}}]
