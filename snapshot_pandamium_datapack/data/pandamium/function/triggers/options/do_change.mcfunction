...
execute if score @s options matches -11 store success score @s optn.custom_dye unless score @s optn.custom_dye matches 1
execute if score @s options matches -11 run function pandamium:triggers/options/print_menu/gameplay
execute if score @s options matches -11 if score @s optn.custom_dye matches 0 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"}," Set option ",{"text":"Rainbow Armour","color":"aqua"}," to ",{"text":"Off","bold":true,"color":"yellow"},"!"]
execute if score @s options matches -11 if score @s optn.custom_dye matches 1 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"}," Set option ",{"text":"Rainbow Armour","color":"aqua"}," to ",{"text":"On","bold":true,"color":"yellow"},"!"]
execute if score @s options matches -11 if score @s optn.custom_dye matches 0 if items entity @s armor.* *[custom_data~{pandamium:{custom_dye:{}}}] run advancement grant @s only pandamium:detect/obtain_custom_dyed_item
