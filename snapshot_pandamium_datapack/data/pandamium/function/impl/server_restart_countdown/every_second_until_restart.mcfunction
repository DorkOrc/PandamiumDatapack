...
execute if score <broadcast> variable matches 1 if score <server_restart_countdown_start> global matches 1 run tellraw @a [{text:"[Warning]",color:"dark_red"},{text:" The server will be temporarily closed in\n ",color:"red",extra:[{storage:"pandamium:temp",nbt:"time_left",interpret:true,bold:true,color:"yellow"},{storage:"pandamium:global",nbt:"restart_reason",interpret:true},{text:"!"}]}]
execute if score <broadcast> variable matches 1 unless score <server_restart_countdown_start> global matches 1 run tellraw @a [{text:"[Warning]",color:"dark_red"},{text:" The server will close in ",color:"red",extra:[{storage:"pandamium:temp",nbt:"time_left",interpret:true,bold:true,color:"yellow"},{text:"!"}]}]
