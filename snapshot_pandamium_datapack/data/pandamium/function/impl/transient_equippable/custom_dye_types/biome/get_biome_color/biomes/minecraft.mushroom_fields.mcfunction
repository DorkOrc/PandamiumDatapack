...
scoreboard players set @s custom_dye.color_transition.target_red 195
scoreboard players set @s custom_dye.color_transition.target_green 40
scoreboard players set @s custom_dye.color_transition.target_blue 38
