...
function pandamium:utils/log {args:{message:["Teleported ",{storage:"pandamium:temp",nbt:"username",interpret:true}," from [",{storage:"pandamium:templates",nbt:"teleport.from[0]",plain:true}," ",{storage:"pandamium:templates",nbt:"teleport.from[1]",plain:true}," ",{storage:"pandamium:templates",nbt:"teleport.from[2]",plain:true}," in ",{storage:"pandamium:local",nbt:'functions."pandamium:impl/teleport/store_teleport/main".from_dimension_string_id',interpret:true},"] to [",{storage:"pandamium:templates",nbt:"teleport.to[0]",plain:true}," ",{storage:"pandamium:templates",nbt:"teleport.to[1]",plain:true}," ",{storage:"pandamium:templates",nbt:"teleport.to[2]",plain:true}," in ",{storage:"pandamium:local",nbt:'functions."pandamium:impl/teleport/store_teleport/main".to_dimension_string_id',interpret:true},'] by "',{storage:"pandamium:temp",nbt:"source_escaped",interpret:true},'"']}}
