...
execute store result storage pandamium:templates teleport.to[3] int 1 store result score <dimension> variable run function pandamium:utils/get/dimension_id
