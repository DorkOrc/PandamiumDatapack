...
execute if score <different> variable matches 1 run function pandamium:impl/text/get_compound_from_input/raise_error {message:{text:"Illegal push: Cannot push ",extra:[{storage:"pandamium:temp",nbt:"push_source.type"},{text:" into a list"}]}}
