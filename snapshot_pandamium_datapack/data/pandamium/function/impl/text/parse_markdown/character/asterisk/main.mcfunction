...
execute if data storage pandamium:local functions."pandamium:impl/text/parse_markdown/*"{next_character:"*"} run return run function pandamium:impl/text/parse_markdown/character/asterisk/double_asterisk
