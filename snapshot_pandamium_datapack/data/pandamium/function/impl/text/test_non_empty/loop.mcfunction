...
execute if score <type_is_compound> variable if score <string_length> variable matches 0 if data storage pandamium:local functions."pandamium:impl/text/test_non_empty/*".this_component.translate run return 1
execute if score <type_is_compound> variable if score <string_length> variable matches 0 if data storage pandamium:local functions."pandamium:impl/text/test_non_empty/*".this_component.keybind run return 1
