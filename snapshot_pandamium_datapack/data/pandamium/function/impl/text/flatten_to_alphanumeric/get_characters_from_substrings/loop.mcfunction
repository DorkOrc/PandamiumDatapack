...
# character
data modify storage pandamium:templates macro.this_character.this_character set string storage pandamium:text substrings[0] 0 1
function pandamium:impl/text/flatten_to_alphanumeric/get_characters_from_substrings/verify_character with storage pandamium:templates macro.this_character
$data modify storage pandamium:text concat.$(index) set from storage pandamium:templates macro.this_character.this_character
