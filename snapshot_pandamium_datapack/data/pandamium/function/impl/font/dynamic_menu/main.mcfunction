...
$tellraw @s [{text:"",color:"aqua"},\
        ...
        {text:"",extra:[{text:"Italic",italic:true},": ",{text:"[False]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to disable ",color:"red"},{text:"Italic",bold:true}]},click_event:{action:"run_command",command:"trigger $(trigger_id) set -$(section)012"}}," ",{text:"[True]",color:"green",hover_event:{action:"show_text",value:[{text:"Click to enable ",color:"green"},{text:"Italic",bold:true}]},click_event:{action:"run_command",command:"trigger $(trigger_id) set -$(section)002"}}]},"\n",\
        {text:"",extra:[{text:"Underlined",underlined:true},": ",{text:"[False]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to disable ",color:"red"},{text:"Underlined",bold:true}]},click_event:{action:"run_command",command:"trigger $(trigger_id) set -$(section)013"}}," ",{text:"[True]",color:"green",hover_event:{action:"show_text",value:[{text:"Click to enable ",color:"green"},{text:"Underlined",bold:true}]},click_event:{action:"run_command",command:"trigger $(trigger_id) set -$(section)003"}}]},"\n",\
        {text:"",extra:[{text:"Strikethrough",strikethrough:true},": ",{text:"[False]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to disable ",color:"red"},{text:"Strikethrough",bold:true}]},click_event:{action:"run_command",command:"trigger $(trigger_id) set -$(section)014"}}," ",{text:"[True]",color:"green",hover_event:{action:"show_text",value:[{text:"Click to enable ",color:"green"},{text:"Strikethrough",bold:true}]},click_event:{action:"run_command",command:"trigger $(trigger_id) set -$(section)004"}}]},\
    ]
$tellraw @s[scores={sign_font=1..}] [{text:"",color:"aqua"},\
        {text:"",extra:["Obfuscated (",{text:"AAA",obfuscated:true},"): ",{text:"[False]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to disable ",color:"red"},{text:"Obfuscated",bold:true}]},click_event:{action:"run_command",command:"trigger $(trigger_id) set -$(section)015"}}," ",{text:"[True]",color:"green",hover_event:{action:"show_text",value:[{text:"Click to enable ",color:"green"},{text:"Obfuscated",bold:true}]},click_event:{action:"run_command",command:"trigger $(trigger_id) set -$(section)005"}}]},\
    ]

$tellraw @s [{text:"",color:"aqua"},\
    "Font: ",\
        {text:"[Default]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to pick font ",color:"blue"},{text:"Default",bold:true},{text:"\n\nThis may look different to each player depending on their resource packs and language font options",color:"gray"}]},click_event:{action:"run_command",command:"trigger $(trigger_id) set -$(section)021"}}," ",\
        {text:"[",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to pick font ",color:"blue"},{text:"Uniform",bold:true}]},click_event:{action:"run_command",command:"trigger $(trigger_id) set -$(section)022"},extra:[{text:"Uniform",font:"uniform",bold:true},"]"]}," ",\
        {text:"[",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to pick font ",color:"blue"},{text:"Standard Galactic Alphabet",bold:true}]},click_event:{action:"run_command",command:"trigger $(trigger_id) set -$(section)023"},extra:[{text:"bntz",font:"alt"},"]"]}," ",\
        {text:"[",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to pick font ",color:"blue"},{text:"Illager Runes",bold:true}]},click_event:{action:"run_command",command:"trigger $(trigger_id) set -$(section)024"},extra:[{text:"dmqe",font:"illageralt"},"]"]},\
    ]

tellraw @s[scores={item_font=1..}] [{text:"",color:"aqua"},"Lore",": ",{text:"[Line 1]",color:"dark_purple",hover_event:{action:"show_text",value:[{text:"Click to swap the name with ",color:"dark_purple"},{text:"Lore Line 1",bold:true}]},click_event:{action:"run_command",command:"trigger item_font set -1"}}," ",{text:"[Line 2]",color:"dark_purple",hover_event:{action:"show_text",value:[{text:"Click to swap the name with ",color:"dark_purple"},{text:"Lore Line 2",bold:true}]},click_event:{action:"run_command",command:"trigger item_font set -2"}}," ",{text:"[Line 3]",color:"dark_purple",hover_event:{action:"show_text",value:[{text:"Click to swap the name with ",color:"dark_purple"},{text:"Lore Line 3",bold:true}]},click_event:{action:"run_command",command:"trigger item_font set -3"}}," ",{text:"[Line 4]",color:"dark_purple",hover_event:{action:"show_text",value:[{text:"Click to swap the name with ",color:"dark_purple"},{text:"Lore Line 4",bold:true}]},click_event:{action:"run_command",command:"trigger item_font set -4"}}]
