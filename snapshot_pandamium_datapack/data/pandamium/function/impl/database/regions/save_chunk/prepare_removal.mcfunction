...
data modify storage pandamium:local functions."pandamium:utils/database/regions/save_chunk".last_chunk_x set from storage pandamium.db.regions:io selected.entry.chunks[-1]
data modify storage pandamium:local functions."pandamium:utils/database/regions/save_chunk".last_chunk_z set from storage pandamium.db.regions:io selected.entry.chunks[-1]
