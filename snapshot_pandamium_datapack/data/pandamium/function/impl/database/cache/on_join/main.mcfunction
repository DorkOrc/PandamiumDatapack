...
execute if score @s custom_dye.type matches 4..5 store result storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_0 int 1 store result storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_1 int 1 store result storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_2 int 1 store result storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_3 int 1 store result storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_4 int 1 run data get storage pandamium.db.players:io selected.entry.data.custom_dye.colors[0]
execute if score @s custom_dye.type matches 4..5 if data storage pandamium.db.players:io selected.entry.data.custom_dye.colors[1] run data modify storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_1 set from storage pandamium.db.players:io selected.entry.data.custom_dye.colors[1]
