...
execute if score @s custom_dye.type matches 4 run data modify storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".username set from storage pandamium.db.players:io selected.entry.username
execute if score @s custom_dye.type matches 4 store result storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_0 int 1 store result storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_1 int 1 store result storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_2 int 1 store result storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_3 int 1 store result storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_4 int 1 run data get storage pandamium.db.players:io selected.entry.data.custom_dye.colors[0]
execute if score @s custom_dye.type matches 4 if data storage pandamium.db.players:io selected.entry.data.custom_dye.colors[1] run data modify storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_1 set from storage pandamium.db.players:io selected.entry.data.custom_dye.colors[1]
execute if score @s custom_dye.type matches 4 if data storage pandamium.db.players:io selected.entry.data.custom_dye.colors[2] run data modify storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_2 set from storage pandamium.db.players:io selected.entry.data.custom_dye.colors[2]
execute if score @s custom_dye.type matches 4 if data storage pandamium.db.players:io selected.entry.data.custom_dye.colors[3] run data modify storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_3 set from storage pandamium.db.players:io selected.entry.data.custom_dye.colors[3]
execute if score @s custom_dye.type matches 4 if data storage pandamium.db.players:io selected.entry.data.custom_dye.colors[4] run data modify storage pandamium:local functions."pandamium:impl/database/cache/on_join/*".color_4 set from storage pandamium.db.players:io selected.entry.data.custom_dye.colors[4]
