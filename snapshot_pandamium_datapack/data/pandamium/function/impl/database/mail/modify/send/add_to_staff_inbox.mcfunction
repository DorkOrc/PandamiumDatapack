...
tellraw @a[scores={staff_perms=1..}] [{text:"[Mail]",color:"blue"},{text:" ",color:"green",extra:[{text:"",color:"aqua",extra:[{storage:"pandamium:temp",nbt:"sender_display_name",interpret:true}]},{text:" sent "},{text:"The Staff Team",color:"yellow"},{text:" mail! "},{text:"[View The Staff Team's Inbox]",color:"gold",hover_event:{action:"show_text",text:[{text:"Click to see ",color:"gold"},{text:"The Staff Team's Inbox",bold:true}]},click_event:{action:"run_command",command:"trigger mail set 1000008"}}]}]
