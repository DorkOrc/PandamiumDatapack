...
execute unless score @s hidden matches 1.. if score @s idle.time matches 1..1073741823 run data modify storage pandamium:local functions."pandamium:impl/update_tablist_value/main".status set value '{"text":"[Idle]","color":"gray"}'
