...
execute unless block ~ ~ ~ minecraft:chest run setblock ~ ~ ~ minecraft:chest[facing=west,type=right]{} strict
execute unless block ~ ~ ~1 minecraft:chest run setblock ~ ~ ~1 minecraft:chest[facing=west,type=left]{} strict
