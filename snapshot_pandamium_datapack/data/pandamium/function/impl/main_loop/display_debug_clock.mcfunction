...
title @a[scores={send_extra_debug_info=2..},predicate=pandamium:holding/clock] actionbar ["",{text:"ᴘʀᴇᴄɪsᴇ",color:"dark_aqua"},{text:" ",extra:[{storage:"pandamium:local",nbt:"functions.'pandamium:impl/main_loop/get_precise_time'.hour",color:"white",extra:[":",{storage:"pandamium:local",nbt:"functions.'pandamium:impl/main_loop/get_precise_time'.minute"},":",{storage:"pandamium:local",nbt:"functions.'pandamium:impl/main_loop/get_precise_time'.second"}]}," "]},{text:"ʀᴄᴏɴ",color:"dark_aqua"}," ",{score:{name:"<day>",objective:"global"}},"/",{score:{name:"<month>",objective:"global"}},"/",{score:{name:"<year>",objective:"global"}}," ",{score:{name:"<hour>",objective:"global"}},"h ",{text:"ᴇsᴛɪᴍᴀᴛᴇ",color:"dark_aqua"}," ??:",{storage:"pandamium:temp",nbt:"parts[0]"},{storage:"pandamium:temp",nbt:"time[2]"},":",{storage:"pandamium:temp",nbt:"parts[1]"},{storage:"pandamium:temp",nbt:"time[1]"},{text:".",color:"gray",extra:[{storage:"pandamium:temp",nbt:"parts[2]"},{storage:"pandamium:temp",nbt:"parts[3]"}]}]
