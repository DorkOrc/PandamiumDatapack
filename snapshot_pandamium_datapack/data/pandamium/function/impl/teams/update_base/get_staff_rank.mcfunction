...
execute if score @s staff_rank matches 1 run data modify storage pandamium:temp arguments merge value {color:"yellow",prefix:'{"text":"Helper | "}'}
execute if score @s staff_rank matches 2 run data modify storage pandamium:temp arguments merge value {color:"gold",prefix:'{"text":"Mod | "}'}
