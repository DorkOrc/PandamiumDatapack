...
execute if score <near_nether_portal> variable matches 1 run tellraw @s [{text:"The nearest nether portal is ",color:"green"},{score:{name:"<distance>",objective:"variable"},color:"aqua"},{text:" blocks away."}]
