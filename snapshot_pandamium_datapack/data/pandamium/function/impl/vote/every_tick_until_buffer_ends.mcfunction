...
tellraw @a[scores={voting_summary_buffer=..0,gameplay_rank=0}] [{text:"Run ",color:"gray",hover_event:{action:"show_text",text:{text:"Click to open the Rewards Shop",color:"aqua"}},click_event:{action:"run_command",command:"trigger rewards_shop"}},{text:"/trigger rewards_shop",color:"aqua"},{text:" to spend your reward credits!"}]
