...
data modify storage pandamium:text input set value {storage:"pandamium:local",nbt:'functions."pandamium:impl/leader_boards/get_active_display/*".display[]',interpret:true,separator:"\n"}
