...
execute if score <displayed_components_size> variable matches 1.. run tellraw @s [{text:""},{nbt:"slot_prefix",storage:"pandamium:containers",color:"aqua",underlined:true,font:"uniform",extra:[{score:{name:"<display_slot>",objective:"variable"}}]},{text:": "},{score:{name:"<count>",objective:"variable"},color:"gold"},{text:" "},{text:"",color:"yellow",extra:[{storage:"pandamium:containers",nbt:"item.display_id_parent",interpret:true,extra:[{nbt:"item.display_id",storage:"pandamium:containers"}]}]},{nbt:"plural",storage:"pandamium:containers",color:"gray"},{text:" "},{text:"[Extra]",color:"dark_gray",hover_event:{action:"show_text",text:[{text:"Extra Components Data (raw data):\n"},{nbt:"displayed_components",storage:"pandamium:containers",color:"gray"}]}},{text:" "},{text:"",color:"white",italic:true,extra:[{nbt:'item.components."minecraft:custom_name"',storage:"pandamium:containers",interpret:true}]}]
execute unless score <displayed_components_size> variable matches 1.. run tellraw @s [{text:""},{nbt:"slot_prefix",storage:"pandamium:containers",color:"aqua",underlined:true,font:"uniform",extra:[{score:{name:"<display_slot>",objective:"variable"}}]},{text:": "},{score:{name:"<count>",objective:"variable"},color:"gold"},{text:" "},{text:"",color:"yellow",extra:[{storage:"pandamium:containers",nbt:"item.display_id_parent",interpret:true,extra:[{nbt:"item.display_id",storage:"pandamium:containers"}]}]},{nbt:"plural",storage:"pandamium:containers",color:"gray"},{text:" "},{text:"",color:"white",italic:true,extra:[{nbt:'item.components."minecraft:custom_name"',storage:"pandamium:containers",interpret:true}]}]
...
execute if data storage pandamium:containers item.components."minecraft:lore"[0] run tellraw @s [{text:"└lore: ",color:"aqua"},{text:"[Lore]",color:"dark_purple",hover_event:{action:"show_text",text:[{text:"",color:"dark_purple",italic:true},{nbt:'item.components."minecraft:lore"[]',storage:"pandamium:containers",interpret:true,separator:"\n"}]}}]
