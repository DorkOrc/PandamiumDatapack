# modify custom item data
execute if data storage pandamium:containers item.components."minecraft:custom_data".pandamium.stored_mob run data modify storage pandamium:containers item.components."minecraft:custom_data".pandamium.id set value "stored_mob"
execute if data storage pandamium:containers item.components."minecraft:custom_data".pandamium.id run function pandamium:impl/containers/run/custom_item

# Set up displayed data 
...
data remove storage pandamium:containers displayed_components."minecraft:lodestone_tracker"
...
execute if score <displayed_components_size> variable matches 1.. run tellraw @s ["",{nbt:"slot_prefix",storage:"pandamium:containers",interpret:true,color:"aqua",underlined:true,font:"uniform",extra:[{score:{name:"<display_slot>",objective:"variable"}}]},": ",{score:{name:"<count>",objective:"variable"},color:"gold"}," ",{text:"",color:"yellow",extra:[{storage:"pandamium:containers",nbt:"item.display_id_parent",interpret:true,extra:[{nbt:"item.display_id",storage:"pandamium:containers",plain:true}]}]},{nbt:"plural",storage:"pandamium:containers",interpret:true,color:"gray"}," ",{text:"[Extra]",color:"dark_gray",hover_event:{action:"show_text",value:["Extra Components Data (raw data):\n",{nbt:"displayed_components",storage:"pandamium:containers",color:"gray"}]}},{text:" "},{text:"",color:"white",italic:true,extra:[{nbt:'item.components."minecraft:custom_name"',storage:"pandamium:containers",interpret:true}]}]
execute unless score <displayed_components_size> variable matches 1.. run tellraw @s ["",{nbt:"slot_prefix",storage:"pandamium:containers",interpret:true,color:"aqua",underlined:true,font:"uniform",extra:[{score:{name:"<display_slot>",objective:"variable"}}]},": ",{score:{name:"<count>",objective:"variable"},color:"gold"}," ",{text:"",color:"yellow",extra:[{storage:"pandamium:containers",nbt:"item.display_id_parent",interpret:true,extra:[{nbt:"item.display_id",storage:"pandamium:containers",plain:true}]}]},{nbt:"plural",storage:"pandamium:containers",interpret:true,color:"gray"}," ",{text:"",color:"white",italic:true,extra:[{nbt:'item.components."minecraft:custom_name"',storage:"pandamium:containers",interpret:true}]}]

execute if data storage pandamium:containers item.components."minecraft:profile".name run tellraw @s [{text:"└profile: ",color:"aqua"},{translate:"block.minecraft.player_head.named",with:[{nbt:'item.components."minecraft:profile".name',storage:"pandamium:containers",interpret:true}],color:"yellow"}]
...
execute if data storage pandamium:containers item.components."minecraft:potion_contents".potion run tellraw @s [{text:"└potion_contents: ",color:"aqua"},{nbt:'item.components."minecraft:potion_contents".potion',storage:"pandamium:containers",interpret:true,color:"green"}]
execute if data storage pandamium:containers item.components."minecraft:written_book_content".title{raw:""} unless data storage pandamium:containers item.components."minecraft:written_book_content"{__hide_details__:1b} run tellraw @s [{text:"└written_book_content: ",color:"aqua"},{nbt:'item.components."minecraft:item_name"',storage:"pandamium:containers",interpret:true,color:"green"},{text:" by "},{nbt:'item.components."minecraft:written_book_content".author',storage:"pandamium:containers",interpret:true,color:"green"}]
execute if data storage pandamium:containers item.components."minecraft:written_book_content" unless data storage pandamium:containers item.components."minecraft:written_book_content"{__hide_details__:1b} unless data storage pandamium:containers item.components."minecraft:written_book_content".title{raw:""} run tellraw @s [{text:"└written_book_content: ",color:"aqua"},{nbt:'item.components."minecraft:written_book_content".title.raw',interpret:true,storage:"pandamium:containers",color:"green"},{text:" by "},{nbt:'item.components."minecraft:written_book_content".author',storage:"pandamium:containers",interpret:true,color:"green"}]
...
execute if data storage pandamium:containers item.components."minecraft:lore"[0] run tellraw @s [{text:"└lore: ",color:"aqua"},{text:"[Lore]",color:"dark_purple",hover_event:{action:"show_text",value:[{text:"",color:"dark_purple",italic:true},{nbt:'item.components."minecraft:lore"[]',storage:"pandamium:containers",interpret:true,separator:"\n"}]}}]
