...
execute if score <has_filtered_version> variable matches 0 if score <interpret> variable matches 0 run tellraw @s ["",{text:"pages.",color:"aqua",underlined:true,extra:[{score:{name:"<page>",objective:"variable"}}]},": ",{text:"[raw]",color:"dark_gray",hover_event:{action:"show_text",value:{nbt:"items[0].raw",storage:"pandamium:containers"}}}]
...
execute if score <has_filtered_version> variable matches 1 if score <interpret> variable matches 0 run tellraw @s ["",{text:"pages.",color:"aqua",underlined:true,extra:[{score:{name:"<page>",objective:"variable"}}]},": ",{text:"[raw]",color:"dark_gray",hover_event:{action:"show_text",value:{nbt:"items[0]",storage:"pandamium:containers"}}}," ",{text:"[filtered]",color:"dark_gray",hover_event:{action:"show_text",value:{nbt:"items[0]",storage:"pandamium:containers"}}}]
execute if score <has_filtered_version> variable matches 1 if score <interpret> variable matches 1 run tellraw @s ["",{text:"pages.",color:"aqua",underlined:true,extra:[{score:{name:"<page>",objective:"variable"}}]},": ",{text:"[raw]",color:"dark_gray",hover_event:{action:"show_text",value:{nbt:"items[0]",storage:"pandamium:containers",interpret:true}}}," ",{text:"[filtered]",color:"dark_gray",hover_event:{action:"show_text",value:{nbt:"items[0]",storage:"pandamium:containers",interpret:true}}}]
