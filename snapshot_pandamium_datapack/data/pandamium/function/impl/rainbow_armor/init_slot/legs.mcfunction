execute unless items entity @s armor.legs *[dyed_color] run return run item modify entity @s armor.legs [{function:"minecraft:set_custom_data",tag:{pandamium:{rainbow:{}}}},{function:"set_components",components:{"minecraft:equippable":{dispensable:false,equip_sound:"minecraft:intentionally_empty",model:"minecraft:leather",slot:"legs"}}}]
...
item modify block 5 0 0 contents [{function:"minecraft:set_custom_data",tag:{pandamium:{rainbow:{}}}},{function:"minecraft:set_components",components:{"minecraft:equippable":{dispensable:false,equip_sound:"minecraft:intentionally_empty",model:"minecraft:leather",slot:"legs"}}}]
