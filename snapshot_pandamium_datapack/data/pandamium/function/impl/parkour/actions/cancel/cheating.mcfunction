...
tellraw @s [{text:"[Parkour] ",color:"dark_red"},{text:"Your parkour session was ended! Cheating was detected.",color:"red",hover_event:{action:"show_text",text:[{text:"Reason: ",color:"dark_red"},{storage:"pandamium:temp",nbt:"cheat_data.name",color:"red"}]}}]
