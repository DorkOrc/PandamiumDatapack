...
execute if score <new_best_time> variable matches 1 if score <new_best_deathless_time> variable matches 0 run tellraw @s [{text:"[Parkour] ",color:"aqua"},{text:"Finished the ",color:"dark_aqua",extra:[{storage:"pandamium:dictionary",nbt:"parkour.parkour_3.name",interpret:true,bold:true,color:"aqua"},{text:" parkour course in "},{storage:"pandamium:temp",nbt:"formatted_time",interpret:true},{text:" and fell "},{score:{name:"@s",objective:"parkour.falls"},color:"aqua",bold:true},{text:" times! ("},{text:"NEW BEST RUN",bold:true},{text:")"}]}]
execute if score <new_best_time> variable matches 0 if score <new_best_deathless_time> variable matches 1 run tellraw @s [{text:"[Parkour] ",color:"aqua"},{text:"Finished the ",color:"dark_aqua",extra:[{storage:"pandamium:dictionary",nbt:"parkour.parkour_3.name",interpret:true,bold:true,color:"aqua"},{text:" parkour course in "},{storage:"pandamium:temp",nbt:"formatted_time",interpret:true},{text:" and fell "},{score:{name:"@s",objective:"parkour.falls"},color:"aqua",bold:true},{text:" times! ("},{text:"NEW BEST DEATHLESS RUN",bold:true},{text:")"}]}]
execute if score <new_best_time> variable matches 1 if score <new_best_deathless_time> variable matches 1 run tellraw @s [{text:"[Parkour] ",color:"aqua"},{text:"Finished the ",color:"dark_aqua",extra:[{storage:"pandamium:dictionary",nbt:"parkour.parkour_3.name",interpret:true,bold:true,color:"aqua"},{text:" parkour course in "},{storage:"pandamium:temp",nbt:"formatted_time",interpret:true},{text:" and fell "},{score:{name:"@s",objective:"parkour.falls"},color:"aqua",bold:true},{text:" times! ("},{text:"NEW BEST RUN AND NEW BEST DEATHLESS RUN",bold:true},{text:")"}]}]
