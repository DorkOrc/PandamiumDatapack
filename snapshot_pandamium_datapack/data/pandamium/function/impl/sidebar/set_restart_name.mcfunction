...
$execute if score <sidebar_minutes> variable matches 0 run scoreboard players display name <sidebar.restart_countdown> sidebar {color:"red",extra:[{bold:true,color:"dark_red",text:"$(seconds)"},{text:" seconds"}],font:"minecraft:uniform",text:"Restart in "}
