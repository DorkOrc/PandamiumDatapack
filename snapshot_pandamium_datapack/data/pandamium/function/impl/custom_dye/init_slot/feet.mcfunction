execute unless items entity @s armor.feet *[dyed_color] run return run item modify entity @s armor.feet [{function:"minecraft:set_custom_data",tag:{pandamium:{custom_dye:{}}}},{function:"set_components",components:{"minecraft:equippable":{dispensable:false,equip_sound:"minecraft:intentionally_empty",model:"minecraft:leather",slot:"feet"}}}]
...
item modify block 5 0 0 contents [{function:"minecraft:set_custom_data",tag:{pandamium:{custom_dye:{}}}},{function:"minecraft:set_components",components:{"minecraft:equippable":{dispensable:false,equip_sound:"minecraft:intentionally_empty",model:"minecraft:leather",slot:"feet"}}}]
