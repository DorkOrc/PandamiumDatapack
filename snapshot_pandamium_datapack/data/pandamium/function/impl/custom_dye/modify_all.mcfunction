...
# modify the colours
$item modify entity @a[predicate=pandamium:player/enabled_custom_dye] armor.feet {function:"minecraft:set_components",components:{"minecraft:dyed_color":{rgb:$(rgb)}}}
$item modify entity @a[predicate=pandamium:player/enabled_custom_dye] armor.legs {function:"minecraft:set_components",components:{"minecraft:dyed_color":{rgb:$(rgb)}}}
$item modify entity @a[predicate=pandamium:player/enabled_custom_dye] armor.chest {function:"minecraft:set_components",components:{"minecraft:dyed_color":{rgb:$(rgb)}}}
$item modify entity @a[predicate=pandamium:player/enabled_custom_dye] armor.head {function:"minecraft:set_components",components:{"minecraft:dyed_color":{rgb:$(rgb)}}}
