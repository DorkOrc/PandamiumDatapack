...
execute as @a[predicate=pandamium:player/can_enable_custom_dye,scores={custom_dye.custom_dyed_items_equipped=1..}] if items entity @s weapon.mainhand *[custom_data~{pandamium:{custom_dye:{}}}] in pandamium:staff_world run function pandamium:detect/obtain_custom_dyed_item/fix_item {slot:"weapon.mainhand"}
execute as @a[predicate=pandamium:player/can_enable_custom_dye,scores={custom_dye.custom_dyed_items_equipped=1..}] if items entity @s weapon.offhand *[custom_data~{pandamium:{custom_dye:{}}}] in pandamium:staff_world run function pandamium:detect/obtain_custom_dyed_item/fix_item {slot:"weapon.mainhand"}
...
execute as @a[predicate=pandamium:player/can_enable_custom_dye,scores={temp_1=1..}] if score @s custom_dye.custom_dyed_items_equipped < @s temp_1 unless items entity @s player.cursor *[custom_data~{pandamium:{custom_dye:{}}}] at @s anchored eyes positioned ^ ^ ^ as @e[type=item,distance=..5] if items entity @s contents *[custom_data~{pandamium:{custom_dye:{}}}] in pandamium:staff_world run function pandamium:detect/obtain_custom_dyed_item/fix_item {slot:"container.0"}
execute as @a[predicate=pandamium:player/can_enable_custom_dye,scores={temp_1=1..}] if score @s custom_dye.custom_dyed_items_equipped < @s temp_1 if items entity @s player.cursor *[custom_data~{pandamium:{custom_dye:{}}}] in pandamium:staff_world run function pandamium:detect/obtain_custom_dyed_item/fix_item {slot:"player.cursor"}
