...
scoreboard players set @s[predicate=pandamium:player/min_staff_perms/helper,scores={gameplay_perms=..2}] gameplay_perms 3
scoreboard players set @s[predicate=pandamium:player/min_staff_perms/moderator] gameplay_perms 6
