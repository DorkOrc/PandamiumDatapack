...
# end
tellraw @a[scores={send_extra_debug_info=1..}] {color:"gray",italic:true,text:"[Pandamium: Refreshed [",extra:[{storage:"pandamium:queue",nbt:"selected.entry.leader_board"},{text:"] leader board]"}]}
