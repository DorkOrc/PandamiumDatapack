...
execute if data storage pandamium:local functions."pandamium:impl/queue/actions/cache_mail/main".items[0] run data modify storage pandamium:local functions."pandamium:impl/queue/actions/cache_mail/main".items[].private.available set value 1b
