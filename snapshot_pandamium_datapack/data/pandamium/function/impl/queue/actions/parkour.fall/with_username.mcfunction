...
$summon area_effect_cloud ~ ~ ~ {Particle:{type:"minecraft:block",block_state:{Name:"minecraft:air"}},CustomName:{text:"☠ ",extra:[{text:"$(username)",bold:true},{text:" ☠"}],color:"red"},CustomNameVisible:1b,WaitTime:12000,Tags:["parkour.death_point","spawn_protected"]}
