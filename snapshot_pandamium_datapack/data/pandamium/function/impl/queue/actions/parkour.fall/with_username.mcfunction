...
$summon area_effect_cloud ~ ~ ~ {Particle:{type:"minecraft:block",block_state:{Name:"minecraft:air"}},CustomName:[{color:"red",text:"☠ "},{bold:true,text:"$(username)"}," ☠"],CustomNameVisible:1b,WaitTime:12000,Tags:["parkour.death_point","spawn_protected"]}
