...
execute if score <elevator_display_part> variable matches 11 run data merge entity @s {block_state:{Name:"minecraft:iron_chain",Properties:{axis:"y"}},transformation:{translation:[-1.5f,0f,-1.5f]}}
execute if score <elevator_display_part> variable matches 12 run data merge entity @s {block_state:{Name:"minecraft:iron_chain",Properties:{axis:"y"}},transformation:{translation:[0.5f,0f,-1.5f]}}
execute if score <elevator_display_part> variable matches 13 run data merge entity @s {block_state:{Name:"minecraft:iron_chain",Properties:{axis:"y"}},transformation:{translation:[-1.5f,0f,0.5f]}}
execute if score <elevator_display_part> variable matches 14 run data merge entity @s {block_state:{Name:"minecraft:iron_chain",Properties:{axis:"y"}},transformation:{translation:[0.5f,0f,0.5f]}}
execute if score <elevator_display_part> variable matches 15 run data merge entity @s {block_state:{Name:"minecraft:iron_chain",Properties:{axis:"y"}},transformation:{translation:[-1.5f,1f,-1.5f]}}
execute if score <elevator_display_part> variable matches 16 run data merge entity @s {block_state:{Name:"minecraft:iron_chain",Properties:{axis:"y"}},transformation:{translation:[0.5f,1f,-1.5f]}}
execute if score <elevator_display_part> variable matches 17 run data merge entity @s {block_state:{Name:"minecraft:iron_chain",Properties:{axis:"y"}},transformation:{translation:[-1.5f,1f,0.5f]}}
execute if score <elevator_display_part> variable matches 18 run data merge entity @s {block_state:{Name:"minecraft:iron_chain",Properties:{axis:"y"}},transformation:{translation:[0.5f,1f,0.5f]}}
execute if score <elevator_display_part> variable matches 19 run data merge entity @s {block_state:{Name:"minecraft:iron_chain",Properties:{axis:"y"}},transformation:{translation:[-1.5f,2f,-1.5f]}}
...
execute if score <elevator_display_part> variable matches 21 run data merge entity @s {block_state:{Name:"minecraft:iron_chain",Properties:{axis:"y"}},transformation:{translation:[0.5f,2f,-1.5f]}}
...
execute if score <elevator_display_part> variable matches 25 run data merge entity @s {block_state:{Name:"minecraft:iron_chain",Properties:{axis:"y"}},transformation:{translation:[-1.5f,2f,0.5f]}}
...
execute if score <elevator_display_part> variable matches 27 run data merge entity @s {block_state:{Name:"minecraft:iron_chain",Properties:{axis:"y"}},transformation:{translation:[0.5f,2f,0.5f]}}
