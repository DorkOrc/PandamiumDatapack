...
execute unless score <announce> variable matches 1 run tellraw @a[scores={staff_perms=1..}] [{color:"dark_gray",text:"[Staff Info]"},[{color:"gray",text:" "},{color:"gray",storage:"pandamium:local",nbt:'functions."pandamium:impl/punishment/unjail/*".target_display_name',interpret:true}," was unjailed",{color:"gray",storage:"pandamium:local",nbt:'functions."pandamium:impl/punishment/unjail/*".announcement_insertion',interpret:true},"!"]]
