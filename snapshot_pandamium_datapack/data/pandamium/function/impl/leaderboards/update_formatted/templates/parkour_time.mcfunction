...
execute if score <hours> variable matches 0 if score <minutes> variable matches 0 in pandamium:staff_world run item modify block 5 0 0 contents {function:"minecraft:set_name",entity:"this",name:[{score:{name:"<seconds>",objective:"variable"},color:"green",bold:true},{text:".",color:"dark_green",bold:false,extra:[{storage:"pandamium:temp",nbt:"parts[2]"},{storage:"pandamium:temp",nbt:"parts[3]"}]},{text:" seconds"}]}
execute if score <hours> variable matches 0 if score <minutes> variable matches 1.. in pandamium:staff_world run item modify block 5 0 0 contents {function:"minecraft:set_name",entity:"this",name:[{storage:"pandamium:temp",nbt:"parts[0]",color:"green",bold:true},{score:{name:"<minutes>",objective:"variable"}},{text:":"},{storage:"pandamium:temp",nbt:"parts[1]"},{score:{name:"<seconds>",objective:"variable"}},{text:".",color:"dark_green",bold:false,extra:[{storage:"pandamium:temp",nbt:"parts[2]"},{storage:"pandamium:temp",nbt:"parts[3]"}]}]}
execute if score <hours> variable matches 1.. in pandamium:staff_world run item modify block 5 0 0 contents {function:"minecraft:set_name",entity:"this",name:[{score:{name:"<hours>",objective:"variable"},color:"green",bold:true},{text:":"},{storage:"pandamium:temp",nbt:"parts[0]"},{score:{name:"<minutes>",objective:"variable"}},{text:":"},{storage:"pandamium:temp",nbt:"parts[1]"},{score:{name:"<seconds>",objective:"variable"}},{text:".",color:"dark_green",bold:false,extra:[{storage:"pandamium:temp",nbt:"parts[2]"},{storage:"pandamium:temp",nbt:"parts[3]"}]}]}
...
execute if score <flag_as_unconfirmed> variable matches 1 in pandamium:staff_world run item modify block 5 0 0 contents {function:"minecraft:set_name",entity:"this",name:[{block:"5 0 0",nbt:"item.components.minecraft:custom_name",interpret:true},{text:" "},{text:"⚠",color:"yellow",bold:false}]}

execute in pandamium:staff_world run data modify storage pandamium:temp format[-1].template_result set from block 5 0 0 item.components.minecraft:custom_name
