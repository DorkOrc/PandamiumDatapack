...
# get stored date
execute store result score <stored_year> variable run data get storage pandamium.leader_boards:data previous_year_data.year
...
data modify storage pandamium.leader_boards:data previous_year_data.backups.yearly_playtime set from storage pandamium.leader_boards:data leader_boards.yearly_playtime
...
execute store result storage pandamium.leader_boards:data previous_year_data.year int 1 run scoreboard players get <stored_year> variable
