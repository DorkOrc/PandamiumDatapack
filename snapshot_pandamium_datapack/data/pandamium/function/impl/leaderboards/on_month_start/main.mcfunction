...
# get stored date
execute store result score <stored_month> variable run data get storage pandamium.leader_boards:data previous_month_data.month
execute store result score <stored_year_and_month> variable run data get storage pandamium.leader_boards:data previous_month_data.year 12
...
execute store result storage pandamium.leader_boards:data previous_month_data.month int 1 run scoreboard players get <stored_month> variable
execute store result storage pandamium.leader_boards:data previous_month_data.year int 1 run scoreboard players get <stored_year> variable
