...
data modify storage pandamium:rewards_shop dialogs.main_menu.dialog.actions append value {"label":"\"Chase The Skies\" Drop","tooltip":"A selection of items from the Chase The Skies game drop\n• Dried Ghast\n• Tears Music Disc\n• Dennis Painting\n• Lava Chicken Music Disc","width":150,"action":{"type":"minecraft:run_command","command":"/trigger rewards_shop set 102"}}
...
data modify storage pandamium:rewards_shop dialogs.main_menu.dialog.actions append value {"label":"\"The Copper Age\" Drop","tooltip":"A selection of items from the The Copper Age game drop\n• Dried Ghast\n• Tears Music Disc\n• Dennis Painting\n• Lava Chicken Music Disc","width":150,"action":{"type":"minecraft:run_command","command":"/trigger rewards_shop set 103"}}
