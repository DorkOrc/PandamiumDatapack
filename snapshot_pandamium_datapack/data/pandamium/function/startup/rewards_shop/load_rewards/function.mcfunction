# arguments: cost, reward_id, function, name

$data modify storage pandamium:local functions."pandamium:startup/rewards_shop/load_rewards/*" set value {cost:$(cost),reward_id:"$(reward_id)",reward:{type:"function",function:"$(function)"}}
...
$data modify storage pandamium:local functions."pandamium:startup/rewards_shop/load_rewards/*".name set value {text:"",extra:[$(name)]}
execute if data storage pandamium:local functions."pandamium:startup/rewards_shop/load_rewards/*"{name:""} run execute in pandamium:staff_world run function pandamium:utils/get/item_display_name {source:"block 2 0 0 container.0"}
execute if data storage pandamium:local functions."pandamium:startup/rewards_shop/load_rewards/*"{name:""} run data modify storage pandamium:local functions."pandamium:startup/rewards_shop/load_rewards/*".name set from storage pandamium:temp item_display_name
