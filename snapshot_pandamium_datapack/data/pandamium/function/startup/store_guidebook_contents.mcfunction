...
data modify storage pandamium:global guidebook.version_index set value 113
data modify storage pandamium:global guidebook.version_name set value '2.4.6'
data modify storage pandamium:global guidebook.date_updated set value '21/10/2024'
# ^^^
