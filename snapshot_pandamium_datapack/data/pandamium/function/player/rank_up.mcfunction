...
execute if predicate pandamium:player/gameplay_rank/player run function pandamium:utils/log {args:{message:['event="player_ranked_up",data={"username":"',{storage:"pandamium:temp",nbt:"username"},'","to_rank":"player"}']}}
...
execute if predicate pandamium:player/gameplay_rank/member run function pandamium:utils/log {args:{message:['event="player_ranked_up",data={"username":"',{storage:"pandamium:temp",nbt:"username"},'","to_rank":"member"}']}}
...
execute if predicate pandamium:player/gameplay_rank/elder run function pandamium:utils/log {args:{message:['event="player_ranked_up",data={"username":"',{storage:"pandamium:temp",nbt:"username"},'","to_rank":"elder"}']}}
...
execute if predicate pandamium:player/gameplay_rank/veteran run function pandamium:utils/log {args:{message:['event="player_ranked_up",data={"username":"',{storage:"pandamium:temp",nbt:"username"},'","to_rank":"veteran"}']}}
...
execute if predicate pandamium:player/gameplay_rank/elite run function pandamium:utils/log {args:{message:['event="player_ranked_up",data={"username":"',{storage:"pandamium:temp",nbt:"username"},'","to_rank":"elite"}']}}
