...
execute if score <month> global matches 11 if score <month> global matches 11 if predicate {condition:"minecraft:any_of",terms:[{condition:"minecraft:inverted",term:{condition:"minecraft:entity_scores",entity:"this",scores:{last_joined.year:{min:{type:"minecraft:score",target:{type:"minecraft:fixed",name:"<year>"},score:"global"}}}}},{condition:"minecraft:entity_scores",entity:"this",scores:{last_joined.month:{max:10}}},{condition:"minecraft:entity_scores",entity:"this",scores:{last_joined.month:11,last_joined.day:{max:10}}}]} run give @s poppy[item_name='"Remembrance Day Poppy"',equippable={slot:"head",allowed_entities:"minecraft:player",swappable:1b}]
