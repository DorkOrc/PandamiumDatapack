...
execute if predicate {condition: "minecraft:any_of",terms: [{condition: "minecraft:inverted",term: {condition: "minecraft:entity_scores",entity: "this",scores: {last_joined.year: {min: 2024}}}},{condition: "minecraft:all_of",terms: [{condition: "minecraft:entity_scores",entity: "this",scores: {last_joined.year: 2024}},{condition: "minecraft:entity_scores",entity: "this",scores: {last_joined.month: {max: 6}}}]},{condition: "minecraft:all_of",terms: [{condition: "minecraft:entity_scores",entity: "this",scores: {last_joined.year: 2024}},{condition: "minecraft:entity_scores",entity: "this",scores: {last_joined.month: 7}},{condition: "minecraft:entity_scores",entity: "this",scores: {last_joined.day: {max: 11}}}]},{condition: "minecraft:all_of",terms: [{condition: "minecraft:entity_scores",entity: "this",scores: {last_joined.year: 2024}},{condition: "minecraft:entity_scores",entity: "this",scores: {last_joined.month: 7}},{condition: "minecraft:entity_scores",entity: "this",scores: {last_joined.day: 12}},{condition: "minecraft:entity_scores",entity: "this",scores: {last_joined.hour: {max: 20}}}]}]} run function pandamium:player/on_join/notices/mini_blocks
...
scoreboard players add @s optn.custom_dye 0
