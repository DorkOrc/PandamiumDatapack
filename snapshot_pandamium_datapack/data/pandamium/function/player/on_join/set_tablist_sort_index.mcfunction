...
execute if score @s supporter_rank matches 1 unless score @s disable_donator_prefix matches 1 run return run scoreboard players set @s tablist_sort_index 105
execute if score @s gameplay_rank matches 5 run return run scoreboard players set @s tablist_sort_index 107
execute if score @s gameplay_rank matches 4 run return run scoreboard players set @s tablist_sort_index 108
execute if score @s gameplay_rank matches 3 run return run scoreboard players set @s tablist_sort_index 109
execute if score @s gameplay_rank matches 2 run return run scoreboard players set @s tablist_sort_index 110
execute if score @s gameplay_rank matches 1 run return run scoreboard players set @s tablist_sort_index 111
execute if score @s gameplay_rank matches 0 run return run scoreboard players set @s tablist_sort_index 112
