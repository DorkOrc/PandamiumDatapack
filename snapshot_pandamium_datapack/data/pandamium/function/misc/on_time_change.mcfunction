...
tellraw @a[scores={send_extra_debug_info=2..}] [{text:"[Pandamium: Updated datetime (and hour id): ",color:"gray",italic:true},{score:{name:"<day>",objective:"global"}},{text:"/"},{score:{name:"<month>",objective:"global"}},{text:"/"},{score:{name:"<year>",objective:"global"}},{text:", "},{score:{name:"<hour>",objective:"global"}},{text:"h]"}]
