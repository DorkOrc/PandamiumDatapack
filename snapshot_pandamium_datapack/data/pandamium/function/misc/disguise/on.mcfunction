...
execute if score <valid_entity_type> variable matches 0 run return run tellraw @s [{text:"[Disguise]",color:"dark_red"},{text:" Invalid entity type: ",color:"red",extra:[{storage:"pandamium:temp",nbt:"entity_type",color:"yellow"},{text:"!"}]}]
