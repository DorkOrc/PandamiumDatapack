# handle hurt
execute unless score @s detect.die matches 1.. at @s[gamemode=!spectator,scores={particles_data.damage_effect.type=1..,detect.take_damage=21..}] run function pandamium:impl/particles/hurt_event
