...
execute if data storage pandamium:local functions."pandamium:detect/set_spawnpoint/*".player_data.respawn{dimension:"minecraft:overworld"} run scoreboard players set @s spawnpoint_d 0
