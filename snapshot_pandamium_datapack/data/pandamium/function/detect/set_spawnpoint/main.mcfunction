...
execute if data storage pandamium:local functions."pandamium:detect/set_spawnpoint/*".player_data.respawn run function pandamium:detect/set_spawnpoint/refresh
