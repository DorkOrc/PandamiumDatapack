...
tellraw @s [{text:"[Pandamium]",color:"blue"},{text:" Thank you, ",color:"green",extra:[{storage:"pandamium:temp",nbt:"username"},{text:", for playing on our server! The Pandamium team wishes you a "},{text:"Merry Christmas ❤",color:"aqua"},{text:"!"}]}]
