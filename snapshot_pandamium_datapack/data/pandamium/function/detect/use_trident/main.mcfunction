...
execute if predicate pandamium:holding/using_riptide_trident run scoreboard players operation @s riptiding_until = <current_gametime> global
execute if predicate pandamium:holding/using_riptide_trident run scoreboard players add @s riptiding_until 20
