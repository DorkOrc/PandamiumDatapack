...
execute if score <previous_sneaking_state> variable matches 1 unless score @s sneak_to_sit.sit_cancelled_time matches 0..30 if score @s sneak_to_sit.time_since_sneaking_state_change matches 0..8 if score @s sneak_to_sit matches 1 unless predicate pandamium:sneaking run scoreboard players set @s sneak_to_sit.sneaking_state 4
execute if score <previous_sneaking_state> variable matches 4 unless score @s sneak_to_sit.sit_cancelled_time matches 0..30 if score @s sneak_to_sit.time_since_sneaking_state_change matches 0..8 if score @s sneak_to_sit matches 1 if predicate pandamium:sneaking run scoreboard players set @s sneak_to_sit.sneaking_state 5
execute if score <previous_sneaking_state> variable matches 5 unless score @s sneak_to_sit.sit_cancelled_time matches 0..30 if score @s sneak_to_sit.time_since_sneaking_state_change matches 0..8 if score @s sneak_to_sit matches 1 unless predicate pandamium:sneaking run function pandamium:misc/sit
