...
loot spawn 0 0 0 loot pandamium:loot_bundle/1_20/contents
...
loot replace block 0 0 0 container.0 loot pandamium:loot_bundle/1_20/bundle
...
# Spawn extra items
execute at @s run loot spawn ~ ~ ~ loot pandamium:loot_bundle/1_20/extras
