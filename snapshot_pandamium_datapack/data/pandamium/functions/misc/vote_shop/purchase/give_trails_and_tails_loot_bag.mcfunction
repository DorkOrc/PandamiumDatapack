...
loot spawn 0 0 0 loot pandamium:loot_bundle/trails_and_tails/contents
...
loot replace block 0 0 0 container.0 loot pandamium:loot_bundle/trails_and_tails/bundle
...
# Spawn extra items
execute at @s run loot spawn ~ ~ ~ loot pandamium:loot_bundle/trails_and_tails/extras
