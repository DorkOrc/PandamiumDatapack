...
execute if score <value_in_section> variable matches 8 run function pandamium:misc/vote_shop/purchase/mini_blocks/from_storage/main
...
execute if score <value_in_section> variable matches 21 store success score <has_given> variable in pandamium:staff_world run function pandamium:misc/vote_shop/purchase/give_tails_and_trails_loot_bag
