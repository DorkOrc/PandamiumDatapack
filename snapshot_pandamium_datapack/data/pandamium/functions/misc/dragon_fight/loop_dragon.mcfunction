...
execute unless score <dragon_fight_spawned_reinforcements> global matches 1 if score <phantom_crystals_left> variable matches ..2 run function pandamium:misc/dragon_fight/spawn_reinforcements
...
execute if score <dragon_fight_loop> variable matches 1 run schedule function pandamium:misc/dragon_fight/loop_dragon 5t
execute if score <dragon_fight_loop> variable matches 2 run function pandamium:misc/dragon_fight/end
