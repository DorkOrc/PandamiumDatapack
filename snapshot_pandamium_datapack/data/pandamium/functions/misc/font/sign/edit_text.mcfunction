...
execute if score <line> variable matches 1 run data modify storage pandamium:temp Text set from storage pandamium:temp sign.front_text.messages[0]
execute if score <line> variable matches 1 in pandamium:staff_world run function pandamium:misc/font/do_edit
execute if score <line> variable matches 1 run data modify block ~ ~ ~ front_text.messages[0] set from storage pandamium:temp Text
...
execute if score <line> variable matches 2 run data modify storage pandamium:temp Text set from storage pandamium:temp sign.front_text.messages[1]
execute if score <line> variable matches 2 in pandamium:staff_world run function pandamium:misc/font/do_edit
execute if score <line> variable matches 2 run data modify block ~ ~ ~ front_text.messages[1] set from storage pandamium:temp Text
...
execute if score <line> variable matches 3 run data modify storage pandamium:temp Text set from storage pandamium:temp sign.front_text.messages[2]
execute if score <line> variable matches 3 in pandamium:staff_world run function pandamium:misc/font/do_edit
execute if score <line> variable matches 3 run data modify block ~ ~ ~ front_text.messages[2] set from storage pandamium:temp Text
...
execute if score <line> variable matches 4 run data modify storage pandamium:temp Text set from storage pandamium:temp sign.front_text.messages[3]
execute if score <line> variable matches 4 in pandamium:staff_world run function pandamium:misc/font/do_edit
execute if score <line> variable matches 4 run data modify block ~ ~ ~ front_text.messages[3] set from storage pandamium:temp Text
