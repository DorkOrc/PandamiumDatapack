...
execute if score <recognised> variable matches 0 if data storage pandamium:json {substring:'extra"'} store success score <found_match> variable run data modify storage pandamium:json key set value 'extra'
execute if score <recognised> variable matches 0 if score <found_match> variable matches 1 store success score <recognised> variable run data modify storage pandamium:json string set string storage pandamium:json string 6
...
execute if score <found_original_text> variable matches 1 if data storage pandamium:json {key:'text'} if data storage pandamium:json stack[-1].flags{is_root:1b} run data modify storage pandamium:json string set value ''
execute if score <found_original_text> variable matches 1 if data storage pandamium:json {key:'text'} if data storage pandamium:json stack[-1].flags{is_root:1b} run data remove storage pandamium:json stack[]
