...
tag @s add player
execute unless score @s disable_attack_indicator matches 1 at @s as @e[distance=..64,tag=!player,sort=nearest] run function pandamium:misc/attack_indicator/check_entity
tag @s remove player
