# pandamium:misc/leaderboards/get_self/...` should already have been run
...
execute if score <on_leaderboard> variable matches 1 run function pandamium:misc/leaderboards/insert/is_on_leaderboard
