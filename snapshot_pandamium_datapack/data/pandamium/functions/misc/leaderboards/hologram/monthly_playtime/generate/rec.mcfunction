...
execute if score <decimal> variable matches 10.. in pandamium:staff_world run data modify block 0 0 0 Text1 set value '[{"text":"(","color":"aqua"},{"score":{"name":"<num>","objective":"variable"},"bold":true},") ",{"nbt":"hologram.leaderboard[-1].display_name","storage":"pandamium:temp","interpret":true}," - ",[{"nbt":"hologram.leaderboard[-1].time[3]","storage":"pandamium:temp","interpret":true,"color":"green","bold":true},".",{"score":{"name":"<decimal>","objective":"variable"}}]]'
execute if score <decimal> variable matches 0..9 in pandamium:staff_world run data modify block 0 0 0 Text1 set value '[{"text":"(","color":"aqua"},{"score":{"name":"<num>","objective":"variable"},"bold":true},") ",{"nbt":"hologram.leaderboard[-1].display_name","storage":"pandamium:temp","interpret":true}," - ",[{"nbt":"hologram.leaderboard[-1].time[3]","storage":"pandamium:temp","interpret":true,"color":"green","bold":true},".0",{"score":{"name":"<decimal>","objective":"variable"}}]]'
