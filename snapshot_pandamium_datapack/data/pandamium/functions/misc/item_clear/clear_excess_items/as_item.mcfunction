...
execute unless score <age> variable matches ..1200 in pandamium:staff_world as @e[x=0,y=0,z=0,dx=0,dy=0,dz=0,type=armor_stand,tag=item_clear,limit=1] run function pandamium:misc/item_clear/clear_excess_items/as_armor_stand
