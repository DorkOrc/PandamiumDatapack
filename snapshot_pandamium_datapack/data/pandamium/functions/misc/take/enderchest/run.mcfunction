...
execute if score <item_count> variable matches 1.. in pandamium:staff_world positioned 7 64 -2 summon marker run function pandamium:misc/take/enderchest/as_marker
