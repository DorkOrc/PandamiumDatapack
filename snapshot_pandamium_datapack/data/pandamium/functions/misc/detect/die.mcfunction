execute if score @s death_particles matches 1.. if entity @s[gamemode=!spectator] unless score @s hidden matches 1.. at @s if entity @a[distance=0.1..64,limit=1] run function pandamium:misc/particles/death_event
