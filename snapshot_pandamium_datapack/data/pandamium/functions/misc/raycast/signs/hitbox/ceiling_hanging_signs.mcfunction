...
execute if score <straight_on> variable matches 0 align xyz positioned ~0.1875 ~ ~0.1875 if entity @s[dx=0] align xyz positioned ~-0.1875 ~ ~-0.1875 if entity @s[dx=0] run scoreboard players set <raycast_in_block> variable 1
