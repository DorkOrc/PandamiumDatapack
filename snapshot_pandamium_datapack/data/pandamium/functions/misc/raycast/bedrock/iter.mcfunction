execute if block ~ ~ ~ bedrock run scoreboard players set <raycast_hit_target> variable 1
...
execute if score <raycast_hit_target> variable matches 0 if score <ttl> variable matches 1.. at @s run function pandamium:misc/raycast/bedrock/iter
