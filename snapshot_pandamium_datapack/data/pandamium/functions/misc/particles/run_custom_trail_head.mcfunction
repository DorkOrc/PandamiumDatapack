...
execute if score @s active_particles matches 69 run function pandamium:misc/particles/custom_trails/head/axolotl_whiskers
...
execute if score @s active_particles matches 72 run function pandamium:misc/particles/custom_trails/head/goat_ears_and_horns
...
execute if score @s active_particles matches 91 run function pandamium:misc/particles/custom_trails/head/donator_star
execute if score @s active_particles matches 92 run function pandamium:misc/particles/custom_trails/head/helper_shield
execute if score @s active_particles matches 93 run function pandamium:misc/particles/custom_trails/head/mod_shield
execute if score @s active_particles matches 94 run function pandamium:misc/particles/custom_trails/head/srmod_shield
execute if score @s active_particles matches 95 run function pandamium:misc/particles/custom_trails/head/admin_shield
execute if score @s active_particles matches 96 run function pandamium:misc/particles/custom_trails/head/owner_shield
execute if score @s active_particles matches 97 run function pandamium:misc/particles/custom_trails/head/vip_gem
execute if score @s active_particles matches 98 run function pandamium:misc/particles/custom_trails/head/plumb_bob
...
execute if score @s active_particles matches 53 run function pandamium:misc/particles/custom_trails/head/shrek
