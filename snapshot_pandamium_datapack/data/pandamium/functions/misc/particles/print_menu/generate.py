...
def generate_tree(particles,name,offset=0):
	...
	def rec(a,b):
		...
		if a == b:
			...
			with open(f'get_particle_name/{name}/'+('run.mcfunction' if (a == MIN and b == MAX) else f'{_range}.mcfunction'),'w') as file:
