# Trails
execute if score @s active_particles matches 2 run particle dragon_breath ~ ~0.5 ~ 0.4 0.4 0.4 0.01 3
...
execute if score @s active_particles matches 42 run particle falling_cherry_leaves ~ ~1 ~ 0.3 0.5 0.3 0 1
