...
execute if score <enderman_farm_x> global = <enderman_farm_x> global in the_end positioned 300 0 0 summon marker run function pandamium:misc/enderman_farm/protection/as_new_marker
