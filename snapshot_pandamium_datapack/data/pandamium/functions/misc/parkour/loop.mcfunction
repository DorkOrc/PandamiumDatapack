...
execute at @a[scores={parkour.checkpoint=0..}] positioned ~-32 ~-32 ~-32 as @e[type=marker,dx=64,dy=64,dz=64,tag=parkour.node,tag=!parkour.start] at @s run function pandamium:misc/parkour/node_particles
