...
execute if score @s parkour.checkpoint matches 0.. if data storage pandamium:temp parkour.node.data{reset_timer:1b,start:1b} run function pandamium:misc/parkour/actions/reset_timer
execute if score @s parkour.checkpoint matches 0.. if data storage pandamium:temp parkour.node.data.teleport run function pandamium:misc/parkour/actions/teleport
