...
execute positioned as @s run summon area_effect_cloud ~ ~-0.5 ~ {Tags:["seat","spawn_protected"],Duration:40,Radius:0f,Particle:"block air",CustomName:'{"text":"seat","color":"gray"}'}
