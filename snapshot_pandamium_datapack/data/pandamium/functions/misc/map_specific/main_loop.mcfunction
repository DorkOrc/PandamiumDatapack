...
execute as @a[x=11,y=91,z=-11,distance=..2.5,gamemode=!spectator] unless score @s rtp_cooldown matches 1.. run function pandamium:misc/teleport/random/player/teleport_and_feedback
...
schedule function pandamium:misc/map_specific/main_loop 5t