...
tellraw @s [" ",{"text":"Link 4: ","color":"green"},{"text":"minecraft.global","color":"blue","underlined":true,"clickEvent":{"action":"open_url","value":"https://minecraft.global/servers/b559672e-7906-4d17-858b-3c630000a152/vote"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to vote through\n","color":"blue"},{"text":"minecraft.global","bold":true}]}}," ",{"text":"⚠","color":"yellow","hoverEvent":{"action":"show_text","contents":[{"text":"The Votifier configuration for this website seems to have broken, so ","color":"yellow"},{"text":"you may not receive a reward","underlined":true}," for voting through this link."]}}]
