...
tellraw @s ["\n ",{"text":"[Open All Links]","color":"dark_aqua","hoverEvent":{"action":"show_text","contents":[{"text":"Click to open all 4 voting links in your default browser","color":"dark_aqua"},{"text":"\n\nIt will open an article on our website which will then automatically open all 4 pages in separate tabs. If your browser blocks pop-ups, you can enable them for that page or press the yellow button manually.","color":"gray"}]},"clickEvent":{"action":"open_url","value":"https://www.pandamium.com/article/votes/snapshot"}}]
