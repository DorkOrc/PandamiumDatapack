...
# delete in chunk
$execute store result score <x> variable run data get storage pandamium.db:players selected.entry.data.homes.$(home).xyzd[0]
$execute store result score <y> variable run data get storage pandamium.db:players selected.entry.data.homes.$(home).xyzd[1]
$execute store result score <z> variable run data get storage pandamium.db:players selected.entry.data.homes.$(home).xyzd[2]
$execute store result score <d> variable run data get storage pandamium.db:players selected.entry.data.homes.$(home).xyzd[3]
...
$execute store result storage pandamium.db:players selected.entry.data.homes.$(home).xyzd[3] int 1 store result score <dimension> variable store result score <d> variable run function pandamium:utils/get/dimension_id

# append to chunk
function pandamium:utils/database/regions/load_chunk/from_xzd_scores
$data modify storage pandamium.db:regions selected.chunk.entry.homes append value {data:[I;$(id),$(home)],xyz:[I;0,0,0]}
