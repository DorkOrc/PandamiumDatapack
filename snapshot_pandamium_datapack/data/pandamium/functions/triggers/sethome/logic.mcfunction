...
execute if entity @s[predicate=pandamium:in_donator_area] run tellraw @s [{"text":"[Homes]","color":"dark_red"},{"text":" You cannot set a home here!","color":"red"}]
execute if entity @s[predicate=pandamium:in_donator_area] run return 0
