...
execute store success score <returned> variable run tellraw @s [{"text":"[Auto-Actions Log]","color":"gold"},[{"text":" Teleported to ","color":"yellow"},{"nbt":"selected_entry.username","storage":"pandamium:auto_actions"},"'s ",{"text":"Pre-Jail Location","bold":true}," in spectator mode!"]]
