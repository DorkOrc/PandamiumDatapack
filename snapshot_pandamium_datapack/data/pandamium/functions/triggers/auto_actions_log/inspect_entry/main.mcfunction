...
execute if data storage pandamium:auto_actions selected_entry{type:"auto_jail"} run function pandamium:triggers/auto_actions_log/inspect_entry/action/auto_jail
