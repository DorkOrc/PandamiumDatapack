...
# Print Menu
execute if score @s vote_shop matches 1.. run function pandamium:impl/triggers/vote_shop/print_menu/main

# Get price and validate option (returns <cost>, <valid_option>, <buying_mini_block> and <reference_value>)
execute if score @s vote_shop matches ..-1 run function pandamium:impl/triggers/vote_shop/get_price
...
execute if score <valid_option> variable matches 1 if score <section> variable matches -20..-11 run function pandamium:impl/triggers/vote_shop/ask_to_confirm_purchase

# Purchase
execute if score <valid_option> variable matches 1 if score <section> variable matches -10..-1 run function pandamium:impl/triggers/vote_shop/check_requirements
