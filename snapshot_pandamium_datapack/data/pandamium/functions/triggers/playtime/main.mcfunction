...
execute if score <returned> variable matches 0 if score @s playtime matches 1 store success score <returned> variable run function pandamium:triggers/playtime/print_playtime
...
execute if score <returned> variable matches 0 as @a if score @s id = <target_id> variable store success score <target_exists> variable run function pandamium:triggers/playtime/print_playtime
