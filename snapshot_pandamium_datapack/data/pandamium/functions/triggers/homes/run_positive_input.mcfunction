...
execute if score @s homes matches 1 store success score <returned> variable run function pandamium:impl/home/print_menu/normal/main
...
execute if score <returned> variable matches 0 if score @s staff_perms matches 1 as @a[tag=target,limit=1] store success score <returned> variable run function pandamium:impl/home/print_menu/helper/main
execute if score <returned> variable matches 0 if score @s staff_perms matches 2.. as @a[tag=target,limit=1] store success score <returned> variable run function pandamium:impl/home/print_menu/moderator/main
