...
execute if score @s gameplay_perms matches 3.. if score @s hide_unset_homes matches 1 run tellraw @s ["",\
        [{"text":"\n[","color":"dark_green","hoverEvent":{"action":"show_text","contents":[{"text":"Available Home Slots: ","color":"dark_green"},{"color":"green","storage":"pandamium:temp","nbt":"unset_homes[]","interpret":true,"separator":{"text":", ","color":"dark_green"}}]}},{"score":{"name":"<length>","objective":"variable"}}," Available Home Slots]"],\
        "\n",\
...
execute unless score @s show_home_numbers matches 1 run tellraw @s [{"text":"Show Home Numbers: ","color":"aqua","hoverEvent":{"action":"show_text","value":[{"text":"Click to cycle options for\n","color":"aqua"},{"text":"Show Home Numbers","bold":true},{"text":"\n• Off (Default)\n• On","color":"dark_gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -10"}},{"text":"Off","color":"yellow","bold":true}]
execute if score @s show_home_numbers matches 1 run tellraw @s [{"text":"Show Home Numbers: ","color":"aqua","hoverEvent":{"action":"show_text","value":[{"text":"Click to cycle options for\n","color":"aqua"},{"text":"Show Home Numbers","bold":true},{"text":"\n• Off (Default)\n• On","color":"dark_gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -10"}},{"text":"On","color":"yellow","bold":true}]
