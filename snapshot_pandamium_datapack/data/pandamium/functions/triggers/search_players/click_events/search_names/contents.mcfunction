...
execute if score <results> variable matches 1 run tellraw @s ["1 Result for \"",{"storage":"pandamium:templates","nbt":"macro.search.search"},"\": ",[{"text":"","color":"aqua"},{"storage":"pandamium:temp","nbt":"results[]","interpret":true,"separator":{"text":", ","color":"gray"}}]]
execute if score <results> variable matches 2..10 run tellraw @s ["",{"score":{"name":"<results>","objective":"variable"}}," Results for \"",{"storage":"pandamium:templates","nbt":"macro.search.search"},"\": ",[{"text":"","color":"aqua"},{"storage":"pandamium:temp","nbt":"results[]","interpret":true,"separator":{"text":", ","color":"gray"}}]]
