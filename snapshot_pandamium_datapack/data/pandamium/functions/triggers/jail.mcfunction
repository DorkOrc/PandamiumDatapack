...
execute if score <returned> variable matches 0 unless score @s silent_punishments matches 1 run tellraw @a [{"text":"[Jail] ","color":"dark_purple"},{"selector":"@p[tag=target]","color":"light_purple"}," was jailed by ",{"nbt":"punisher","storage":"pandamium:temp","interpret":true,"color":"light_purple"},"!"]
execute if score <returned> variable matches 0 if score @s silent_punishments matches 1 run tellraw @a[scores={staff_perms=1..}] [{"text":"","color":"gray"},{"text":"[Jail] ","color":"dark_gray"},{"selector":"@p[tag=target]","color":"gray"}," was jailed by ",{"nbt":"punisher","storage":"pandamium:temp","interpret":true,"color":"gray"},"!"]
execute if score <returned> variable matches 0 if score @s silent_punishments matches 1 run tellraw @p[tag=target,scores={staff_perms=0}] [{"text":"[Jail]","color":"dark_gray"},[{"text":" You were jailed by ","color":"gray"},{"nbt":"punisher","storage":"pandamium:temp","interpret":true,"color":"gray"},"! ",[{"text":"You can message them by typing: /tell ","clickEvent":{"action":"suggest_command","value":"/tell "}},{"text":"<username>","color":"aqua"},{"text":" <message>","color":"yellow"}]]]
