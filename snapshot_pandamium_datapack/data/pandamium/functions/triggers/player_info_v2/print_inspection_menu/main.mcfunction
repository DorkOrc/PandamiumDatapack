...
$tellraw @s ["",\
    ...
    "\n",\
        {"text":"[Inventory]","color":"blue","hoverEvent":{"action":"show_text","contents":[{"text":"Click to see ","color":"blue"},{"storage":"pandamium:temp","nbt":"target","interpret":true},"'s ",{"text":"inventory","bold":true},{"text":"\n\nA command will be suggested to you, not automatically ran","color":"dark_gray"}]},"clickEvent":{"action":"run_command","value":"/trigger inventory set $(id)"}}," ",\
        {"text":"[Ender Chest]","color":"blue","hoverEvent":{"action":"show_text","contents":[{"text":"Click to see ","color":"blue"},{"storage":"pandamium:temp","nbt":"target","interpret":true},"'s ",{"text":"ender chest","bold":true},{"text":"\n\nA command will be suggested to you, not automatically ran","color":"dark_gray"}]},"clickEvent":{"action":"run_command","value":"/trigger enderchest set $(id)"}}," ",\
        {"text":"[Homes]","color":"blue","hoverEvent":{"action":"show_text","contents":[{"text":"Click to see ","color":"blue"},{"storage":"pandamium:temp","nbt":"target","interpret":true},"'s ",{"text":"homes","bold":true},{"text":"\n\nA command will be suggested to you, not automatically ran","color":"dark_gray"}]},"clickEvent":{"action":"run_command","value":"/trigger homes set $(id)"}}," ",\
        {"text":"[Mail]","color":"dark_gray","hoverEvent":{"action":"show_text","contents":["Inbox (raw data):\n",{"storage":"pandamium.db.players:io","nbt":"selected.entry.data.mail.inbox","color":"gray"},"\nOutbox (raw data):\n",{"storage":"pandamium.db.players:io","nbt":"selected.entry.data.mail.outbox","color":"gray"},"\nDrafts (raw data):\n",{"storage":"pandamium.db.players:io","nbt":"selected.entry.data.mail.drafts","color":"gray"}]}},\
    "\n\n",\
