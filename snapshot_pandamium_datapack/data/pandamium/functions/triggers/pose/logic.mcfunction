...
execute unless score @s gameplay_perms matches 6.. if score @s staff_perms matches 1.. unless score @s pose matches -403 run return run tellraw @s [{"text":"[Info]","color":"dark_red"},[{"text":" Only Patreon supporters can use that trigger! You can check out our ","color":"red","hoverEvent":{"action":"show_text","value":[{"text":"Click to join our ","color":"aqua"},{"text":"Discord Server","bold":true}]},"clickEvent":{"action":"open_url","value":"http://discord.pandamium.eu"}},{"text":"discord server","bold":true}," for more information on how to support us!"]," ",{"text":"[🔓]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger pose set -403"},"hoverEvent":{"action":"show_text","value":[{"text":"Click to ","color":"yellow"},{"text":"Unlock","bold":true}," the armour stand",{"text":"\n(Staff Only)","color":"#7E7E2A"}]}}]
