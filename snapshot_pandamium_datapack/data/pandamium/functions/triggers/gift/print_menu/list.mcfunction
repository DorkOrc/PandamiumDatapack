...
execute as @a[scores={gameplay_perms=6,staff_perms=0}] unless score @s vip_rank matches 1 run function pandamium:triggers/gift/print_menu/entry
execute as @a[scores={gameplay_perms=6,staff_perms=0,vip_rank=1}] run function pandamium:triggers/gift/print_menu/entry
