...
return run tellraw @s [{"text":"","color":"green"},{"text":"[Gift]","color":"dark_green"}," Gifted ",{"selector":"@a[predicate=pandamium:matches_id,limit=1]"}," a ",{"text":"reward credit","color":"aqua"},"! You now have ",{"score":{"name":"@s","objective":"reward_credits"},"bold":true,"color":"aqua"}," reward credit",{"text":"(s)","color":"gray"},"! ",[{"text":"(-","color":"red"},{"text":"1","bold":true},")"]]
