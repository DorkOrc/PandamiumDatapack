...
execute if score @s restart_server matches -2 unless score <restart_countdown> global matches 1.. run function pandamium:impl/triggers/restart_server/start_countdown
...
execute if score @s restart_server matches -3 if score <restart_countdown> global matches 1.. run function pandamium:impl/triggers/restart_server/cancel_countdown
