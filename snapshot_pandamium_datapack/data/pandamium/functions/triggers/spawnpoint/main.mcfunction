...
execute if score <returned> variable matches 0 if score @s spawnpoint matches 1.. at @s run function pandamium:triggers/spawnpoint/run_positive_input
execute if score <returned> variable matches 0 if score @s spawnpoint matches ..-2 at @s run function pandamium:triggers/spawnpoint/run_negative_input
