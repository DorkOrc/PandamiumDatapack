...
execute if score <returned> variable matches 0 positioned as @s as @a[tag=source,limit=1] run function pandamium:triggers/container/select_new_block/at_block
