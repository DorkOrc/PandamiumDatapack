...
scoreboard players set <ticks_until_reload> variable 37200
scoreboard players operation <ticks_until_reload> variable -= <ticks_since_time_change> global
execute if score <ticks_until_reload> variable matches ..-1 run scoreboard players add <ticks_until_reload> variable 34800
...
execute if score <seconds_until_reload> variable matches ..9 run scoreboard players set <second_until_reload> variable 10
