...
execute if score <returned> variable matches 0 if score @s enderman_farm matches ..-1 unless score @s staff_perms matches 1.. store success score <returned> variable run tellraw @s [{"text":"[Warp]","color":"dark_red"},{"text":" That is not a valid option!","color":"red"}]

# menu
execute if score <returned> variable matches 0 if score @s enderman_farm matches -1 store success score <returned> variable run function pandamium:misc/enderman_farm/print_menu
...
execute if score <returned> variable matches 0 if score @s enderman_farm matches -101 run function pandamium:misc/enderman_farm/set_warp
...
execute if score <returned> variable matches 0 if score @s enderman_farm matches -102 run function pandamium:misc/enderman_farm/delete_warp
...
execute if score <returned> variable matches 0 if score @s enderman_farm matches -103 run function pandamium:misc/enderman_farm/protection/enable
...
execute if score <returned> variable matches 0 if score @s enderman_farm matches -104 run function pandamium:misc/enderman_farm/protection/disable

# err
execute if score <returned> variable matches 0 if score @s enderman_farm matches ..-1 store success score <returned> variable run tellraw @s [{"text":"[Warp]","color":"dark_red"},{"text":" That is not a valid option!","color":"red"}]

# Warp
execute if score <returned> variable matches 0 if score <enderman_farm_x> global = <enderman_farm_x> global store success score <returned> variable run function pandamium:misc/teleport/warp/enderman_farm

execute if score <returned> variable matches 0 if score @s staff_perms matches 1.. store success score <returned> variable run tellraw @s [{"text":"[Warp]","color":"dark_red"},[{"text":" The ","color":"red"},{"text":"Enderman Farm","bold":true}," warp does not exist! "],{"text":"[✎]","color":"yellow","bold":true,"hoverEvent":{"action":"show_text","value":[{"text":"Click to configure the ","color":"yellow"},{"text":"Enderman Farm","bold":true}," warp"]},"clickEvent":{"action":"run_command","value":"/trigger enderman_farm set -2"}}]
