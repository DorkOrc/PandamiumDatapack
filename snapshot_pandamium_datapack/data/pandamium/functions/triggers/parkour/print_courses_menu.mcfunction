...
execute if score @s parkour_3.best_time_real matches 1.. run function pandamium:utils/get/time_from_ticks_without_days
execute if score @s parkour_3.best_time_real matches 1.. if score <hours> variable matches 0 run tellraw @s [{"storage":"pandamium:dictionary","nbt":"parkour.parkour_3.name","interpret":true,"color":"dark_aqua"},": ",{"score":{"name":"<minutes>","objective":"variable"},"bold":true,"color":"aqua"},{"text":" minute","color":"aqua"},{"text":"s","color":"gray"}," and ",{"score":{"name":"<seconds>","objective":"variable"},"bold":true,"color":"aqua"},{"text":" second","color":"aqua"},{"text":"s","color":"gray"}]
