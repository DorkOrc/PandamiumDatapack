...
execute unless score @s spawn matches 2..3 run function pandamium:impl/teleport/warp/spawn
execute if score @s spawn matches 2 run function pandamium:impl/teleport/warp/nether_spawn
execute if score @s spawn matches 3 run function pandamium:impl/teleport/warp/end_platform
