...
execute if score @s options matches -15..-1 run scoreboard players set <valid_option> variable 1
...
execute if score @s options matches -302..-301 if score @s staff_perms matches 1.. run scoreboard players set <valid_option> variable 1
...
execute if score @s options matches -603..-602 if score @s staff_perms matches 3.. run scoreboard players set <valid_option> variable 1
