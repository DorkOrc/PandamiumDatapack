...
execute unless score @s staff_perms matches 1.. run scoreboard players set @s[scores={options=2}] options 1
...
execute unless score @s staff_perms matches 1.. if score <has_alts> variable matches 1 run tellraw @s [{"text":"\nPages: ","color":"yellow"},{"text":"[Regular]","color":"gold","hoverEvent":{"action":"show_text","contents":[{"text":"Click to go to ","color":"gold"},{"text":"Regular Options","bold":true}," page"]},"clickEvent":{"action":"run_command","value":"/trigger options set 1"}}," ",{"text":"[Alts]","color":"gold","hoverEvent":{"action":"show_text","contents":[{"text":"Click to go to ","color":"gold"},{"text":"Alt Accounts","bold":true}," page"]},"clickEvent":{"action":"run_command","value":"/trigger options set 3"}}]
