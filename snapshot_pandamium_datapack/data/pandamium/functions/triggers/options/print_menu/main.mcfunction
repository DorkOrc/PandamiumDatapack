...
execute if score @s staff_perms matches 1.. if score <has_alts> variable matches 0 run tellraw @s [{"text":"\nPages: ","color":"yellow"},{"text":"[Regular]","color":"gold","hoverEvent":{"action":"show_text","contents":[{"text":"Click to go to ","color":"gold"},{"text":"Regular Options","bold":true}," page"]},"clickEvent":{"action":"run_command","value":"/trigger options set 1"}}," ",{"text":"[Staff]","color":"gold","hoverEvent":{"action":"show_text","contents":[{"text":"Click to go to ","color":"gold"},{"text":"Staff Options","bold":true}," page"]},"clickEvent":{"action":"run_command","value":"/trigger options set 2"}}," ",{"text":"[Server]","color":"gold","hoverEvent":{"action":"show_text","contents":[{"text":"Click to go to ","color":"gold"},{"text":"Server Options","bold":true}," page"]},"clickEvent":{"action":"run_command","value":"/trigger options set 3"}}]
execute if score @s staff_perms matches 1.. if score <has_alts> variable matches 1 run tellraw @s [{"text":"\nPages: ","color":"yellow"},{"text":"[Regular]","color":"gold","hoverEvent":{"action":"show_text","contents":[{"text":"Click to go to ","color":"gold"},{"text":"Regular Options","bold":true}," page"]},"clickEvent":{"action":"run_command","value":"/trigger options set 1"}}," ",{"text":"[Staff]","color":"gold","hoverEvent":{"action":"show_text","contents":[{"text":"Click to go to ","color":"gold"},{"text":"Staff Options","bold":true}," page"]},"clickEvent":{"action":"run_command","value":"/trigger options set 2"}}," ",{"text":"[Server]","color":"gold","hoverEvent":{"action":"show_text","contents":[{"text":"Click to go to ","color":"gold"},{"text":"Server Options","bold":true}," page"]},"clickEvent":{"action":"run_command","value":"/trigger options set 3"}}," ",{"text":"[Alts]","color":"gold","hoverEvent":{"action":"show_text","contents":[{"text":"Click to go to ","color":"gold"},{"text":"Alt Accounts","bold":true}," page"]},"clickEvent":{"action":"run_command","value":"/trigger options set 4"}}]
