...
execute if score <returned> variable matches 0 if score @s take_bound_items matches -1060..-1001 run function pandamium:triggers/take_bound_items/select_player_from_session_id
