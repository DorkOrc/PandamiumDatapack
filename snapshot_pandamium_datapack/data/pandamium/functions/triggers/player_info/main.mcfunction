...
execute if score <player_info.returned> variable matches 0 if score @s player_info matches -1999..-1001 run function pandamium:triggers/player_info/select_player_from_session_id
...
execute if score <player_info.returned> variable matches 0 if score @s player_info matches -999..-2 store success score <player_info.returned> variable run function pandamium:triggers/player_info/click_events
