execute unless data storage pandamium.db.players:io selected.entry.data.tp_history run return run tellraw @s [{"text":"Teleport History: ","color":"gold"},{"text":"[🗺]","color":"dark_gray","hoverEvent":{"action":"show_text","contents":{"text":"none","color":"gray"}}}]
