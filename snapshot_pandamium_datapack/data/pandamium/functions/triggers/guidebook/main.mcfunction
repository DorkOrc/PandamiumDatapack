...
execute unless score @s staff_perms matches 1.. run function pandamium:triggers/guidebook/give_self_guidebook
execute if score <returned> variable matches 0 if score @s guidebook matches 2.. run function pandamium:triggers/guidebook/give_target_guidebook
