...
execute if score <reference_value> variable matches -31 run scoreboard players set <cost> variable 4
execute if score <reference_value> variable matches -32 run scoreboard players set <cost> variable 6
