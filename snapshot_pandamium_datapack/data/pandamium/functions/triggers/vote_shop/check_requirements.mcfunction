...
execute unless score @s rewards_shop matches -11 unless score @s rewards_shop matches -13 unless score @s rewards_shop matches -14 run scoreboard players set <gives_item> variable 1
...
execute if score <can_buy> variable matches 1 if score @s rewards_shop matches -9 unless score <player_count> global matches 10.. run scoreboard players set <can_buy> variable 0
