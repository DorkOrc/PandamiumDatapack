...
execute if score <can_buy> variable matches 1 if score @s vote_shop matches -14 run function pandamium:triggers/vote_shop/check_can_summon_zombie_horse
...
execute if score <can_buy> variable matches 1 if score @s vote_shop matches -18 run function pandamium:triggers/vote_shop/check_can_summon_camel
...
execute if score <can_buy> variable matches 1 if score @s vote_shop matches -19 run function pandamium:triggers/vote_shop/check_can_summon_sniffer

execute if score <can_buy> variable matches 1 if score @s vote_shop matches -13 run function pandamium:triggers/vote_shop/check_can_break_bedrock/main
