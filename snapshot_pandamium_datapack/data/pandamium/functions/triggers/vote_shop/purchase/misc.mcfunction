...
execute if score <value_in_section> variable matches 31 store success score <has_given> variable run give @s writable_book
execute if score <value_in_section> variable matches 32 store success score <has_given> variable run give @s name_tag
