...
execute if score @s vote_shop matches 1 run function pandamium:triggers/vote_shop/print_menu/misc
execute if score @s vote_shop matches 2 run function pandamium:triggers/vote_shop/print_menu/mini_blocks/more
#execute if score @s vote_shop matches 3 run function pandamium:triggers/vote_shop/print_menu/mini_blocks/cultural
#execute if score @s vote_shop matches 4 run function pandamium:triggers/vote_shop/print_menu/mini_blocks/symbols
