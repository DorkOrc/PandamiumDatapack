...
execute if score <returned> variable matches 0 if score @s kick matches 1 store success score <returned> variablerun function pandamium:misc/print_nearest_non_staff_player
