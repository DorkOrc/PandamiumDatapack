...
execute if score <enderman_farm_x> global = <enderman_farm_x> global store success score <returned> variable run tellraw @s [{"text":"[Enderman Farm]","color":"dark_green"},[{"text":" Enabled ","color":"green"},{"text":"Enderman Farm Protection","bold":true},"!"]]
