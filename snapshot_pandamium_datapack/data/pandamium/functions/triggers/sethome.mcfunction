...
execute if score <returned> variable matches 0 run function pandamium:home/check_gameplay_perms
...
# Run
execute if score <returned> variable matches 0 unless score <do_replace> variable matches 1 run function pandamium:home/check_if_home_exists
execute if score <returned> variable matches 0 unless score <do_replace> variable matches 1 if score <home_exists> variable matches 1 store success score <returned> variable run function pandamium:home/set/ask_to_confirm_replace
execute if score <returned> variable matches 0 run function pandamium:home/set/run
