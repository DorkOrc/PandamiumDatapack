...
# Teleport
execute if score <returned> variable matches 0 if score @s switch_dimension matches -1 if dimension the_nether store success score <returned> variable run tellraw @s [{"text":"[Switch Dimension]","color":"dark_red"},[{"text":" You are already in ","color":"red"},{"text":"The Nether","bold":true},"!"]]
execute if score <returned> variable matches 0 if score @s switch_dimension matches -1 if dimension overworld run function pandamium:impl/triggers/switch_dimension/to_the_nether_from_overworld
...
execute if score <returned> variable matches 0 if score @s switch_dimension matches -2 if dimension overworld store success score <returned> variable run tellraw @s [{"text":"[Switch Dimension]","color":"dark_red"},[{"text":" You are already in ","color":"red"},{"text":"The Overworld","bold":true},"!"]]
execute if score <returned> variable matches 0 if score @s switch_dimension matches -2 if dimension the_nether run function pandamium:impl/triggers/switch_dimension/to_overworld_from_the_nether
...
execute if score <returned> variable matches 0 if score @s switch_dimension matches -3 if dimension the_end store success score <returned> variable run tellraw @s [{"text":"[Switch Dimension]","color":"dark_red"},[{"text":" You are already in ","color":"red"},{"text":"The End","bold":true},"!"]]
