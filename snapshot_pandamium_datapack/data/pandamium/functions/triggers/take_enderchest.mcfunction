...
execute if score <returned> variable matches 0 if score @s take_enderchest matches 1 store success score <returned> variable run function pandamium:utils/print_nearest_non_staff_player
...
# Run
execute if score <returned> variable matches 0 as @p[tag=target] run function pandamium:misc/take/enderchest
