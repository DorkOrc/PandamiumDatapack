...
tellraw @s [{"text":"","color":"aqua"},{"text":"Overworld:","bold":true},{"text":"\n Players: ","color":"green"},{"score":{"name":"<overworld_player_count>","objective":"variable"},"bold":true},{"text":"\n Sleeping Players: ","color":"green"},{"score":{"name":"<total_sleeping_players>","objective":"variable"},"bold":true},[{"text":" (","color":"gray","hoverEvent":{"action":"show_text","value":[{"score":{"name":"<player_sleeping_percentage>","objective":"variable"},"color":"gray"},"% of players are required to\nbe sleeping in order to skip\nthe night."]}},{"score":{"name":"<player_sleeping_percentage>","objective":"variable"}},"%)"],{"text":"\n Mobs: ","color":"green"},{"score":{"name":"<overworld_mob_count>","objective":"variable"},"bold":true}]
