...
# Set Particle
execute if score <returned> variable matches 0 unless score @s particles matches -45..-1 unless score @s particles matches -53..-50 unless score @s particles matches -99..-64 store success score <returned> variable run tellraw @s [{"text":"[Particles]","color":"dark_red"},{"text":" That is not a valid option!","color":"red"}]
