...
# Menu
execute if score <returned> variable matches 0 store success score <returned> variable if score @s particles matches 1.. run function pandamium:misc/particles/print_menu/main
