...
data modify storage pandamium:dictionary triggers.options.refresh_staff_menu_button set value '{"text":"[🔁]","color":"aqua","hoverEvent":{"action":"show_text","contents":[{"text":"Click to refresh staff options menu","color":"aqua"}]},"clickEvent":{"action":"run_command","value":"/trigger options set 2"}}'
data modify storage pandamium:dictionary triggers.options.refresh_server_menu_button set value '{"text":"[🔁]","color":"aqua","hoverEvent":{"action":"show_text","contents":[{"text":"Click to refresh server options menu","color":"aqua"}]},"clickEvent":{"action":"run_command","value":"/trigger options set 3"}}'
...
data modify storage pandamium:dictionary flair.flairs set value ['"☻"','"💎"','"😎"','"✨"','"💯"','"☠"','"👍"','"🎲"','"🔥"','"🚀"','"🦋"','"☀"','"☽"','"💥"','"🌌"','"🌸"','"🌷"','"♬"','"♪"','"💩"','"🏃"','"👁"','"🌊"','"⌛"','"⚡"','"☁"','"☂"','"❄"','"☃"','"☄"','"💤"','"🫧"','"🐚"','"🍬"','"🍭"','"🍪"','"🍦"','"🍕"','"🍖"','"✂"','"⚔"','"🗡"','"⛏"','"🪓"','"🧪"','"⚗"','"🧋"','"☕"','"🍵"','"🍸"','"🍹"','"🍻"','"🥂"','"🥤"','"🥛"','"🎂"','"🎈"','"💐"','"🎁"','"🕯"','"🌈"','"🎉"','"🎆"','"⭐"','"✰"','"🌟"','"🌠"','"❤"','"💔"','"💕"','"💙"','"💚"','"💝"','"💓"','"❥"','"🫶"','"💘"','"🛠"','"🎃"','"🕸"','"🕷"','"🪦"','"⚰"','"👻"','"🤡"','"🦇"','"🔪"','"😱"','"🎮"','"🎧"','"🛸"','"🌏"','"🐈"','"🌵"','"🌱"','"ඞ"']
