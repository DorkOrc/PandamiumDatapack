...
data modify storage pandamium:global guidebook.version_index set value 108
data modify storage pandamium:global guidebook.version_name set value '2.4.1'
data modify storage pandamium:global guidebook.date_updated set value '07/03/2024'
# ^^^
