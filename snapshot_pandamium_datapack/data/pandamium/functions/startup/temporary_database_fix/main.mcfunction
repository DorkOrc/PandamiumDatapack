execute if score <completed_database_fix_6_9_2023> global matches 1 run return 0
...
scoreboard players set <completed_database_fix_6_9_2023> global 1
say data fixer complete
