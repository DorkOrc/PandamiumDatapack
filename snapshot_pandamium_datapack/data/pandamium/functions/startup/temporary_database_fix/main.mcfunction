execute if score <completed_database_fix_02_12_2023> global matches 1 run return 0
...
execute store result score <length> variable store result bossbar pandamium:data_fixer_progress max if data storage pandamium.db:mail entries[]
...
scoreboard players set <completed_database_fix_02_12_2023> global 1
