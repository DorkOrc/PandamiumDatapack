...
# Update best times
execute if score <course_number> variable matches 1 run function pandamium:impl/parkour/parkour_1/finish
execute if score <course_number> variable matches 2 run function pandamium:impl/parkour/parkour_2/finish
