...
execute if score <hit> variable matches 0 if block ~ ~ ~ decorated_pot align xyz positioned ~0.0625 ~ ~0.0625 if entity @s[dx=0] align xyz positioned ~-0.0625 ~ ~-0.0625 if entity @s[dx=0] run scoreboard players set <hit> variable 1
