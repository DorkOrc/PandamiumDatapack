...
execute as @a if score @s tpa_request.sender_id = <sender_id> variable store success score <receiver_exists> variable run function pandamium:impl/tpa/cancel_outgoing_request/as_receiver
