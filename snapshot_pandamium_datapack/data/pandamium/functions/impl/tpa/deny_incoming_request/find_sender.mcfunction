...
execute as @a if score @s id = <sender_id> variable store success score <player_exists> variable run function pandamium:impl/tpa/deny_incoming_request/as_sender
