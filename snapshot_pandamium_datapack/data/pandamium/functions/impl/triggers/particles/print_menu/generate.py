...
def generate_tree(particles,name,offset=0):
	...
	def rec(a,b):
		...
		if a == b:
			...
			return f"execute if score <{name}_id> variable matches {_range} run function pandamium:impl/triggers/particles/print_menu/get_{name}_name/tree/{_range}\n"
	rec(MIN,MAX)
