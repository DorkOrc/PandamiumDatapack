...
execute if score <value_in_section> variable matches 8 run function pandamium:impl/triggers/vote_shop/purchase/mini_blocks/from_storage/main
execute if score <value_in_section> variable matches 9 store success score <has_given> variable as @r run loot give @p[tag=source] loot pandamium:head
...
execute if score <value_in_section> variable matches 12 store success score <has_given> variable in pandamium:staff_world run function pandamium:impl/triggers/vote_shop/purchase/give_caves_and_cliffs_loot_bag
execute if score <value_in_section> variable matches 13 store success score <has_given> variable at @e[type=marker,tag=raycast.ray,limit=1] run setblock ~ ~ ~ air destroy
...
execute if score <value_in_section> variable matches 15 store success score <has_given> variable in pandamium:staff_world run function pandamium:impl/triggers/vote_shop/purchase/give_wild_loot_bag
...
execute if score <value_in_section> variable matches 21 store success score <has_given> variable in pandamium:staff_world run function pandamium:impl/triggers/vote_shop/purchase/give_trails_and_tales_loot_bag
