...
execute if data storage pandamium:temp vote_shop.selected_item.id run function pandamium:impl/triggers/vote_shop/purchase/mini_blocks/from_storage/main
