...
execute if predicate pandamium:in_dimension/the_nether if score <bedrock_y> variable matches 1.. run scoreboard players set <bedrock_valid_pos> variable 1
execute if predicate pandamium:in_dimension/overworld if score <bedrock_y> variable matches -63.. run scoreboard players set <bedrock_valid_pos> variable 1
execute if predicate pandamium:in_dimension/the_end if score <bedrock_y> variable matches 70.. run scoreboard players set <bedrock_valid_pos> variable 1
