...
execute if score <returned> variable matches 0 run tellraw @s[tag=!target] [{"text":"[Guidebook]","color":"gold"},[{"text":" Gave ","color":"yellow"},{"selector":"@a[tag=target,limit=1]"}," a guidebook!"]]
