...
execute if block ~ ~ ~ #wall_signs store result score <looking_at_front> variable run function pandamium:impl/triggers/sign_font/get_facing_signs_side
execute if block ~ ~ ~ #pandamium:rotation_signs store result score <looking_at_front> variable run function pandamium:impl/triggers/sign_font/get_rotation_signs_side

execute if score <returned> variable matches 0 run scoreboard players set <valid_option> variable 0
execute if score <returned> variable matches 0 run function pandamium:impl/triggers/sign_font/edit_text
