...
execute if score <returned> variable matches 0 at @e[type=marker,tag=raycast.ray,sort=nearest,limit=1] align xyz run data modify storage pandamium:temp containers.nbt set from block ~ ~ ~
...
execute if score <returned> variable matches 0 store result score @s selected_block.x run data get storage pandamium:temp containers.nbt.x
execute if score <returned> variable matches 0 store result score @s selected_block.y run data get storage pandamium:temp containers.nbt.y
execute if score <returned> variable matches 0 store result score @s selected_block.z run data get storage pandamium:temp containers.nbt.z

# Run
execute if score <returned> variable matches 0 run data modify storage pandamium:containers source set value 'container'
...
execute if score <returned> variable matches 0 run scoreboard players set <unique_container> variable 0
execute if score <returned> variable matches 0 if score <unique_container> variable matches 0 if data storage pandamium:temp containers.nbt{id:'minecraft:brewing_stand'} store success score <unique_container> variable run function pandamium:impl/containers/brewing_stand
execute if score <returned> variable matches 0 if score <unique_container> variable matches 0 if data storage pandamium:temp containers.nbt{id:'minecraft:furnace'} store success score <unique_container> variable run function pandamium:impl/containers/furnace
execute if score <returned> variable matches 0 if score <unique_container> variable matches 0 if data storage pandamium:temp containers.nbt{id:'minecraft:smoker'} store success score <unique_container> variable run function pandamium:impl/containers/furnace
execute if score <returned> variable matches 0 if score <unique_container> variable matches 0 if data storage pandamium:temp containers.nbt{id:'minecraft:blast_furnace'} store success score <unique_container> variable run function pandamium:impl/containers/furnace
execute if score <returned> variable matches 0 if score <unique_container> variable matches 0 run function pandamium:impl/containers/generic
