...
$execute if data storage pandamium.db:players selected{index:$(index)} run data modify storage pandamium.db:players selected.entry.data.tp_history set from storage pandamium:temp tp_history
