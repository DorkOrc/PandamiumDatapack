...
execute positioned as @s positioned over motion_blocking_no_leaves as @a[tag=teleport.random.player,limit=1] rotated as @s run function pandamium:utils/teleport/here
