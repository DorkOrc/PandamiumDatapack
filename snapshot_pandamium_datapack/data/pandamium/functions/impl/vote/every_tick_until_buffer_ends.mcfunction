...
tellraw @a[scores={voting_summary_buffer=..0}] [{"text":"You now have ","color":"gray"},{"score":{"name":"*","objective":"votes"},"color":"aqua"}," votes, ",{"score":{"name":"*","objective":"monthly_votes"},"color":"aqua"}," votes this month, and ",{"score":{"name":"*","objective":"reward_credits"},"color":"aqua"}," reward credits."]
