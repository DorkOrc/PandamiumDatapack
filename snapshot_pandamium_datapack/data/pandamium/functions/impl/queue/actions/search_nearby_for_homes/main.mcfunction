...
$tellraw @a[scores={id=$(source)},limit=1] {"color":"green","text":"","extra":[{"storage":"pandamium:queue","nbt":"selected.entry.homes_found","color":"aqua"}," homes were found within 500 blocks horizontally of ",{"color":"aqua","text":"","extra":[{"storage":"pandamium:queue","nbt":"selected.entry.origin.x"}," ~ ",{"storage":"pandamium:queue","nbt":"selected.entry.origin.z"}]}," in ",{"storage":"pandamium:queue","nbt":"selected.entry.origin.dimension","color":"aqua"},"!"]}
