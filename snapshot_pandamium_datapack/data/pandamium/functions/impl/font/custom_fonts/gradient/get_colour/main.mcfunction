...
execute in pandamium:staff_world run function pandamium:impl/font/custom_fonts/gradient/get_colour/write_to_sign with storage pandamium:templates macro.red__green__blue
