...
execute if score <is_same_colour> variable matches 1 run function pandamium:impl/font/custom_fonts/gradient/do_flat
execute if score <is_same_colour> variable matches 0 run function pandamium:impl/font/custom_fonts/gradient/do_gradient
