...
scoreboard players operation <range> variable *= #600 constant
...
execute if score <range> variable matches 300..499 run scoreboard players set <blue> variable 255
execute if score <range> variable matches 500..599 run scoreboard players operation <blue> variable = <fall> variable
...
execute if data storage pandamium:text characters[0] run function pandamium:impl/font/custom_fonts/rainbow/loop
