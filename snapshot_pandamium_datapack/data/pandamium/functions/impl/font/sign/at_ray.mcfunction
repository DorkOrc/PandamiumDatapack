...
execute if block ~ ~ ~ #wall_signs run function pandamium:impl/font/sign/get_facing_signs_side
execute if block ~ ~ ~ #pandamium:rotation_signs run function pandamium:impl/font/sign/get_rotation_signs_side

execute if score <returned> variable matches 0 run scoreboard players set <valid_option> variable 0
execute if score <returned> variable matches 0 run function pandamium:impl/font/sign/edit_text
