...
scoreboard players set <updated> variable 0
execute in overworld as @e[type=text_display,x=0,predicate=pandamium:in_spawn,tag=hologram.leaderboard.yearly_votes,limit=1] at @s run function pandamium:impl/leaderboards/hologram/update/yearly_votes
