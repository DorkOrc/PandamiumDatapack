...
execute if score <updated> variable matches 0 in overworld positioned -5.863961 93.5 10.399495 facing 0 ~ 0 summon text_display run function pandamium:impl/leaderboards/hologram/update/monthly_playtime
...
execute if score <updated> variable matches 0 in overworld positioned -9.399495 93.5 6.863961 facing 0 ~ 0 summon text_display run function pandamium:impl/leaderboards/hologram/update/monthly_votes
