...
# get date
execute store result score <backup_year> variable run data get storage pandamium:leaderboards previous_month_data.year
execute store result score <backup_month> variable run data get storage pandamium:leaderboards previous_month_data.month
...
data modify storage pandamium:temp entries set from storage pandamium:leaderboards previous_month_data.backups.monthly_playtime.format
...
data modify storage pandamium:temp entries set from storage pandamium:leaderboards previous_month_data.backups.monthly_votes.format
data modify storage pandamium:temp json_entries set value []
scoreboard players set <index> variable 0
