data modify block 3 0 0 front_text.messages[0] set value '["{\\"username\\":\\"",{"nbt":"entries[0].username","storage":"pandamium:temp"},"\\",\\"values\\":[",{"nbt":"entries[0].value","storage":"pandamium:temp"},"]}"]'
