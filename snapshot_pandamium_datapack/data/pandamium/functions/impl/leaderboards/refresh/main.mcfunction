...
$execute store result score <length> variable store result bossbar pandamium:queue/leaderboards.refresh/$(type) max if data storage pandamium.db.players:data entries[]
