...
$data modify storage pandamium:leaderboards backups.$(type) set value {date:[I;0,0,0,0],contents:[]}
$data modify storage pandamium:leaderboards backups.$(type).contents set from storage pandamium:leaderboards $(type)
