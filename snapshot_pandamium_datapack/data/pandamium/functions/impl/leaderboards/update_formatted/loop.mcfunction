...
data modify storage pandamium:temp format append value {display:{name:'"???"'},place:"?",value:"?",root_text_component:'{"text":"","color":"#00FFFF"}',template_result:'""'}
...
$function pandamium:impl/leaderboards/update_formatted/templates/$(template)
...
execute if data storage pandamium:temp entries[0] run function pandamium:impl/leaderboards/update_formatted/loop with storage pandamium:templates macro.template
