data modify storage pandamium:leaderboards leader_boards.total_votes merge value { title: "Total Votes", template: "generic", source_objective: "votes", operation: "none", max_entries: 15, buffer_entries: 5}
data modify storage pandamium:leaderboards leader_boards.total_playtime merge value { title: "Total Playtime",template: "generic", source_objective: "playtime_ticks", operation: "ticks_to_hours", max_entries: 15, buffer_entries: 5}
data modify storage pandamium:leaderboards leader_boards.monthly_votes merge value { title: "Monthly Votes",template: "generic", source_objective: "monthly_votes", operation: "none", max_entries: 15, buffer_entries: 5}
data modify storage pandamium:leaderboards leader_boards.monthly_playtime merge value { title: "Monthly Playtime",template: "generic", source_objective: "monthly_playtime_ticks", operation: "ticks_to_hours", max_entries: 15, buffer_entries: 5}
