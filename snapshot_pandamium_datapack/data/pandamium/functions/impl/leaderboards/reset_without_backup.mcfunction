...
execute if data storage pandamium:temp {type:"parkour_3"} run data modify storage pandamium:leaderboards leader_boards.parkour_3 merge value {title: "Forgotten Caverns Parkour", template: "parkour_time", source_objective: "parkour_3.best_time_real", operation: "negative", max_entries: 20, buffer_entries: 5}
