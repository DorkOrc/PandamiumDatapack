...
execute if score <entry_value> variable >= <player_value> variable store result storage pandamium:templates macro.index__type.index int 1 run scoreboard players add <index> variable 1
execute if score <entry_value> variable >= <player_value> variable run return 0
