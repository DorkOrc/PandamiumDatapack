...
$execute store result score <entry_value> variable run data get storage pandamium:leaderboards $(type)[$(index)].value
...
execute if score <index> variable matches 0.. run function pandamium:impl/leaderboards/update_user_place/loop with storage pandamium:templates macro.index__type
