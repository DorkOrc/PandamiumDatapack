...
$data modify storage pandamium:temp arguments.source_objective set from storage pandamium:leaderboards leader_boards.$(type).source_objective
$data modify storage pandamium:temp arguments.operation set from storage pandamium:leaderboards leader_boards.$(type).operation
...
$execute store result score <max_entries> variable run data get storage pandamium:leaderboards leader_boards.$(type).max_entries
$execute store result score <buffer_entries> variable run data get storage pandamium:leaderboards leader_boards.$(type).buffer_entries
...
$execute store result score <total_entries> variable if data storage pandamium:leaderboards leader_boards.$(type).entries[]
