...
execute if score @s monthly_votes >= <monthly_votes_leaderboard_highest_value> global run data modify storage pandamium:temp arguments.flair set value '{"text":"🜲","color":"gold","hoverEvent":{"action":"show_text","contents":{"text":"This player is at the top of a\\nmonthly leaderboard.","color":"gold"}}}'
execute if score @s monthly_playtime_ticks >= <monthly_playtime_leaderboard_highest_value> global run data modify storage pandamium:temp arguments.flair set value '{"text":"🜲","color":"gold","hoverEvent":{"action":"show_text","contents":{"text":"This player is at the top of a\\nmonthly leaderboard.","color":"gold"}}}'
data modify storage pandamium:temp arguments.flair set from storage pandamium.db:players selected.entry.data.flair
execute unless data storage pandamium:temp arguments{flair:'""'} run data modify storage pandamium:temp arguments.separator set value '" "'
