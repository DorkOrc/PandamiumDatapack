...
execute in the_nether as @a[x=15,y=38,z=-16,dx=0,dy=4,dz=4] in overworld positioned -256.5 135.5 rotated 168.5 90 0 run function pandamium:utils/teleport/here
