...
execute as @a[x=11,y=91,z=-11,distance=..2.5,gamemode=!spectator] unless score @s rtp_cooldown matches 1.. run function pandamium:teleport/random_with_feedback
