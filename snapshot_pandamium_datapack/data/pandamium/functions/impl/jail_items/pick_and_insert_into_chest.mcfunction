...
execute if score <can_insert_left> variable matches 1 run loot insert ~ ~ ~ mine 0 1 0 barrier{drop_contents:1b}
...
execute if score <can_insert_left> variable matches 0 if score <can_insert> variable matches 1 run loot insert ~ ~ ~1 mine 0 1 0 barrier{drop_contents:1b}
