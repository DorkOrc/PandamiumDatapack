...
$data modify storage pandamium:temp deleted_entries append from storage pandamium.db.players:data entries[].data.tp_history[{hour_id: $(expired_hour_id), recent: 0b}]
