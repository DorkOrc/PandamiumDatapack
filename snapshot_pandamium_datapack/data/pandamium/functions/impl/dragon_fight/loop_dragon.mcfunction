...
execute unless score <dragon_fight_spawned_reinforcements> global matches 1 if score <phantom_crystals_left> variable matches ..2 run function pandamium:impl/dragon_fight/spawn_reinforcements
