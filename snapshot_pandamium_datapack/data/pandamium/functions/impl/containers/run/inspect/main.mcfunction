...
execute if data storage pandamium:containers inspect.item{id:"minecraft:bundle"}.tag.Items[0] store success score <inspect_bundle> variable run data modify storage pandamium:containers items set from storage pandamium:containers inspect.item.tag.Items
