...
execute if score <recognised> variable matches 0 if score <state> variable matches 1 run function pandamium:impl/json/parse/before_value

execute if score <recognised> variable matches 0 if score <state> variable matches 0..1 if data storage pandamium:json {char:'}'} run function pandamium:impl/json/parse/before_terminus
execute if score <recognised> variable matches 0 if score <state> variable matches 0..1 if data storage pandamium:json {char:']'} run function pandamium:impl/json/parse/before_terminus
...
execute if score <recognised> variable matches 0 if score <state> variable matches 3 run function pandamium:impl/json/parse/after_key
...
execute unless data storage pandamium:json {string:''} run function pandamium:impl/json/parse/iter
