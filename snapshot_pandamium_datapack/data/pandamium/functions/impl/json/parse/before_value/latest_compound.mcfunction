...
execute if score <recognised> variable matches 0 run function pandamium:impl/json/parse/before_value/latest_compound_uncommon
execute if score <recognised> variable matches 0 run function pandamium:impl/json/parse/string/ignore
