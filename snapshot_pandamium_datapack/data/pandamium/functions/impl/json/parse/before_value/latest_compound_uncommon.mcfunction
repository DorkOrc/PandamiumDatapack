...
execute if score <recognised> variable matches 0 if data storage pandamium:json stack[-1].flags.is_root run function pandamium:impl/json/parse/before_value/latest_compound_root_only
