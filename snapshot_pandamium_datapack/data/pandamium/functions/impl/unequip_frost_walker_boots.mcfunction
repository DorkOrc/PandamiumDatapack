...
data modify storage pandamium.db:mail selected.entry.data.title set value '"Inventory Too Full"'
data modify storage pandamium.db:mail selected.entry.data.message set value '"Inventory was too full to unequip item. Mailed item to you instead."'
data modify storage pandamium.db:mail selected.entry.data.preview set value '{"extra":["..."],"text":"Inventory was t"}'
data modify storage pandamium.db:mail selected.entry.ephemeral set value 1b
