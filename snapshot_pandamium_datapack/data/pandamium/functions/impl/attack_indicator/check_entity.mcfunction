...
execute if score <hit> variable matches 1 if data storage pandamium:temp nbt{HurtTime:10s} in pandamium:staff_world run function pandamium:impl/attack_indicator/as_potential_entity
