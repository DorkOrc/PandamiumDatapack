...
function pandamium:impl/text/flatten/get_characters_from_substrings/main
function pandamium:impl/text/flatten/concatenate_characters with storage pandamium:text concat
