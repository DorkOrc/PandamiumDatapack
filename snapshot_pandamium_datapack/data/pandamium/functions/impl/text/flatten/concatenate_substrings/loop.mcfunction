...
data modify storage pandamium:temp arguments.substring set string block 3 0 0 front_text.messages[0] 9 -2
data modify storage pandamium:temp arguments.output set string block 3 0 0 front_text.messages[1] 9 -2
