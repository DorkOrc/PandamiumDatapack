...
$scoreboard players enable @a[scores={optn.disable_dynamic_triggers.tpa_names=0}] tpa_$(username)
...
$scoreboard players enable @a[scores={staff_perms=1..,optn.disable_dynamic_triggers.staff=0}] kick_$(username)
...
$execute unless score @s jailed matches 1.. run scoreboard players enable @a[scores={staff_perms=1..,optn.disable_dynamic_triggers.staff=0}] jail_$(username)
...
$execute if score @s jailed matches 1.. run scoreboard players enable @a[scores={staff_perms=1..,optn.disable_dynamic_triggers.staff=0}] unjail_$(username)
...
$scoreboard players set @a[scores={staff_perms=1..,optn.disable_dynamic_triggers.staff=0}] player_info_$(username) 0
