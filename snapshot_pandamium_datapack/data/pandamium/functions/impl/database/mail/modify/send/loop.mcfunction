...
execute unless data storage pandamium.db.players:io selected run tellraw @a[scores={send_extra_debug_info=2..}] {"text":"[Server: Attempted to add mail to invalid player's inbox; Failed to send mail]","color":"gray","italic":true}
