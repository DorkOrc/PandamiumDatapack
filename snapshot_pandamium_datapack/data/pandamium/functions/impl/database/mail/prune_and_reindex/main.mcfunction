...
data modify storage pandamium.db:mail entries[{sent:1b,ephemeral:1b,data:{completed_ephemeral:1b}}].all_read set value 1b
data remove storage pandamium.db:mail entries[{sent:1b,ephemeral:1b,receivers:[{read:0b}]}].all_read
data remove storage pandamium.db:mail entries[{sent:1b,ephemeral:1b,all_read:1b}]
