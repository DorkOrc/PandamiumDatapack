...
$tellraw @a[scores={send_extra_debug_info=1..}] [{"text":"[PandaDB: Automatically transferred scores and database info/indexes for ","color":"gray","italic":true},{"text":"$(old_username)","bold":true}," to ",{"text":"$(new_username)","bold":true},"]"]
