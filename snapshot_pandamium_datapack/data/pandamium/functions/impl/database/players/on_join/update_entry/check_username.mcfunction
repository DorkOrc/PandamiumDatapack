...
$data modify storage pandamium:templates macro.index__old_username__new_username.old_username set from storage pandamium.db.players:data entries[$(index)].username
