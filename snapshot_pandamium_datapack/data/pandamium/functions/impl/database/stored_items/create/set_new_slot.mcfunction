...
execute if score <container_x> variable matches 128016 run scoreboard players set <container_x> variable 12800

execute if score <container_z> variable matches 128016 run scoreboard players add <container_y> variable 1
execute if score <container_z> variable matches 128016 run scoreboard players set <container_z> variable 12800
