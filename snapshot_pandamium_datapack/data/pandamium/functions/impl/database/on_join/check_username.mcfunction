...
execute if score <username_changed> variable matches 1 run function pandamium:impl/database/on_join/transfer_username with storage pandamium:templates macro.index__old_username__new_username
