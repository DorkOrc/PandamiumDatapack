...
execute if data storage pandamium.db:regions selected.chunk.entry.has_summoned_christmas_mob run return fail
...
execute if score <entity_type> variable matches 1..15 run data modify storage pandamium.db:regions selected.chunk.entry.has_summoned_christmas_mob set value 1b
execute if score <entity_type> variable matches 16..100 run data modify storage pandamium.db:regions selected.chunk.entry.has_summoned_christmas_mob set value 0b
