...
execute in overworld if entity @a[tag=receiver,predicate=pandamium:in_donator_area,limit=1] unless entity @a[tag=sender,scores={gameplay_perms=6..},limit=1] run scoreboard players set <can_accept> variable 0
