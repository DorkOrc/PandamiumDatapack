...
# (temporary)
execute if predicate pandamium:last_joined/before_data_loss if score @s previous_month_leaderboard_reward_type matches 1 run function pandamium:player/on_join/print_temporary_leaderboard_reward_notice
