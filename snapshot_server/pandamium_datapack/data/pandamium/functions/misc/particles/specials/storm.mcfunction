...
# Lightning Bolts
execute if score <storm> variable matches 200.. if score <lightning_bolt> variable matches 1 rotated ~ 0 run function pandamium:misc/particles/misc/lightning_bolt_1
execute if score <storm> variable matches 200.. if score <lightning_bolt> variable matches 3 rotated ~ 0 run function pandamium:misc/particles/misc/lightning_bolt_2
execute if score <storm> variable matches 200.. if score <lightning_bolt> variable matches 6 rotated ~ 0 run function pandamium:misc/particles/misc/lightning_bolt_3
