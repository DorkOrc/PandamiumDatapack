execute if predicate pandamium:is_raining_and_thundering run gamerule playersSleepingPercentage 50
execute unless predicate pandamium:is_raining_and_thundering run gamerule playersSleepingPercentage 33
